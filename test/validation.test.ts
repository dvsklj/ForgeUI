  ...
  it('accepts runtime-supported props across component allowlists', () => {
    const result = validateManifest(validManifest({
      ...
      elements: {
        ...
        chartLegend: { type: 'ChartLegend', props: { title: 'Channels', items: [{ label: 'Web', value: 42, color: 'var(--forgeui-color-primary)' }], dataPath: 'channels', labelKey: 'label', valueKey: 'value', colorKey: 'color', orientation: 'vertical', direction: 'vertical', showValues: true, emptyMessage: 'No channels' } },
