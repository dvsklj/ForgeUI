import{LitElement as Ur,html as se}from"lit";import{createStore as or}from"tinybase";var pe="__forgeui_schema_version";function W(s,t){s.setValue(pe,t)}function ge(s,t){let e=t?.version;if(!t||!Number.isInteger(e)||e<1)return{migrated:!1};let o=new Map;for(let n of t.migrations??[])if(!(n.to<=n.from)){if(o.has(n.from)){console.warn(`[forgeui] duplicate schema migration from v${n.from}; ignoring later entry`);continue}o.set(n.from,n)}let i=Xt(s,t);if(i>=e)return W(s,e),{migrated:!1};let r=i,l=!1;for(;r<e;){let n=o.get(r);if(!n)return{migrated:l,missingStep:r};Qt(s,n);for(let a of n.operations)tr(s,a);r=n.to,W(s,r),l=!0}return{migrated:l}}function Xt(s,t){let e=s.getValue(pe);return typeof e=="number"&&Number.isInteger(e)&&e>=1?e:t.version}function Qt(s,t){if(!t.operations.some(er))return;let e={version:t.from,tables:s.getTables(),values:s.getValues()};s.setValue(`__forgeui_migration_backup_${t.from}_${t.to}`,JSON.stringify(e))}function er(s){return s.op==="drop_column"||s.op==="drop_table"||s.op==="rename_column"}function tr(s,t){switch(t.op){case"add_table":s.setTable(t.table,{});return;case"drop_table":s.delTable(t.table);return;case"add_column":{let o=("definition"in t?t.definition:void 0)?.default??t.default;if(!rr(o))return;for(let i of s.getRowIds(t.table))s.hasCell(t.table,i,t.column)||s.setCell(t.table,i,t.column,o);return}case"drop_column":for(let e of s.getRowIds(t.table))s.delCell(t.table,e,t.column);return;case"rename_column":for(let e of s.getRowIds(t.table))if(s.hasCell(t.table,e,t.from)){let o=s.getCell(t.table,e,t.from);s.setCell(t.table,e,t.to,o),s.delCell(t.table,e,t.from)}return}}function rr(s){return typeof s=="string"||typeof s=="number"||typeof s=="boolean"}var ir=new Set(["__proto__","prototype","constructor"]);function ee(s){if(s.length===0||s.length>256)return!1;for(let t of s.normalize("NFC").split("."))if(ir.has(t))return!1;return!0}function fe(s,t){if(t.includes("/")){let e=t.split("/");if(e.length===3){let[o,i,r]=e;return s.getCell(o,i,r)}if(e.length===2){let[o,i]=e,r=s.getValue(t);if(r!==void 0)return r;let l=s.getCellIds(o,i);if(l.length>0){let n={};for(let a of l)n[a]=s.getCell(o,i,a);return n}}}return s.getValue(t)}function sr(s,t){if(t.startsWith("count:")){let e=t.slice(6);return s.getRowCount(e)}if(t.startsWith("sum:")){let[e,o]=t.split(":"),[i,r]=o.split("/"),l=0,n=s.getRowIds(i);for(let a of n){let u=s.getCell(i,a,r);typeof u=="number"&&(l+=u)}return l}if(t.startsWith("avg:")){let[e,o]=t.split(":"),[i,r]=o.split("/"),l=0,n=0,a=s.getRowIds(i);for(let u of a){let c=s.getCell(i,u,r);typeof c=="number"&&(l+=c,n++)}return n>0?l/n:0}return fe(s,t)}var te=null;function J(s){te=s}function nr(s,t){if(t.length>1024)return;let e="(state\\.[a-zA-Z_][a-zA-Z0-9_.]*|-?\\d+(?:\\.\\d+)?)",o=t.trim().match(new RegExp(`^${e}\\s*(>=|<=|[+\\-*/><])\\s*${e}$`));if(!o)return;let i=St(s,o[1]),r=St(s,o[3]);if(!(typeof i!="number"||typeof r!="number"))switch(o[2]){case"+":return i+r;case"-":return i-r;case"*":return i*r;case"/":return r===0?void 0:i/r;case">":return i>r;case"<":return i<r;case">=":return i>=r;case"<=":return i<=r}}function St(s,t){if(/^-?\d/.test(t))return Number(t);if(!t.startsWith("state."))return;let e=t.slice(6);return ee(e)?_t(s,e):void 0}function me(s,t){let e=t.trim();if(e==="")return;if(e.startsWith('"')&&e.endsWith('"')||e.startsWith("'")&&e.endsWith("'"))return e.slice(1,-1);if(e.startsWith('"')&&!e.endsWith('"')||e.startsWith("'")&&!e.endsWith("'"))return;if(e==="true")return!0;if(e==="false")return!1;if(e==="null")return null;if(/^-?\d+(\.\d+)?$/.test(e))return Number(e);if(/(?:[+\-*/%]|===?|!==?|>=?|<=?|\&\&|\|\|)/.test(e)&&!e.includes("|"))return nr(s,e);if(e.includes("|")){let[i,...r]=e.split("|").map(a=>a.trim()),n=me(s,i);for(let a of r){let[u,...c]=a.split(/\s+/);n=ar(n,u,c)}return n}if(e.startsWith("item.")||e==="item"){if(e==="item")return te;let i=e.slice(5);return G(te,i)}if(e.startsWith("state.")||e==="state"){if(e==="state")return;let i=e.slice(6);return _t(s,i)}return fe(s,e)}function ar(s,t,e){switch(t){case"values":return Array.isArray(s)?s:s&&typeof s=="object"?Object.values(s):[];case"keys":return s&&typeof s=="object"?Object.keys(s):[];case"count":case"length":return Array.isArray(s)?s.length:s&&typeof s=="object"?Object.keys(s).length:typeof s=="string"?s.length:0;case"sum":return Array.isArray(s)?s.reduce((o,i)=>o+(typeof i=="number"?i:0),0):0;case"first":return Array.isArray(s)?s[0]:void 0;case"last":return Array.isArray(s)?s[s.length-1]:void 0;default:return s}}function G(s,t){if(!s||typeof s!="object"||!t||!ee(t))return;let e=t.split(".");if(e.length>32)return;let o=s;for(let i of e){if(o==null)return;o=o[i]}return o}function _t(s,t){if(!ee(t))return;let e=s.getValue(t);if(e!==void 0){if(typeof e=="string")try{return JSON.parse(e)}catch{}return e}let o=t.split(".");if(o.length>=3){let[r,l,n,...a]=o;if(s.hasTable(r)&&s.hasRow(r,l)){let u=s.getCell(r,l,n);if(a.length===0)return u;if(typeof u=="string")try{let c=JSON.parse(u);return G(c,a.join("."))}catch{}return}}if(o.length>=2){let[r,l,...n]=o;if(s.hasTable(r)&&s.hasRow(r,l)){let a=s.getRow(r,l);return n.length===0?a:G(a,n.join("."))}}if(o.length>=1){let[r,...l]=o;if(s.hasTable(r)){let n=s.getRowIds(r),a={};for(let u of n)a[u]=s.getRow(r,u);return l.length===0?a:G(a,l.join("."))}}let i=s.getValue(o[0]);if(typeof i=="string"&&o.length>1)try{let r=JSON.parse(i);return G(r,o.slice(1).join("."))}catch{}}function E(s,t){if(typeof t!="string"){if(t!==null&&typeof t=="object"){let e=t;if("$expr"in e)return E(s,`$expr:${e.$expr}`);if("$state"in e)return E(s,`$state:${e.$state}`);if("$computed"in e)return E(s,`$computed:${e.$computed}`);if("$item"in e)return E(s,`$item:${e.$item}`)}return t}if(t.startsWith("$state:")){let e=t.slice(7);return ee(e)?fe(s,e):void 0}if(t.startsWith("$computed:")){let e=t.slice(10);return e.length>1024?void 0:sr(s,e)}if(t.startsWith("$item:")){let e=t.slice(6);return ee(e)?e.includes(".")?G(te,e):te?.[e]:void 0}if(t.startsWith("$expr:")){let e=t.slice(6);return e.length>1024?void 0:me(s,e)}return t.length>4096?t:t.includes("{{")&&t.includes("}}")?lr(t,s):t}function lr(s,t){let e="",o=0;for(;o<s.length;)if(s[o]==="{"&&s[o+1]==="{"){let i=o+2,r=1,l=i;for(;l<s.length-1&&r>0;){let n=s[l],a=s[l+1];n==="{"&&a==="{"?(r++,l+=2):n==="}"&&a==="}"?(r--,l+=2):l++}if(r)e+=s[o++];else{let n=s.slice(i,l-2);if(n.length<=256){let a=n.trim(),u=a.startsWith("$")?E(t,a):me(t,a);e+=u==null?"":String(u)}else e+=s.slice(o,l);o=l}}else e+=s[o++];return e}function cr(s){if(!s)return{};let t={};for(let[e,o]of Object.entries(s.tables)){t[e]={};for(let[i,r]of Object.entries(o.columns))t[e][i]={type:r.type}}return t}function he(s){let t=or();if(s.schema&&!s.deferSchema&&Z(t,s.schema),s.initialState)for(let[e,o]of Object.entries(s.initialState))typeof o=="string"||typeof o=="number"||typeof o=="boolean"?t.setValue(e,o):typeof o=="object"&&o!==null&&t.setValue(e,JSON.stringify(o));return t}function Z(s,t){if(!t)return;let e=cr(t);s.setTablesSchema(e),W(s,t.version)}function re(s,t){let{type:e,path:o,operation:i,key:r,value:l}=t;if(e!=="mutateState"||!o)return!1;switch(i){case"set":{if(o.includes("/")){let n=o.split("/");if(n.length===3){let[a,u,c]=n;return s.setCell(a,u,c,l),!0}}return s.setValue(o,l),!0}case"append":{let n=o,a=r||`row_${Date.now()}`;if(typeof l=="object"&&l!==null){for(let[u,c]of Object.entries(l))(typeof c=="string"||typeof c=="number"||typeof c=="boolean")&&s.setCell(n,a,u,c);return!0}return!1}case"delete":{let n=o,a=r;return a?(s.delRow(n,a),!0):!1}case"update":{let n=o,a=r;if(a&&typeof l=="object"&&l!==null){for(let[u,c]of Object.entries(l))(typeof c=="string"||typeof c=="number"||typeof c=="boolean")&&s.setCell(n,a,u,c);return!0}return!1}case"increment":{if(o.includes("/")){let a=o.split("/");if(a.length===3){let[u,c,d]=a,p=s.getCell(u,c,d);if(typeof p=="number")return s.setCell(u,c,d,p+(l||1)),!0}}let n=s.getValue(o);return typeof n=="number"?(s.setValue(o,n+(l||1)),!0):!1}case"decrement":{if(o.includes("/")){let a=o.split("/");if(a.length===3){let[u,c,d]=a,p=s.getCell(u,c,d);if(typeof p=="number")return s.setCell(u,c,d,p-(l||1)),!0}}let n=s.getValue(o);return typeof n=="number"?(s.setValue(o,n-(l||1)),!0):!1}case"toggle":{if(o.includes("/")){let a=o.split("/");if(a.length===3){let[u,c,d]=a,p=s.getCell(u,c,d);if(typeof p=="boolean")return s.setCell(u,c,d,!p),!0}}let n=s.getValue(o);return typeof n=="boolean"?(s.setValue(o,!n),!0):!1}default:return!1}}var At={Stack:"layout",Grid:"layout",Card:"layout",Container:"layout",Tabs:"layout",Accordion:"layout",Divider:"layout",Spacer:"layout",Repeater:"layout",Text:"content",Image:"content",Icon:"content",Badge:"content",Avatar:"content",EmptyState:"content",TextInput:"input",Textarea:"input",NumberInput:"input",Select:"input",MultiSelect:"input",RadioGroup:"input",Checkbox:"input",Toggle:"input",DatePicker:"input",Slider:"input",FileUpload:"input",Button:"action",ButtonGroup:"action",Link:"action",Table:"data",List:"data",Chart:"data",Metric:"data",Alert:"feedback",Dialog:"feedback",Progress:"feedback",Toast:"feedback",Breadcrumb:"navigation",Stepper:"navigation",Drawing:"drawing"},ur={layout:["Stack","Grid","Card","Container","Tabs","Accordion","Divider","Spacer","Repeater"],content:["Text","Image","Icon","Badge","Avatar","EmptyState"],input:["TextInput","Textarea","NumberInput","Select","MultiSelect","RadioGroup","Checkbox","Toggle","DatePicker","Slider","FileUpload"],action:["Button","ButtonGroup","Link"],data:["Table","List","Chart","Metric"],feedback:["Alert","Dialog","Progress","Toast"],navigation:["Breadcrumb","Stepper"],drawing:["Drawing"]},Pt=ur,be=Object.keys(At);function oe(s){return s in At}var h=["id","bind","action","slot"],ye=["label","value","variant"],U=["label","value"],dr={Stack:[...h,"direction","align","justify","gap","spacing","padding","wrap"],Grid:[...h,"columns","gap","padding","minChildWidth"],Card:[...h,"variant","title","subtitle","padding"],Container:[...h,"maxWidth","padding"],Tabs:[...h,"items","tabs","activeTab","value"],Accordion:[...h,"title","items","multiple"],Divider:[...h,"direction","spacing"],Spacer:[...h,"size","height","width"],Repeater:[...h,"dataPath","template","data","emptyMessage","direction","gap"],Text:[...h,"content","variant","weight","color","colorScheme","align"],Image:[...h,"src","alt","aspectRatio","fit","radius"],Icon:[...h,"name","size","color"],Badge:[...h,"text","label","colorScheme","variant"],Avatar:[...h,"src","name","size"],EmptyState:[...h,"title","description","icon","actionLabel"],TextInput:[...h,...U,"placeholder","hint","error","multiline","required","maxLength","type","inputType"],Textarea:[...h,...U,"placeholder","hint","error","required","maxLength","rows","disabled"],NumberInput:[...h,...U,"min","max","step","required"],Select:[...h,...U,"options","placeholder","required"],MultiSelect:[...h,...U,"options","maxSelections"],RadioGroup:[...h,...U,"options","hint","required","disabled"],Checkbox:[...h,...U,"description","checked"],Toggle:[...h,...U,"description","checked"],DatePicker:[...h,...U,"format","min","max"],Slider:[...h,...U,"min","max","step","showValue","unit"],FileUpload:[...h,...U,"accept","maxSize","multiple"],Button:[...h,"label","variant","size","icon","disabled","pressed"],ButtonGroup:[...h,"direction","spacing"],Link:[...h,"label","href","variant","external"],Table:[...h,"dataPath","data","columns","pageSize","searchable","selectable","emptyMessage","rowAction","caption"],List:[...h,"dataPath","template","emptyMessage","dividers","items"],Chart:[...h,...ye,"title","dataPath","xKey","yKey","labelKey","valueKey","chartType","color","colorScheme","height","data","yFormat"],Metric:[...h,...ye,"format","goal","trend","trendLabel","prefix","suffix","unit","subtitle"],Alert:[...h,"title","message","variant","dismissible"],Dialog:[...h,"title","trigger","confirmLabel","cancelLabel","open"],Progress:[...h,...ye,"max","size","showValue"],Toast:[...h,"message","variant","duration"],Breadcrumb:[...h,"items"],Stepper:[...h,"steps","activeStep","variant"],Drawing:[...h,"width","height","background","shapes"]},Et=Object.fromEntries(Object.entries(dr).map(([s,t])=>[s,new Set(t)]));import It from"ajv/dist/runtime/ucs2length.js";var Tt=Ct,Mt={type:"object",required:["manifest","id","root","elements"],additionalProperties:!1,properties:{manifest:{type:"string",pattern:"^0\\.\\d+\\.\\d+$"},id:{type:"string",minLength:1,maxLength:128},root:{type:"string",minLength:1},schema:{type:"object",additionalProperties:!1,properties:{version:{type:"integer",minimum:1},tables:{type:"object"},migrations:{type:"array"},views:{type:"object"}}},state:{type:"object"},elements:{type:"object",minProperties:1,additionalProperties:{type:"object",required:["type"],additionalProperties:!1,properties:{type:{type:"string",enum:["Stack","Grid","Card","Container","Tabs","Accordion","Divider","Spacer","Repeater","Text","Image","Icon","Badge","Avatar","EmptyState","TextInput","Textarea","NumberInput","Select","MultiSelect","RadioGroup","Checkbox","Toggle","DatePicker","Slider","FileUpload","Button","ButtonGroup","Link","Table","List","Chart","Metric","Alert","Dialog","Progress","Toast","Breadcrumb","Stepper","Drawing"]},props:{type:"object"},children:{type:"array",items:{type:"string"}},visible:{type:"object"}}}},actions:{type:"object"},meta:{type:"object"},persistState:{type:"boolean"},skipPersistState:{type:"boolean"},dataAccess:{type:"object",additionalProperties:!1,properties:{enabled:{type:"boolean"},readable:{type:"array",items:{type:"string"}},restricted:{type:"array",items:{type:"string"}},summaries:{type:"boolean"}}}}},pr=Object.prototype.hasOwnProperty,ve=It.default??It,gr=new RegExp("^0\\.\\d+\\.\\d+$","u");function Ct(s,{instancePath:t="",parentData:e,parentDataProperty:o,rootData:i=s}={}){let r=null,l=0;if(s&&typeof s=="object"&&!Array.isArray(s)){if(s.manifest===void 0){let n={instancePath:t,schemaPath:"#/required",keyword:"required",params:{missingProperty:"manifest"},message:"must have required property 'manifest'"};r===null?r=[n]:r.push(n),l++}if(s.id===void 0){let n={instancePath:t,schemaPath:"#/required",keyword:"required",params:{missingProperty:"id"},message:"must have required property 'id'"};r===null?r=[n]:r.push(n),l++}if(s.root===void 0){let n={instancePath:t,schemaPath:"#/required",keyword:"required",params:{missingProperty:"root"},message:"must have required property 'root'"};r===null?r=[n]:r.push(n),l++}if(s.elements===void 0){let n={instancePath:t,schemaPath:"#/required",keyword:"required",params:{missingProperty:"elements"},message:"must have required property 'elements'"};r===null?r=[n]:r.push(n),l++}for(let n in s)if(!pr.call(Mt.properties,n)){let a={instancePath:t,schemaPath:"#/additionalProperties",keyword:"additionalProperties",params:{additionalProperty:n},message:"must NOT have additional properties"};r===null?r=[a]:r.push(a),l++}if(s.manifest!==void 0){let n=s.manifest;if(typeof n=="string"){if(!gr.test(n)){let a={instancePath:t+"/manifest",schemaPath:"#/properties/manifest/pattern",keyword:"pattern",params:{pattern:"^0\\.\\d+\\.\\d+$"},message:'must match pattern "^0\\.\\d+\\.\\d+$"'};r===null?r=[a]:r.push(a),l++}}else{let a={instancePath:t+"/manifest",schemaPath:"#/properties/manifest/type",keyword:"type",params:{type:"string"},message:"must be string"};r===null?r=[a]:r.push(a),l++}}if(s.id!==void 0){let n=s.id;if(typeof n=="string"){if(ve(n)>128){let a={instancePath:t+"/id",schemaPath:"#/properties/id/maxLength",keyword:"maxLength",params:{limit:128},message:"must NOT have more than 128 characters"};r===null?r=[a]:r.push(a),l++}if(ve(n)<1){let a={instancePath:t+"/id",schemaPath:"#/properties/id/minLength",keyword:"minLength",params:{limit:1},message:"must NOT have fewer than 1 characters"};r===null?r=[a]:r.push(a),l++}}else{let a={instancePath:t+"/id",schemaPath:"#/properties/id/type",keyword:"type",params:{type:"string"},message:"must be string"};r===null?r=[a]:r.push(a),l++}}if(s.root!==void 0){let n=s.root;if(typeof n=="string"){if(ve(n)<1){let a={instancePath:t+"/root",schemaPath:"#/properties/root/minLength",keyword:"minLength",params:{limit:1},message:"must NOT have fewer than 1 characters"};r===null?r=[a]:r.push(a),l++}}else{let a={instancePath:t+"/root",schemaPath:"#/properties/root/type",keyword:"type",params:{type:"string"},message:"must be string"};r===null?r=[a]:r.push(a),l++}}if(s.schema!==void 0){let n=s.schema;if(n&&typeof n=="object"&&!Array.isArray(n)){for(let a in n)if(!(a==="version"||a==="tables"||a==="migrations"||a==="views")){let u={instancePath:t+"/schema",schemaPath:"#/properties/schema/additionalProperties",keyword:"additionalProperties",params:{additionalProperty:a},message:"must NOT have additional properties"};r===null?r=[u]:r.push(u),l++}if(n.version!==void 0){let a=n.version;if(!(typeof a=="number"&&!(a%1)&&!isNaN(a)&&isFinite(a))){let u={instancePath:t+"/schema/version",schemaPath:"#/properties/schema/properties/version/type",keyword:"type",params:{type:"integer"},message:"must be integer"};r===null?r=[u]:r.push(u),l++}if(typeof a=="number"&&isFinite(a)&&(a<1||isNaN(a))){let u={instancePath:t+"/schema/version",schemaPath:"#/properties/schema/properties/version/minimum",keyword:"minimum",params:{comparison:">=",limit:1},message:"must be >= 1"};r===null?r=[u]:r.push(u),l++}}if(n.tables!==void 0){let a=n.tables;if(!(a&&typeof a=="object"&&!Array.isArray(a))){let u={instancePath:t+"/schema/tables",schemaPath:"#/properties/schema/properties/tables/type",keyword:"type",params:{type:"object"},message:"must be object"};r===null?r=[u]:r.push(u),l++}}if(n.migrations!==void 0&&!Array.isArray(n.migrations)){let a={instancePath:t+"/schema/migrations",schemaPath:"#/properties/schema/properties/migrations/type",keyword:"type",params:{type:"array"},message:"must be array"};r===null?r=[a]:r.push(a),l++}if(n.views!==void 0){let a=n.views;if(!(a&&typeof a=="object"&&!Array.isArray(a))){let u={instancePath:t+"/schema/views",schemaPath:"#/properties/schema/properties/views/type",keyword:"type",params:{type:"object"},message:"must be object"};r===null?r=[u]:r.push(u),l++}}}else{let a={instancePath:t+"/schema",schemaPath:"#/properties/schema/type",keyword:"type",params:{type:"object"},message:"must be object"};r===null?r=[a]:r.push(a),l++}}if(s.state!==void 0){let n=s.state;if(!(n&&typeof n=="object"&&!Array.isArray(n))){let a={instancePath:t+"/state",schemaPath:"#/properties/state/type",keyword:"type",params:{type:"object"},message:"must be object"};r===null?r=[a]:r.push(a),l++}}if(s.elements!==void 0){let n=s.elements;if(n&&typeof n=="object"&&!Array.isArray(n)){if(Object.keys(n).length<1){let a={instancePath:t+"/elements",schemaPath:"#/properties/elements/minProperties",keyword:"minProperties",params:{limit:1},message:"must NOT have fewer than 1 properties"};r===null?r=[a]:r.push(a),l++}for(let a in n){let u=n[a];if(u&&typeof u=="object"&&!Array.isArray(u)){if(u.type===void 0){let c={instancePath:t+"/elements/"+a.replace(/~/g,"~0").replace(/\//g,"~1"),schemaPath:"#/properties/elements/additionalProperties/required",keyword:"required",params:{missingProperty:"type"},message:"must have required property 'type'"};r===null?r=[c]:r.push(c),l++}for(let c in u)if(!(c==="type"||c==="props"||c==="children"||c==="visible")){let d={instancePath:t+"/elements/"+a.replace(/~/g,"~0").replace(/\//g,"~1"),schemaPath:"#/properties/elements/additionalProperties/additionalProperties",keyword:"additionalProperties",params:{additionalProperty:c},message:"must NOT have additional properties"};r===null?r=[d]:r.push(d),l++}if(u.type!==void 0){let c=u.type;if(typeof c!="string"){let d={instancePath:t+"/elements/"+a.replace(/~/g,"~0").replace(/\//g,"~1")+"/type",schemaPath:"#/properties/elements/additionalProperties/properties/type/type",keyword:"type",params:{type:"string"},message:"must be string"};r===null?r=[d]:r.push(d),l++}if(!(c==="Stack"||c==="Grid"||c==="Card"||c==="Container"||c==="Tabs"||c==="Accordion"||c==="Divider"||c==="Spacer"||c==="Repeater"||c==="Text"||c==="Image"||c==="Icon"||c==="Badge"||c==="Avatar"||c==="EmptyState"||c==="TextInput"||c==="Textarea"||c==="NumberInput"||c==="Select"||c==="MultiSelect"||c==="RadioGroup"||c==="Checkbox"||c==="Toggle"||c==="DatePicker"||c==="Slider"||c==="FileUpload"||c==="Button"||c==="ButtonGroup"||c==="Link"||c==="Table"||c==="List"||c==="Chart"||c==="Metric"||c==="Alert"||c==="Dialog"||c==="Progress"||c==="Toast"||c==="Breadcrumb"||c==="Stepper"||c==="Drawing")){let d={instancePath:t+"/elements/"+a.replace(/~/g,"~0").replace(/\//g,"~1")+"/type",schemaPath:"#/properties/elements/additionalProperties/properties/type/enum",keyword:"enum",params:{allowedValues:Mt.properties.elements.additionalProperties.properties.type.enum},message:"must be equal to one of the allowed values"};r===null?r=[d]:r.push(d),l++}}if(u.props!==void 0){let c=u.props;if(!(c&&typeof c=="object"&&!Array.isArray(c))){let d={instancePath:t+"/elements/"+a.replace(/~/g,"~0").replace(/\//g,"~1")+"/props",schemaPath:"#/properties/elements/additionalProperties/properties/props/type",keyword:"type",params:{type:"object"},message:"must be object"};r===null?r=[d]:r.push(d),l++}}if(u.children!==void 0){let c=u.children;if(Array.isArray(c)){let d=c.length;for(let p=0;p<d;p++)if(typeof c[p]!="string"){let v={instancePath:t+"/elements/"+a.replace(/~/g,"~0").replace(/\//g,"~1")+"/children/"+p,schemaPath:"#/properties/elements/additionalProperties/properties/children/items/type",keyword:"type",params:{type:"string"},message:"must be string"};r===null?r=[v]:r.push(v),l++}}else{let d={instancePath:t+"/elements/"+a.replace(/~/g,"~0").replace(/\//g,"~1")+"/children",schemaPath:"#/properties/elements/additionalProperties/properties/children/type",keyword:"type",params:{type:"array"},message:"must be array"};r===null?r=[d]:r.push(d),l++}}if(u.visible!==void 0){let c=u.visible;if(!(c&&typeof c=="object"&&!Array.isArray(c))){let d={instancePath:t+"/elements/"+a.replace(/~/g,"~0").replace(/\//g,"~1")+"/visible",schemaPath:"#/properties/elements/additionalProperties/properties/visible/type",keyword:"type",params:{type:"object"},message:"must be object"};r===null?r=[d]:r.push(d),l++}}}else{let c={instancePath:t+"/elements/"+a.replace(/~/g,"~0").replace(/\//g,"~1"),schemaPath:"#/properties/elements/additionalProperties/type",keyword:"type",params:{type:"object"},message:"must be object"};r===null?r=[c]:r.push(c),l++}}}else{let a={instancePath:t+"/elements",schemaPath:"#/properties/elements/type",keyword:"type",params:{type:"object"},message:"must be object"};r===null?r=[a]:r.push(a),l++}}if(s.actions!==void 0){let n=s.actions;if(!(n&&typeof n=="object"&&!Array.isArray(n))){let a={instancePath:t+"/actions",schemaPath:"#/properties/actions/type",keyword:"type",params:{type:"object"},message:"must be object"};r===null?r=[a]:r.push(a),l++}}if(s.meta!==void 0){let n=s.meta;if(!(n&&typeof n=="object"&&!Array.isArray(n))){let a={instancePath:t+"/meta",schemaPath:"#/properties/meta/type",keyword:"type",params:{type:"object"},message:"must be object"};r===null?r=[a]:r.push(a),l++}}if(s.persistState!==void 0&&typeof s.persistState!="boolean"){let n={instancePath:t+"/persistState",schemaPath:"#/properties/persistState/type",keyword:"type",params:{type:"boolean"},message:"must be boolean"};r===null?r=[n]:r.push(n),l++}if(s.skipPersistState!==void 0&&typeof s.skipPersistState!="boolean"){let n={instancePath:t+"/skipPersistState",schemaPath:"#/properties/skipPersistState/type",keyword:"type",params:{type:"boolean"},message:"must be boolean"};r===null?r=[n]:r.push(n),l++}if(s.dataAccess!==void 0){let n=s.dataAccess;if(n&&typeof n=="object"&&!Array.isArray(n)){for(let a in n)if(!(a==="enabled"||a==="readable"||a==="restricted"||a==="summaries")){let u={instancePath:t+"/dataAccess",schemaPath:"#/properties/dataAccess/additionalProperties",keyword:"additionalProperties",params:{additionalProperty:a},message:"must NOT have additional properties"};r===null?r=[u]:r.push(u),l++}if(n.enabled!==void 0&&typeof n.enabled!="boolean"){let a={instancePath:t+"/dataAccess/enabled",schemaPath:"#/properties/dataAccess/properties/enabled/type",keyword:"type",params:{type:"boolean"},message:"must be boolean"};r===null?r=[a]:r.push(a),l++}if(n.readable!==void 0){let a=n.readable;if(Array.isArray(a)){let u=a.length;for(let c=0;c<u;c++)if(typeof a[c]!="string"){let d={instancePath:t+"/dataAccess/readable/"+c,schemaPath:"#/properties/dataAccess/properties/readable/items/type",keyword:"type",params:{type:"string"},message:"must be string"};r===null?r=[d]:r.push(d),l++}}else{let u={instancePath:t+"/dataAccess/readable",schemaPath:"#/properties/dataAccess/properties/readable/type",keyword:"type",params:{type:"array"},message:"must be array"};r===null?r=[u]:r.push(u),l++}}if(n.restricted!==void 0){let a=n.restricted;if(Array.isArray(a)){let u=a.length;for(let c=0;c<u;c++)if(typeof a[c]!="string"){let d={instancePath:t+"/dataAccess/restricted/"+c,schemaPath:"#/properties/dataAccess/properties/restricted/items/type",keyword:"type",params:{type:"string"},message:"must be string"};r===null?r=[d]:r.push(d),l++}}else{let u={instancePath:t+"/dataAccess/restricted",schemaPath:"#/properties/dataAccess/properties/restricted/type",keyword:"type",params:{type:"array"},message:"must be array"};r===null?r=[u]:r.push(u),l++}}if(n.summaries!==void 0&&typeof n.summaries!="boolean"){let a={instancePath:t+"/dataAccess/summaries",schemaPath:"#/properties/dataAccess/properties/summaries/type",keyword:"type",params:{type:"boolean"},message:"must be boolean"};r===null?r=[a]:r.push(a),l++}}else{let a={instancePath:t+"/dataAccess",schemaPath:"#/properties/dataAccess/type",keyword:"type",params:{type:"object"},message:"must be object"};r===null?r=[a]:r.push(a),l++}}}else{let n={instancePath:t,schemaPath:"#/type",keyword:"type",params:{type:"object"},message:"must be object"};r===null?r=[n]:r.push(n),l++}return Ct.errors=r,l===0}var xe=Tt,fr=["javascript:","data:text/html","data:text/javascript","data:application/javascript","vbscript:","file:"],mr=["https:","http:","data:image/","blob:"],Rt=["https:","http:","mailto:","tel:","#"],hr=["https:","http:"],br=/^on[a-z]+$/i,jt=[/<\s*script/i,/<\s*iframe/i,/<\s*object/i,/<\s*embed/i,/javascript\s*:/i,/data\s*:\s*text\/html/i,/expression\s*\(/i,/url\s*\(\s*javascript/i];function $e(s){let t=[];if(!xe(s)&&xe.errors){for(let r of xe.errors)t.push({path:r.instancePath||"/",message:r.message||"Schema validation error",severity:"error"});return{valid:!1,errors:t,warnings:[]}}let o=s;yr(o,t),wr(o,t),$r(o,t),Ar(o,t),kr(o,t);let i=JSON.stringify(o).length;return i>1e5&&t.push({path:"/",message:`Manifest size (${(i/1024).toFixed(1)}KB) exceeds 100KB limit`,severity:"warning"}),{valid:!t.some(r=>r.severity==="error"),errors:t.filter(r=>r.severity==="error"),warnings:t.filter(r=>r.severity!=="error")}}function yr(s,t){for(let[e,o]of Object.entries(s.elements))if(o.props){for(let[i,r]of Object.entries(o.props))if(typeof r=="string"){for(let l of jt)l.test(r)&&t.push({path:`/elements/${e}/props/${i}`,message:`Potentially dangerous content detected (matches ${l.source})`,severity:"error"});we(r,`/elements/${e}/props/${i}`,t,vr(o.type,i)),br.test(i)&&t.push({path:`/elements/${e}/props/${i}`,message:`Event handler property not allowed: ${i}`,severity:"error"})}if(o.type==="Breadcrumb"&&Array.isArray(o.props.items)&&o.props.items.forEach((i,r)=>{!i||typeof i!="object"||Array.isArray(i)||we(i.href,`/elements/${e}/props/items/${r}/href`,t,Rt)}),o.children){for(let i of o.children)if(typeof i=="string")for(let r of jt)r.test(i)&&t.push({path:`/elements/${e}/children`,message:`Potentially dangerous content in children: ${r.source}`,severity:"error"})}}if(s.actions)for(let[e,o]of Object.entries(s.actions))we(o.url,`/actions/${e}/url`,t,o.type==="callApi"?hr:void 0)}function vr(s,t){if(t==="src"&&(s==="Image"||s==="Avatar"))return mr;if(t==="href"&&s==="Link")return Rt}function we(s,t,e,o){if(typeof s!="string"||!xr(s))return;let i=s.toLowerCase().trim();for(let r of fr)if(i.startsWith(r)){e.push({path:t,message:`Dangerous URL scheme rejected: ${r}`,severity:"error"});return}o&&!o.some(r=>i.startsWith(r))&&e.push({path:t,message:"URL not allowed",severity:"error"})}function xr(s){return/^[a-z][a-z0-9+.-]*:/i.test(s)}function wr(s,t){let e=s.schema?.tables?Object.keys(s.schema.tables):[],o=new Set;if(s.state)for(let i of Object.keys(s.state))o.add(i);if(!(e.length===0&&o.size===0)){for(let[i,r]of Object.entries(s.elements))if(r.props)for(let[l,n]of Object.entries(r.props)){if(typeof n=="string"&&n.startsWith("$state:")){let a=n.slice(7),u=a.split("/")[0].split(".")[0];u&&!o.has(u)&&!e.includes(u)&&t.push({path:`/elements/${i}/props/${l}`,message:`$state:${a} references unknown state path`,severity:"warning"})}if(typeof n=="string"&&n.startsWith("$computed:")){let a=n.slice(10);if(a.startsWith("sum:")||a.startsWith("avg:")){let[u,c]=a.split(":"),[d,p]=c.split("/");e.includes(d)?p&&s.schema?.tables[d]&&(Object.keys(s.schema.tables[d].columns).includes(p)||t.push({path:`/elements/${i}/props/${l}`,message:`$computed references unknown column: ${d}/${p}`,severity:"error"})):t.push({path:`/elements/${i}/props/${l}`,message:`$computed references unknown table: ${d}`,severity:"error"})}else if(a.startsWith("count:")){let u=a.slice(6);e.includes(u)||t.push({path:`/elements/${i}/props/${l}`,message:`$computed:count references unknown table: ${u}`,severity:"error"})}}}}}function $r(s,t){for(let[e,o]of Object.entries(s.elements))oe(o.type)||t.push({path:`/elements/${e}/type`,message:`Unknown component type: ${o.type}`,severity:"error"})}function kr(s,t){let e=new Set(Object.keys(s.elements));e.has(s.root)||t.push({path:"/root",message:`Root element "${s.root}" not found in elements`,severity:"error"});for(let[o,i]of Object.entries(s.elements))if(i.children)for(let r of i.children)e.has(r)||t.push({path:`/elements/${o}/children`,message:`Child element "${r}" not found in elements`,severity:"error"});Sr(s,t)}function Sr(s,t){let e=new Set,o=new Set;function i(r,l){if(o.has(r))return t.push({path:`/elements/${r}`,message:`Circular reference detected: ${[...l,r].join(" \u2192 ")}`,severity:"error"}),!0;if(e.has(r))return!1;e.add(r),o.add(r);let n=s.elements[r];if(n?.children){for(let a of n.children)if(i(a,[...l,r]))return!0}return o.delete(r),!1}i(s.root,[])}function _r(s){let t=s.trim(),e=t.match(/^```(?:json)?\s*\n?([\s\S]*?)\n?\s*```$/);return e?e[1].trim():t}function Ar(s,t){for(let[e,o]of Object.entries(s.elements)){if(!o.props)continue;let i=Et[o.type];if(i)for(let r of Object.keys(o.props))i.has(r)||t.push({path:`/elements/${e}/props/${r}`,message:`Unknown prop "${r}" for component type ${o.type}`,severity:"error"})}}import{html as f}from"lit";function Lt(s){return ke(s.manifest.root,s)}function ke(s,t){try{let e=t.manifest.elements[s];if(!e)return f``;if(e.visible&&!Er(e.visible,t))return f``;let o=e.type;if(o==="Repeater")return Pr(e,t);let i=zt(e.props||{},t),r=(e.children||[]).map(l=>ke(l,t));switch(o){case"Stack":return f`<forgeui-stack .props=${i} .store=${t.store} .onAction=${t.onAction} .itemContext=${t.itemContext||null}>${r}</forgeui-stack>`;case"Grid":return f`<forgeui-grid .props=${i} .store=${t.store} .onAction=${t.onAction}>${r}</forgeui-grid>`;case"Card":return f`<forgeui-card .props=${i} .store=${t.store} .onAction=${t.onAction}>${r}</forgeui-card>`;case"Container":return f`<forgeui-container .props=${i} .store=${t.store}>${r}</forgeui-container>`;case"Tabs":return f`<forgeui-tabs .props=${i} .store=${t.store} .onAction=${t.onAction}>${r}</forgeui-tabs>`;case"Accordion":return f`<forgeui-accordion .props=${i} .store=${t.store}>${r}</forgeui-accordion>`;case"Divider":return f`<forgeui-divider .props=${i} .store=${t.store}></forgeui-divider>`;case"Spacer":return f`<forgeui-spacer .props=${i} .store=${t.store}></forgeui-spacer>`;case"Text":return f`<forgeui-text .props=${i} .store=${t.store}></forgeui-text>`;case"Image":return f`<forgeui-image .props=${i} .store=${t.store}></forgeui-image>`;case"Icon":return f`<forgeui-icon .props=${i} .store=${t.store}></forgeui-icon>`;case"Badge":return f`<forgeui-badge .props=${i} .store=${t.store}></forgeui-badge>`;case"Avatar":return f`<forgeui-avatar .props=${i} .store=${t.store}></forgeui-avatar>`;case"EmptyState":return f`<forgeui-empty-state .props=${i} .store=${t.store}></forgeui-empty-state>`;case"TextInput":return f`<forgeui-text-input .props=${i} .store=${t.store} .onAction=${t.onAction}></forgeui-text-input>`;case"Textarea":return f`<forgeui-textarea .props=${i} .store=${t.store} .onAction=${t.onAction}></forgeui-textarea>`;case"NumberInput":return f`<forgeui-number-input .props=${i} .store=${t.store} .onAction=${t.onAction}></forgeui-number-input>`;case"Select":return f`<forgeui-select .props=${i} .store=${t.store} .onAction=${t.onAction}></forgeui-select>`;case"MultiSelect":return f`<forgeui-multi-select .props=${i} .store=${t.store} .onAction=${t.onAction}></forgeui-multi-select>`;case"RadioGroup":return f`<forgeui-radio-group .props=${i} .store=${t.store} .onAction=${t.onAction}></forgeui-radio-group>`;case"Checkbox":return f`<forgeui-checkbox .props=${i} .store=${t.store} .onAction=${t.onAction}></forgeui-checkbox>`;case"Toggle":return f`<forgeui-toggle .props=${i} .store=${t.store} .onAction=${t.onAction}></forgeui-toggle>`;case"DatePicker":return f`<forgeui-date-picker .props=${i} .store=${t.store} .onAction=${t.onAction}></forgeui-date-picker>`;case"Slider":return f`<forgeui-slider .props=${i} .store=${t.store} .onAction=${t.onAction}></forgeui-slider>`;case"FileUpload":return f`<forgeui-file-upload .props=${i} .store=${t.store} .onAction=${t.onAction}></forgeui-file-upload>`;case"Button":return f`<forgeui-button .props=${i} .store=${t.store} .onAction=${t.onAction}></forgeui-button>`;case"ButtonGroup":return f`<forgeui-button-group .props=${i} .store=${t.store} .onAction=${t.onAction}>${r}</forgeui-button-group>`;case"Link":return f`<forgeui-link .props=${i} .store=${t.store}></forgeui-link>`;case"Table":return f`<forgeui-table .props=${i} .store=${t.store} .onAction=${t.onAction}></forgeui-table>`;case"List":return f`<forgeui-list .props=${i} .store=${t.store} .onAction=${t.onAction}></forgeui-list>`;case"Chart":return f`<forgeui-chart .props=${i} .store=${t.store}></forgeui-chart>`;case"Metric":return f`<forgeui-metric .props=${i} .store=${t.store}></forgeui-metric>`;case"Alert":return f`<forgeui-alert .props=${i} .store=${t.store}>${r}</forgeui-alert>`;case"Dialog":return f`<forgeui-dialog .props=${i} .store=${t.store} .onAction=${t.onAction}>${r}</forgeui-dialog>`;case"Progress":return f`<forgeui-progress .props=${i} .store=${t.store}></forgeui-progress>`;case"Toast":return f`<forgeui-toast .props=${i} .store=${t.store}></forgeui-toast>`;case"Breadcrumb":return f`<forgeui-breadcrumb .props=${i} .store=${t.store} .onAction=${t.onAction}></forgeui-breadcrumb>`;case"Stepper":return f`<forgeui-stepper .props=${i} .store=${t.store} .onAction=${t.onAction}>${r}</forgeui-stepper>`;case"Drawing":return f`<forgeui-drawing .props=${i} .store=${t.store} .onAction=${t.onAction}></forgeui-drawing>`;default:return f`<forgeui-error .props=${{msg:`Unknown: ${o}`}} .store=${t.store}></forgeui-error>`}}catch(e){return console.warn(`[forgeui] renderElement("${s}") threw:`,e?.message||e),f`<forgeui-error .props=${{msg:`Element "${s}" failed to render: ${e?.message||"unknown error"}`}} .store=${t.store}></forgeui-error>`}}function Pr(s,t){let e=zt(s.props||{},t),o=e.data,i=[];Array.isArray(o)?i=o:o&&typeof o=="object"&&(i=Object.values(o));let r=s.children||[];if(r.length===0)return f`<forgeui-repeater .props=${e} .store=${t.store}></forgeui-repeater>`;let l=[];for(let n=0;n<i.length;n++){let a=i[n],u=typeof a=="object"&&a!==null?{...a,_index:n}:{value:a,_index:n},c={...t,itemContext:u};J(u);try{for(let d of r)l.push(ke(d,c))}finally{J(null)}}return i.length===0?f`<forgeui-repeater .props=${e} .store=${t.store}></forgeui-repeater>`:f`<forgeui-repeater .props=${e} .store=${t.store}>${l}</forgeui-repeater>`}function zt(s,t){let e={};for(let[o,i]of Object.entries(s))e[o]=o==="bind"?i:E(t.store,i);return e}function Er(s,t){if(!s||typeof s!="object")return!0;let e=s.$when??s;if(!e||typeof e!="object")return!0;let{path:o,eq:i,neq:r,gt:l,gte:n,lt:a,lte:u,in:c,exists:d}=e;if(!o||typeof o!="string")return!0;let p=E(t.store,`$state:${o}`);return d!==void 0?d?p!==void 0:p===void 0:i!==void 0?p===i:r!==void 0?p!==r:l!==void 0&&typeof p=="number"?p>l:n!==void 0&&typeof p=="number"?p>=n:a!==void 0&&typeof p=="number"?p<a:u!==void 0&&typeof p=="number"?p<=u:c!==void 0&&Array.isArray(c)?c.includes(p):!0}import{css as Se}from"lit";var Dt=Se`
  @layer tokens {
    :host {
...
`)}function Pe(){return{type:"object",required:["manifest","id","elements"],properties:{manifest:{type:"string",const:"0.1.0"},id:{type:"string",pattern:"^[a-z0-9][a-z0-9-]*$"},root:{type:"string"},title:{type:"string"},schema:{type:"object",properties:{version:{type:"number"},tables:{type:"object",additionalProperties:{type:"object",properties:{columns:{type:"object",additionalProperties:{type:"object",properties:{type:{type:"string",enum:["string","number","boolean"]},default:{}},required:["type"]}}},required:["columns"]}}}},state:{type:"object",additionalProperties:{}},elements:{type:"object",additionalProperties:{type:"object",properties:{type:{type:"string",enum:be},props:{type:"object"},children:{type:"array",items:{type:"string"}},visible:{type:"object",properties:{$when:{type:"object",properties:{path:{type:"string"},eq:{},neq:{},gt:{type:"number"},lt:{type:"number"},gte:{type:"number"},lte:{type:"number"},in:{type:"array"},notIn:{type:"array"},exists:{type:"boolean"}},required:["path"]}}}},required:["type"]}},actions:{type:"object",additionalProperties:{type:"object",properties:{type:{type:"string",enum:["mutateState","navigate","openDialog","closeDialog","callApi","toast","custom"]},path:{type:"string"},value:{},operation:{type:"string",enum:["set","append","update","delete","increment","decrement","toggle"]},set:{type:"object"},data:{type:"object"},key:{type:"string"},formId:{type:"string"},action:{type:"string"},target:{type:"string"},url:{type:"string"},method:{type:"string"},body:{type:"object"}},required:["type"]}},dataAccess:{type:"object",properties:{enabled:{type:"boolean",default:!1},readable:{type:"array",items:{type:"string"}},restricted:{type:"array",items:{type:"string"}},summaries:{type:"boolean",default:!1}}},persistState:{type:"boolean"},skipPersistState:{type:"boolean"}}}}var Ir={container:"Stack",row:"Stack",column:"Stack",text:"Text",heading:"Text",label:"Text",image:"Image",icon:"Icon",button:"Button",link:"Link",textInput:"TextInput",textarea:"Textarea",textArea:"Textarea",numberInput:"NumberInput",checkbox:"Checkbox",toggle:"Toggle",select:"Select",divider:"Divider",spacer:"Spacer",card:"Card",table:"Table",list:"List",alert:"Alert",progress:"Progress",badge:"Badge",avatar:"Avatar"};function Tr(s){let t={},e=0;function o(n){let a=n.id||`a2ui-${e++}`,u=Ir[n.type];if(!u||!oe(u))return t[a]={type:"Text",props:{content:`[Unsupported A2UI type: ${n.type}]`,variant:"caption",colorScheme:"secondary"}},a;let c=Cr(n.type,n.props||{}),d=(n.children||[]).map(p=>o(p));return t[a]={type:u,props:c,children:d.length>0?d:void 0},a}let r=(s.components||s.content||[]).map(n=>o(n)),l=r.length===1?r[0]:"a2ui-root";return r.length>1&&(t[l]={type:"Stack",props:{gap:"md"},children:r}),{manifest:"0.1.0",id:`a2ui-${Date.now()}`,root:l,elements:t,actions:{}}}function Cr(s,t){let e={...t};switch(s){case"heading":e.variant="heading",e.content=t.text||t.content||"",delete e.text;break;case"text":case"label":e.content=t.text||t.content||"",delete e.text;break;case"row":e.direction="row",e.gap=t.gap||t.spacing||"md";break;case"column":e.direction="column",e.gap=t.gap||t.spacing||"md";break;case"container":e.gap=t.gap||t.spacing||"md";break;case"image":e.src=t.src||t.url||"",e.alt=t.alt||"";break;case"button":e.label=t.text||t.label||"",e.variant=t.variant||t.style||"default";break;case"textInput":case"textarea":case"textArea":e.placeholder=t.placeholder||"",e.value=t.value||"",e.label=t.label||"";break;case"numberInput":e.placeholder=t.placeholder||"",e.value=t.value??0,e.label=t.label||"";break;case"select":t.options&&Array.isArray(t.options)&&(e.options=t.options.map(o=>typeof o=="string"?{value:o,label:o}:o));break;case"alert":e.variant=t.type||t.severity||"info",e.content=t.message||t.text||t.content||"",delete e.message,delete e.text;break;case"progress":e.value=t.value??t.percent??0;break}return e}function Ft(s){if(!s||typeof s!="object")return!1;let t=s;return!!(Array.isArray(t.components)||Array.isArray(t.content)||typeof t.type=="string"&&(t.type==="adaptive-card"||t.type.startsWith("a2ui"))||typeof t.version=="string"&&t.version.startsWith("a2ui")||!t.elements&&!t.manifest&&Array.isArray(t.content))}function Ee(s){return Ft(s)?Tr(s):s}function Bt(s){return`forgeui_${(s||"global").replace(/[^a-zA-Z0-9-]/g,"_")}`}var Me="f";function jr(s){return new Promise((t,e)=>{let o=r=>e(r??new Error("IDB"));if(!globalThis.indexedDB)return o();let i=indexedDB.open(`${Bt(s)}_f`,1);i.onupgradeneeded=()=>{i.result.createObjectStore(Me)},i.onsuccess=()=>t(i.result),i.onerror=i.onblocked=()=>o(i.error)})}async function Vt(s,t){if(s.length===0)return;let e=null;try{e=await jr(t),await new Promise((o,i)=>{let r=e.transaction(Me,"readwrite"),l=r.objectStore(Me);for(let{file:n,id:a}of s)l.put(n,a);r.oncomplete=()=>o(),r.onerror=r.onabort=()=>i(r.error)})}catch{return}finally{e?.close()}}function qt(s,t,e="none"){let o=Bt(t),i=e,r=null,l=!1,n=!1,a=null,u=null,c=null,d=[];function p(){let m=v();for(let w of d)try{w(m)}catch{}}function v(){return{mode:i,isPersisting:r!=null&&l,lastSaved:a,lastLoaded:u,error:c,dbName:i==="indexeddb"?o:null}}async function D(){if(r)return r;try{let{createIndexedDbPersister:m}=await import("tinybase/persisters/persister-indexed-db");return r=m(s,o),c=null,r}catch(m){throw c=`IndexedDB unavailable: ${m.message}`,p(),m}}async function _(){if(i==="none")return;let m=await D();try{await m.load(),u=Date.now()}catch(w){c=`Load failed: ${w.message}`,p()}try{m.startAutoSave(),l=!0}catch(w){c=`Auto-save failed: ${w.message}`}try{m.startAutoLoad(1),n=!0}catch(w){c=`Auto-load failed: ${w.message}`}p()}async function x(){if(r){l&&(r.stopAutoSave(),l=!1),n&&(r.stopAutoLoad(),n=!1);try{await r.save(),a=Date.now()}catch(m){c=`Final save failed: ${m.message}`}p()}}async function I(){if(!(i==="none"||!r)){try{await r.save(),a=Date.now(),c=null}catch(m){c=`Save failed: ${m.message}`}p()}}async function k(){if(!(i==="none"||!r)){try{await r.load(),u=Date.now(),c=null}catch(m){c=`Load failed: ${m.message}`}p()}}async function P(){if(await x(),r){try{r.destroy()}catch{}r=null}d=[],p()}function $(m){if(m===i)return;let w=i;i=m,w==="indexeddb"&&m==="none"&&(r&&l&&(r.stopAutoSave(),l=!1),r&&n&&(r.stopAutoLoad(),n=!1)),m==="indexeddb"&&w==="none"&&_().catch(()=>{}),p()}function S(m){return d.push(m),()=>{d=d.filter(w=>w!==m)}}return{start:_,stop:x,save:I,load:k,setMode:$,getStatus:v,addListener:S,destroy:P}}var le=class{constructor(t=50){this._stack=[];this._position=-1;this._listeners=[];this._maxDepth=t}push(t){if(this._position<this._stack.length-1&&(this._stack=this._stack.slice(0,this._position+1)),this._position>=0){let e=this._stack[this._position];if(JSON.stringify(e)===JSON.stringify(t))return}this._stack.push(structuredClone(t)),this._stack.length>this._maxDepth?this._stack.shift():this._position++,this._notifyListeners()}undo(){return this._position<=0?null:(this._position--,this._notifyListeners(),structuredClone(this._stack[this._position]))}redo(){return this._position>=this._stack.length-1?null:(this._position++,this._notifyListeners(),structuredClone(this._stack[this._position]))}current(){return this._position<0?null:structuredClone(this._stack[this._position])}jumpTo(t){return t<0||t>=this._stack.length?null:(this._position=t,this._notifyListeners(),structuredClone(this._stack[this._position]))}getState(){return{canUndo:this._position>0,canRedo:this._position<this._stack.length-1,position:this._position,total:this._stack.length}}getTimeline(){return this._stack.map((t,e)=>({position:e,id:t.id}))}clear(){this._stack=[],this._position=-1,this._notifyListeners()}addListener(t){return this._listeners.push(t),()=>{this._listeners=this._listeners.filter(e=>e!==t)}}_notifyListeners(){let t=this.getState();for(let e of this._listeners)try{e(t)}catch{}}};function Kt(s){if(!Y(s))return s;let t=typeof s.manifest=="string"?s.manifest:"";if(!(/^0\.0(?:\.|$)/.test(t)||!t&&("version"in s||"manifestVersion"in s||"components"in s||"rootElement"in s||Rr(s.elements))))return s;let r={...s,manifest:"0.1.0"};if(delete r.version,delete r.manifestVersion,!r.elements&&Y(r.components)&&(r.elements=r.components,delete r.components),!r.root&&typeof r.rootElement=="string"&&(r.root=r.rootElement,delete r.rootElement),Y(r.elements)){let l={};for(let[n,a]of Object.entries(r.elements)){if(!Y(a))continue;let u={...a};!u.type&&typeof u.component=="string"&&(u.type=u.component,delete u.component),l[n]=u}r.elements=l}return r}function Rr(s){return Y(s)?Object.values(s).some(t=>Y(t)&&"component"in t):!1}function Y(s){return s!==null&&typeof s=="object"&&!Array.isArray(s)}import{html as je,css as Re,nothing as zr}from"lit";import{LitElement as Lr}from"lit";var ce=class ce extends Lr{constructor(){super(...arguments);this._instanceId=`forge-${++ce._instanceCounter}`;this.props={};this.store=null;this.onAction=null;this.itemContext=null}static get properties(){return{props:{type:Object}}}connectedCallback(){super.connectedCallback()}resolve(e){if(!this.store)return e;this.itemContext&&J(this.itemContext);try{return E(this.store,e)}finally{J(null)}}getProp(e){let o=this.props?.[e];return typeof o=="string"&&(o.startsWith("$state:")||o.startsWith("$computed:")||o.startsWith("$item:")||o.startsWith("$expr:")||o.includes("{{")&&o.includes("}}"))?this.resolve(o):o}getArray(e){let o=this.getProp(e);return Array.isArray(o)?o:o&&typeof o=="object"?Object.values(o):[]}getString(e,o=""){let i=this.getProp(e);return typeof i=="string"?i:String(i??o)}getNumber(e,o=0){let i=this.getProp(e);return typeof i=="number"?i:Number(i)||o}getBool(e,o=!1){let i=this.getProp(e);return typeof i=="boolean"?i:o}getBoundProp(e,o){let i=typeof this.props?.bind=="string"?this.props.bind:"";if(i){let l=this.resolve(i);if(l!==void 0)return l}let r=this.getProp(e);return r===void 0?o:r}dispatchAction(e,o){let i=typeof this.props?.bind=="string"?this.props.bind:"",r=i?{...o||{},bind:i}:o;this.onAction&&this.onAction(e,r),this.dispatchEvent(new CustomEvent("forgeui-action",{detail:{action:e,payload:r},bubbles:!0,composed:!0}))}handleAction(e){let o=this.getString("action");o&&this.dispatchAction(o,this.props)}prop(e){return this.getProp(e)}static get sharedStyles(){return[_e]}gapValue(e){let o={none:"0",0:"0","3xs":"var(--forgeui-space-3xs)","2xs":"var(--forgeui-space-2xs)",xs:"var(--forgeui-space-xs)",sm:"var(--forgeui-space-sm)",md:"var(--forgeui-space-md)",lg:"var(--forgeui-space-lg)",xl:"var(--forgeui-space-xl)","2xl":"var(--forgeui-space-2xl)"};if(e==null||e==="")return"var(--forgeui-space-md)";let i=String(e);return i in o?o[i]:/^\d+(\.\d+)?$/.test(i)?`${i}px`:/^\d+(\.\d+)?(px|rem|em|%|vw|vh|ch)$/.test(i)?i:"var(--forgeui-space-md)"}static get styles(){return[_e]}};ce._instanceCounter=0;var g=ce;var Ie=class extends g{static get styles(){return Re`
  ...
  `}render(){let t=this.getString("label","Button"),e=this.getString("variant","primary"),o=this.getString("size",""),i=this.getBool("disabled"),r=this.getProp("pressed");return je`<button class="${e} ${o}" ?disabled=${i}
      aria-pressed=${r==null?zr:String(!!r)}
      @click=${l=>this.handleAction(l)}>${t}<slot></slot></button>`}};customElements.define("forgeui-button",Ie);var Te=class extends g{static get styles(){return Re`
    :host { display:flex; gap:var(--forgeui-space-xs); }
  `}render(){return je`<slot></slot>`}};customElements.define("forgeui-button-group",Te);var Ce=class extends g{static get styles(){return Re`
    :host { display:inline-flex; }
  ...
  `}render(){let t=this.getString("label",""),e=this.getString("href","#");return je`<a href="${e}">${t}<slot></slot></a>`}};customElements.define("forgeui-link",Ce);import{html as z,css as X,nothing as Wt}from"lit";var Le=class extends g{static get properties(){return{props:{type:Object}}}static get styles(){return X`
  ...
  `}render(){let t=this.getString("content",""),e=this.getString("variant","body"),i={h1:"heading1",h2:"heading2",h3:"heading3",title:"heading2",subtitle:"subheading",paragraph:"body",text:"body",secondary:"muted",tertiary:"caption"}[e]||e,r=this.getString("colorScheme",""),l=this.getString("align",""),n=this.getString("weight",""),a={primary:"var(--forgeui-color-primary)",secondary:"var(--forgeui-color-text-secondary)",tertiary:"var(--forgeui-color-text-tertiary)",success:"var(--forgeui-color-success)",warning:"var(--forgeui-color-warning)",error:"var(--forgeui-color-error)",info:"var(--forgeui-color-info)"},u={normal:"var(--forgeui-weight-normal)",medium:"var(--forgeui-weight-medium)",semibold:"var(--forgeui-weight-semibold)",bold:"var(--forgeui-weight-bold)"},c=[];r&&a[r]&&c.push(`color:${a[r]}`),n&&u[n]&&c.push(`font-weight:${u[n]}`);let d=l?`align-${l}`:"",p=z`${t}<slot></slot>`;return i==="heading1"?z`<h1 class="${i} ${d}" style="${c.join(";")}">${p}</h1>`:i==="heading2"?z`<h2 class="${i} ${d}" style="${c.join(";")}">${p}</h2>`:i==="heading3"?z`<h3 class="${i} ${d}" style="${c.join(";")}">${p}</h3>`:z`<div class="${i} ${d}" style="${c.join(";")}">${t}<slot></slot></div>`}};customElements.define("forgeui-text",Le);var ze=class extends g{static get styles(){return X`
    :host { display:block; }
    img { max-width:100%; height:auto; display:block; border-radius:var(--forgeui-radius-md); }
  `}render(){let t=this.getString("src",""),e=this.getString("alt",""),o=this.getString("fit","contain");return t?z`<img src="${t}" alt="${e}" style="object-fit:${o}" loading="lazy">`:z`${Wt}`}};customElements.define("forgeui-image",ze);var De=class extends g{static get styles(){return X`
    :host { display:inline-flex; align-items:center; justify-content:center; }
    svg { width:var(--forgeui-icon-md); height:var(--forgeui-icon-md); fill:currentColor; }
  `}render(){let t=this.getString("name","circle"),e={check:"M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z",x:"M6 18L18 6M6 6l12 12",plus:"M12 4v16m8-8H4",minus:"M20 12H4",chevron:"M9 5l7 7-7 7",arrow:"M13 7l5 5m0 0l-5 5m5-5H6",star:"M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.286 3.96a1 1 0 00.95.69h4.162c.969 0 1.371 1.24.588 1.81l-3.37 2.448a1 1 0 00-.364 1.118l1.287 3.96c.3.921-.755 1.688-1.54 1.118l-3.37-2.448a1 1 0 00-1.176 0l-3.37 2.448c-.784.57-1.838-.197-1.539-1.118l1.287-3.96a1 1 0 00-.364-1.118L2.063 8.387c-.783-.57-.38-1.81.588-1.81h4.162a1 1 0 00.95-.69l1.286-3.96z",circle:"M12 2a10 10 0 100 20 10 10 0 000-20z",alert:"M12 9v2m0 4h.01M4.93 4.93l14.14 14.14M12 2a10 10 0 100 20 10 10 0 000-20z"},o=e[t]||e.circle;return z`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="${o}"/></svg>`}};customElements.define("forgeui-icon",De);var Oe=class extends g{static get styles(){return X`
  ...
  `}render(){let t=this.getString("text","")||this.getString("label",""),e=this.getString("variant","");return z`<span class="badge" variant="${e}">${t}<slot></slot></span>`}};customElements.define("forgeui-badge",Oe);var Ue=class extends g{static get styles(){return X`
    :host { display:inline-flex; }
  ...
  `}render(){let t=this.getString("src",""),e=this.getString("name","?"),o=e.split(" ").map(i=>i[0]).join("").toUpperCase().slice(0,2);return z`<div class="avatar">${t?z`<img src="${t}" alt="${e}">`:o}<slot></slot></div>`}};customElements.define("forgeui-avatar",Ue);var Ne=class extends g{static get styles(){return X`
  ...
  `}render(){let t=this.getString("title","Nothing here"),e=this.getString("description","");return z`
      <div class="title">${t}</div>
      ${e?z`<div class="desc">${e}</div>`:Wt}
      <slot></slot>
    `}};customElements.define("forgeui-empty-state",Ne);import{html as b,css as ue,svg as F,nothing as A}from"lit";var Fe=class extends g{constructor(){super(...arguments);this._query="";this._sortKey="";this._sortDir="asc";this._page=0}static get styles(){return ue`
  ...
  `}_colKey(e){return typeof e=="string"?e:String(e?.key??"")}_colLabel(e){return typeof e=="string"?e:String(e?.label??e?.key??"")}_statusClass(e){let o=String(e??"").toLowerCase().trim();return["done","complete","completed","success","active","ok","approved","paid"].includes(o)?"success":["in progress","in-progress","pending","warning","waiting","review"].includes(o)?"warning":["to do","to-do","todo","backlog","draft","new","inactive"].includes(o)?"neutral":["high","urgent","critical"].includes(o)?"error":["medium","med"].includes(o)?"warning":["low"].includes(o)?"info":["failed","error","rejected","blocked","overdue"].includes(o)?"error":"neutral"}_renderCell(e,o){let i=this._colKey(e),r=o[i],l=e&&typeof e=="object"?e.type:void 0;if(r==null||r==="")return b`<span style="color:var(--forgeui-color-text-tertiary)">—</span>`;if(l==="badge"||l==="status"){let n=(e.variant&&typeof e.variant=="object"?e.variant[String(r).toLowerCase()]:null)||this._statusClass(r);return b`<span class="badge ${n}">${String(r)}</span>`}if(l==="number")return typeof r=="number"?r.toLocaleString():String(r);if(l==="date"){let n=typeof r=="string"||typeof r=="number"?new Date(r):r;return n instanceof Date&&!isNaN(n.getTime())?n.toLocaleDateString():String(r)}if(l==="currency"){let n=Number(r);return isNaN(n)?String(r):n.toLocaleString(void 0,{style:"currency",currency:e.currency||"USD"})}return l==="boolean"?r?"\u2713":"\u2717":String(r)}_sortBy(e){e&&(this._sortKey===e?this._sortDir=this._sortDir==="asc"?"desc":"asc":(this._sortKey=e,this._sortDir="asc"),this._page=0,this.requestUpdate())}_setQuery(e){this._query=e,this._page=0,this.requestUpdate()}_filteredRows(e,o){let i=this._query.trim().toLowerCase();return i?e.filter(r=>o.some(l=>String(r[this._colKey(l)]??"").toLowerCase().includes(i))):e}_sortedRows(e){if(!this._sortKey)return e;let o=this._sortDir==="asc"?1:-1;return[...e].sort((i,r)=>{let l=i?.[this._sortKey],n=r?.[this._sortKey];if(typeof l=="number"&&typeof n=="number")return(l-n)*o;let a=String(l??"").toLowerCase(),u=String(n??"").toLowerCase();return(a>u?1:a<u?-1:0)*o})}_setPage(e,o){this._page=Math.max(0,Math.min(e,Math.max(0,o-1))),this.requestUpdate()}render(){let e=this.getProp("data"),o=this.getProp("columns")||[],i=this.getString("emptyMessage","No data yet"),r=this.getString("rowAction",""),l=this.getString("caption",""),n=this.getBool("searchable",!1),a=Math.max(0,Math.floor(this.getNumber("pageSize",0)));if(!Array.isArray(e))return b`<div class="empty">${i}</div>`;let u=o.length>0?o:e.length>0?Object.keys(e[0]):[];if(u.length===0)return b`<div class="empty">${i}</div>`;let c=this._filteredRows(e,u),d=this._sortedRows(c),p=a>0?Math.max(1,Math.ceil(d.length/a)):1,v=Math.min(this._page,p-1);v!==this._page&&(this._page=v);let D=a>0?d.slice(v*a,v*a+a):d;return b`
      ${n?b`
        <input class="search-input" .value=${this._query} aria-label="Search"
          @input=${_=>this._setQuery(_.target.value)} />
      `:A}
      <table>
        ${l?b`<caption>${l}</caption>`:A}
        <thead><tr>${u.map(_=>{let x=this._colLabel(_),I=this._colKey(_),k=typeof _=="object"?_.align:void 0,P=typeof _=="object"?_.width:void 0,$=k==="right"?"align-right":k==="center"?"align-center":"",S=typeof _=="object"&&_.sortable===!0,m=this._sortKey===I;return b`<th class="${$}" style="${P?`width:${P}`:""}" aria-sort=${m?this._sortDir==="asc"?"ascending":"descending":A}>
            ${S?b`
              <button type="button" @click=${()=>this._sortBy(I)}>
                <span>${x}</span>${m?b`<span class="sort" aria-hidden="true">${this._sortDir==="asc"?"\u25B2":"\u25BC"}</span>`:A}
              </button>
            `:x}
          </th>`})}</tr></thead>
        <tbody>${D.length===0?b`<tr><td colspan=${u.length} class="empty">${i}</td></tr>`:D.map((_,x)=>{let I=a>0?v*a+x:x,k=!!r,P=k?String(_[typeof u[0]=="string"?u[0]:u[0]?.key]??`Row ${x+1}`):"";return b`<tr class="${k?"row-action":""}"
                tabindex=${k?0:A}
                role=${k?"button":A}
                aria-label=${k?P:A}
                @click=${k?()=>this.dispatchAction(r,{row:_,index:I}):void 0}
                @keydown=${k?$=>{($.key==="Enter"||$.key===" ")&&($.preventDefault(),this.dispatchAction(r,{row:_,index:I}))}:void 0}>
              ${u.map($=>{let S=typeof $=="object"?$.align:void 0;return b`<td class="${S==="right"?"align-right":S==="center"?"align-center":""}">${this._renderCell($,_)}</td>`})}</tr>`})}</tbody>
      </table>
      ${a>0&&d.length>0?b`
        <nav class="pager">
      ...
      `:A}
    `}};customElements.define("forgeui-table",Fe);var Be=class extends g{static get styles(){return ue`
    :host { display:block; }
  ...
  `}render(){let t=this.getProp("data"),e=this.getString("dataPath","");!("data"in(this.props||{}))&&e&&this.store?.hasTable(e)&&(t=Object.values(this.store.getTable(e)));let o=this.getString("emptyMessage","No items");return!Array.isArray(t)||t.length===0?b`<div class="empty">${o}</div>`:b`<div class="list">${t.map((i,r)=>b`
      <div class="item" data-index=${r}><slot name="item" .item=${i} .index=${r}>${JSON.stringify(i)}</slot></div>
    `)}</div>`}};customElements.define("forgeui-list",Be);var Ve=class extends g{constructor(){super(...arguments);this._palette=["var(--forgeui-color-primary)","var(--forgeui-color-success)","var(--forgeui-color-warning)","var(--forgeui-color-error)","var(--forgeui-color-info)","var(--forgeui-color-chart-6)","var(--forgeui-color-chart-7)","var(--forgeui-color-chart-8)","var(--forgeui-color-chart-9)","var(--forgeui-color-chart-10)"]}static get styles(){return ue`
    :host { display:block; min-width:0; }
  ...
  `}_niceMax(e){if(e<=0)return 1;let o=Math.pow(10,Math.floor(Math.log10(e))),i=e/o;return(i<=1?1:i<=2?2:i<=5?5:10)*o}render(){let e=this.getString("chartType","bar"),o=this.getProp("data")||[],i=this.getString("title",""),r=this.getString("xKey","label")||this.getString("labelKey","label"),l=this.getString("yKey","value")||this.getString("valueKey","value"),n=this.getString("color","");if(!o||o.length===0)return b`
        ${i?b`<div class="title">${i}</div>`:A}
        <div class="empty">No data to display</div>
      `;let a=o.map(x=>typeof x=="number"?{label:"",value:x}:x&&typeof x=="object"?{label:String(x[r]??x.label??x.name??x.x??""),value:Number(x[l]??x.value??x.y??0)||0,color:x.color}:{label:String(x),value:0}),u=600,c=260,d={top:8,right:16,bottom:36,left:48},p=u-d.left-d.right,v=c-d.top-d.bottom,D,_=A;if(e==="pie"||e==="donut"){let x=a.reduce((j,T)=>j+Math.max(0,T.value),0)||1,I=u/2,k=c/2,P=Math.min(p,v)/2-8,$=e==="donut"?P*.55:0,S=-Math.PI/2,m=[],w=[];a.forEach((j,T)=>{let V=Math.max(0,j.value)/x,R=S,L=S+V*Math.PI*2;S=L;let Q=L-R>Math.PI?1:0,ae=I+P*Math.cos(R),wt=k+P*Math.sin(R),$t=I+P*Math.cos(L),kt=k+P*Math.sin(L),de=j.color||this._palette[T%this._palette.length];if(w.push(de),$>0){let Gt=I+$*Math.cos(R),Jt=k+$*Math.sin(R),Zt=I+$*Math.cos(L),Yt=k+$*Math.sin(L);m.push(F`<path class="slice" fill="${de}" d="M ${ae} ${wt} A ${P} ${P} 0 ${Q} 1 ${$t} ${kt} L ${Zt} ${Yt} A ${$} ${$} 0 ${Q} 0 ${Gt} ${Jt} Z"/>`)}else m.push(F`<path class="slice" fill="${de}" d="M ${I} ${k} L ${ae} ${wt} A ${P} ${P} 0 ${Q} 1 ${$t} ${kt} Z"/>`)}),D=F`<g>${m}</g>`,_=b`<div class="legend">${a.map((j,T)=>b`
        <span class="legend-item"><span class="swatch" style="background:${w[T]}"></span>${j.label} (${j.value})</span>
      `)}</div>`}else{let x=Math.max(...a.map(S=>S.value),0),I=this._niceMax(x),k=S=>d.top+v-S/I*v,P=4,$=[];for(let S=0;S<=P;S++){let m=I*S/P,w=k(m);$.push(F`<line class="grid" x1="${d.left}" x2="${d.left+p}" y1="${w}" y2="${w}"/>`),$.push(F`<text class="tick-label" x="${d.left-6}" y="${w+3}" text-anchor="end">${m.toLocaleString()}</text>`)}if(e==="line"||e==="area"){let S=p/Math.max(1,a.length-1),m=a.map((T,V)=>{let R=d.left+V*S,L=k(T.value);return`${V===0?"M":"L"} ${R} ${L}`}).join(" "),w=e==="area"?m+` L ${d.left+p} ${d.top+v} L ${d.left} ${d.top+v} Z`:"",j=n||"var(--forgeui-color-primary)";D=b`
          <g>${$}</g>
          ${e==="area"?F`<path class="area" d="${w}" style="fill:${j};opacity:0.15"/>`:A}
          ${F`<path class="line" d="${m}" style="stroke:${j}"/>`}
          ${a.map((T,V)=>{let R=d.left+V*S,L=k(T.value);return F`<circle class="point" cx="${R}" cy="${L}" r="3" style="fill:${j}"/>
              <text class="tick-label" x="${R}" y="${d.top+v+14}" text-anchor="middle">${T.label}</text>`})}
        `}else{let S=a.length,m=p/S,w=Math.max(2,m*.7),j=m-w;D=b`
          <g>${$}</g>
          ${a.map((T,V)=>{let R=d.left+V*m+j/2,L=k(T.value),Q=Math.max(0,d.top+v-L),ae=T.color||n||"var(--forgeui-color-primary)";return F`<rect class="bar" x="${R}" y="${L}" width="${w}" height="${Q}" rx="2" style="fill:${ae}">
                <title>${T.label}: ${T.value}</title>
              </rect>
              <text class="tick-label" x="${R+w/2}" y="${d.top+v+14}" text-anchor="middle">${T.label}</text>`})}
        `}}return b`
      ${i?b`<div class="title">${i}</div>`:A}
      <div class="wrap">
    ...
    `}};customElements.define("forgeui-chart",Ve);var qe=class extends g{static get styles(){return ue`
  ...
  `}_trendMeta(t){if(t==null||t==="")return null;if(typeof t=="number")return t>0?{dir:"up",arrow:"\u2191",display:`${Math.abs(t)}%`}:t<0?{dir:"down",arrow:"\u2193",display:`${Math.abs(t)}%`}:{dir:"neutral",arrow:"\u2192",display:"0%"};if(typeof t=="string"){let e=t.toLowerCase(),o=t.match(/^\s*([+-]?\d+(?:\.\d+)?)\s*(%?)\s*$/);if(o){let i=parseFloat(o[1]),r=o[2];return i>0?{dir:"up",arrow:"\u2191",display:`${Math.abs(i)}${r}`}:i<0?{dir:"down",arrow:"\u2193",display:`${Math.abs(i)}${r}`}:{dir:"neutral",arrow:"\u2192",display:`0${r}`}}return e==="up"||e==="positive"||e==="increase"?{dir:"up",arrow:"\u2191",display:""}:e==="down"||e==="negative"||e==="decrease"?{dir:"down",arrow:"\u2193",display:""}:e==="flat"||e==="neutral"||e==="same"?{dir:"neutral",arrow:"\u2192",display:""}:{dir:"neutral",arrow:"",display:t}}return null}render(){let t=this.getString("label",""),e=this.getProp("value"),o=this.getProp("trend"),i=this.getString("trendLabel",""),r=this.getProp("goal"),l=this.getString("unit",""),n=this.getString("suffix",""),a=this.getString("subtitle",""),u=this.getString("variant","");u&&this.setAttribute("variant",u);let c=typeof e=="number"?e.toLocaleString():e==null||e===""?"\u2014":String(e),d=this._trendMeta(o);return b`
      ${t?b`<div class="label">${t}</div>`:A}
      <div class="value-row">
        <span class="value">${c}</span>
        ${l?b`<span class="unit">${l}</span>`:A}
        ${n?b`<span class="suffix">${n}</span>`:A}
        ${d?b`<span class="trend ${d.dir} ${!d.display&&!i?"icon-only":""}">${d.arrow}${d.display?b` ${d.display}`:A}${i?b` ${i}`:A}</span>`:A}
      </div>
      ${a?b`<div class="subtitle">${a}</div>`:A}
      ${r!=null&&r!==""?b`<div class="goal">Goal: ${typeof r=="number"?r.toLocaleString():r}</div>`:A}
    `}};customElements.define("forgeui-metric",qe);import{css as Dr,svg as q}from"lit";var Ke=class extends g{static get properties(){return{props:{type:Object}}}static get styles(){return Dr`
    :host { display:block; }
    svg { display:block; }
  `}render(){let t=this.getNumber("width",400),e=this.getNumber("height",300),o=this.getString("background","transparent"),i=this.getProp("shapes")||[];return q`
      <svg width="${t}" height="${e}" style="background:${o}" viewBox="0 0 ${t} ${e}">
        ${i.map(r=>this.renderShape(r))}
      </svg>
    `}renderShape(t){let e={fill:t.fill??void 0,stroke:t.stroke??void 0,"stroke-width":t.strokeWidth??void 0,opacity:t.opacity??void 0},o=t.action?()=>{this.onAction&&this.onAction(t.action)}:void 0,i=t.action?"cursor:pointer":void 0;switch(t.type){case"rect":return q`<rect
          x="${t.x??0}" y="${t.y??0}"
        ...
        />`;case"text":return q`<text
          ...
          style="${i}"
          @click=${o}
        >${t.content??""}</text>`;case"path":return q`<path
          d="${t.d??""}"
          fill="${e.fill??"none"}"
          stroke="${e.stroke??"none"}"
          stroke-width="${e["stroke-width"]??1}"
          ...
          style="${i}"
          @click=${o}
        />`;default:return q``}}};customElements.define("forgeui-drawing",Ke);import{html as O,css as ie,nothing as K}from"lit";var We=class extends g{static get styles(){return ie`
  ...
  `}render(){let t=this.getString("variant","info"),e=this.getString("title",""),o=this.getString("message","");return O`<div class="alert ${t}" role=${t==="error"||t==="warning"?"alert":"status"}>
      ${e?O`<strong>${e}</strong> `:K}${o}<slot></slot>
    </div>`}};customElements.define("forgeui-alert",We);var He=class extends g{constructor(){super(...arguments);this._priorFocus=null;this._keydownHandler=e=>this._onKeydown(e);this._close=()=>{this.dispatchAction("close")}}static get styles(){return ie`
    :host { display:none; }
  ...
  `}render(){let e=this.getString("title",""),o=this.getBool("open"),i=`${this._instanceId}-title`;return o?this.setAttribute("open",""):this.removeAttribute("open"),o?O`
      <div class="backdrop" @click=${this._close}></div>
      <div
        class="dialog"
        role="dialog"
        aria-modal="true"
        aria-labelledby="${e?i:K}"
        tabindex="-1"
        @click=${r=>r.stopPropagation()}
      >
        ${e?O`<h2 id="${i}" class="title">${e}</h2>`:K}
        <slot></slot>
      </div>
    `:K}updated(e){if(super.updated?.(e),e.has("props")){let o=this.getBool("open"),r=e.get("props")?.open??!1;o&&!r?this._onOpen():!o&&r&&this._onClose()}}_onOpen(){this._priorFocus=document.activeElement instanceof HTMLElement?document.activeElement:null,document.addEventListener("keydown",this._keydownHandler),requestAnimationFrame(()=>{let e=this.shadowRoot?.querySelector(".dialog");(this._firstFocusableInDialog()??e)?.focus()})}_onClose(){document.removeEventListener("keydown",this._keydownHandler),this._priorFocus instanceof HTMLElement&&this._priorFocus.focus(),this._priorFocus=null}disconnectedCallback(){super.disconnectedCallback?.(),document.removeEventListener("keydown",this._keydownHandler)}_onKeydown(e){if(e.key==="Escape"){e.preventDefault(),this._close();return}e.key==="Tab"&&this._trapFocus(e)}_trapFocus(e){let o=this._allFocusableInDialog();if(o.length===0){e.preventDefault();return}let i=o[0],r=o[o.length-1],l=this.shadowRoot?.activeElement??document.activeElement;e.shiftKey?(l===i||!this._dialogContains(l))&&(e.preventDefault(),r.focus()):(l===r||!this._dialogContains(l))&&(e.preventDefault(),i.focus())}_firstFocusableInDialog(){return this._allFocusableInDialog()[0]??null}_allFocusableInDialog(){let e=this.shadowRoot?.querySelector(".dialog");if(!e)return[];let o='button, [href], input:not([type="hidden"]), select, textarea, [tabindex]:not([tabindex="-1"])',i=Array.from(e.querySelectorAll(o)),r=e.querySelector("slot"),l=r instanceof HTMLSlotElement?r.assignedElements({flatten:!0}).flatMap(n=>[n,...Array.from(n.querySelectorAll(o))].filter(u=>u instanceof HTMLElement&&u.matches(o))):[];return[...i,...l].filter(n=>!n.disabled)}_dialogContains(e){return e?this.shadowRoot?.querySelector(".dialog")?.contains(e)??!1:!1}};customElements.define("forgeui-dialog",He);var Ge=class extends g{static get styles(){return ie`
  ...
  `}render(){let t=this.getProp("value"),e=this.getNumber("max",100),o=t==null,i=o?0:Math.max(0,Math.min(Number(t),e)),r=o?0:i/e*100,l=this.getString("label",""),n=this.getBool("showValue");return O`
      ${l||n?O`
        <div class="meta">
          ${l?O`<span>${l}</span>`:O`<span></span>`}
          ${n?O`<span class="value">${Math.round(r)}%</span>`:K}
        </div>
      `:K}
      <div
    ...
    `}};customElements.define("forgeui-progress",Ge);var Je=class extends g{static get styles(){return ie`
  ...
  `}render(){let t=this.getString("message","");return t?O`<div class="toast">${t}</div>`:O`${K}`}};customElements.define("forgeui-toast",Je);var Ze=class extends g{static get styles(){return ie`
    :host { display:block; }
  ...
  `}render(){let t=this.getString("msg","Unknown error");return O`<div class="error" role="alert">⚠ ${t}</div>`}};customElements.define("forgeui-error",Ze);import{html as y,css as N,nothing as M}from"lit";var Ye=class extends g{static get styles(){return N`
  ...
  `}render(){let t=this.getString("label",""),e=this.getString("placeholder",""),o=this.getString("hint",""),i=this.getString("error",""),r=this.getString("inputType","")||this.getString("type","text"),l=this.getBool("multiline"),n=String(this.getBoundProp("value","")??""),a=this._instanceId;return y`
      ${t?y`<label for="${a}">${t}</label>`:M}
      ${l?y`<textarea id="${a}" placeholder="${e}" .value=${n} @input=${u=>this.dispatchAction("change",{value:u.target.value})}></textarea>`:y`<input id="${a}" type="${r}" placeholder="${e}" .value=${n} @input=${u=>this.dispatchAction("change",{value:u.target.value})}>`}
      ${o&&!i?y`<div class="hint">${o}</div>`:M}
      ${i?y`<div class="error">${i}</div>`:M}
    `}};customElements.define("forgeui-text-input",Ye);var Xe=class extends g{static get styles(){return N`
    :host { display:block; flex:1 1 auto; min-width:0; max-width:100%; margin-bottom:var(--forgeui-space-sm); }
    label { display:block; font-size:var(--forgeui-text-sm); font-weight:var(--forgeui-weight-medium); margin-bottom:var(--forgeui-space-2xs); color:var(--forgeui-color-text); overflow-wrap:break-word; }
    ...
    .hint { font-size:var(--forgeui-text-xs); color:var(--forgeui-color-text-tertiary); margin-top:var(--forgeui-space-2xs); }
    .error { font-size:var(--forgeui-text-xs); color:var(--forgeui-color-error); margin-top:var(--forgeui-space-2xs); }
  `}render(){let t=this.getString("label",""),e=this.getString("placeholder",""),o=this.getString("hint",""),i=this.getString("error",""),r=Math.max(1,Math.floor(this.getNumber("rows",4))),l=this.getProp("maxLength"),n=this.getBool("required"),a=this.getBool("disabled"),u=String(this.getBoundProp("value","")??""),c=this._instanceId;return y`
      ${t?y`<label for="${c}">${t}</label>`:M}
      <textarea id="${c}" rows=${r} placeholder="${e}" maxlength=${l??M}
        ?required=${n} ?disabled=${a} .value=${u}
        @input=${d=>this.dispatchAction("change",{value:d.target.value})}></textarea>
      ${o&&!i?y`<div class="hint">${o}</div>`:M}
      ${i?y`<div class="error">${i}</div>`:M}
    `}};customElements.define("forgeui-textarea",Xe);var Qe=class extends g{static get styles(){return N`
    :host { display:block; flex:1 1 auto; min-width:0; max-width:100%; margin-bottom:var(--forgeui-space-sm); }
  ...
  `}render(){let t=this.getString("label",""),e=this.getProp("min"),o=this.getProp("max"),i=this.getProp("step"),r=this.getBoundProp("value"),l=this._instanceId;return y`
      ${t?y`<label for="${l}">${t}</label>`:M}
      <input id="${l}" type="number" min=${e} max=${o} step=${i} .value=${r??""}
        @input=${n=>this.dispatchAction("change",{value:Number(n.target.value)})}>
    `}};customElements.define("forgeui-number-input",Qe);var et=class extends g{static get styles(){return N`
    :host { display:block; flex:1 1 auto; min-width:0; max-width:100%; margin-bottom:var(--forgeui-space-sm); }
    label { display:block; font-size:var(--forgeui-text-sm); font-weight:var(--forgeui-weight-medium); margin-bottom:var(--forgeui-space-2xs); overflow-wrap:break-word; }
  ...
  `}render(){let t=this.getString("label",""),e=this.getProp("options")||[],o=String(this.getBoundProp("value","")??""),i=this._instanceId;return y`
      ${t?y`<label for="${i}">${t}</label>`:M}
      <select id="${i}" .value=${o} @change=${r=>this.dispatchAction("change",{value:r.target.value})}>
        ${e.map(r=>y`<option value=${typeof r=="string"?r:r.value} ?selected=${(typeof r=="string"?r:r.value)===o}>
          ${typeof r=="string"?r:r.label||r.value}
        </option>`)}
      </select>
    `}};customElements.define("forgeui-select",et);var tt=class extends g{static get styles(){return N`
  ...
  `}render(){let t=this.getString("label",""),e=this.getProp("options")||[],o=this.getBoundProp("value",this.getProp("selected")??[]),i=Number(this.getProp("maxSelections")),r=Number.isFinite(i)&&i>=0?i:1/0,l=(Array.isArray(o)?o.map(c=>String(c)):[]).slice(0,r),n=this.getBool("disabled"),a=this._instanceId,u=c=>{let d=l.filter(p=>p!==c);this.dispatchAction("remove",{value:c}),this.dispatchAction("change",{value:d,selected:d})};return y`
      ...
      <select id="${a}" multiple ?disabled=${n}
        ...
        ${e.map(c=>{let d=String(typeof c=="string"?c:c?.value??c?.label??"");return y`<option value=${d} ?selected=${l.includes(d)}>
            ${typeof c=="string"?c:c?.label??d}
          </option>`})}
      </select>
      <div class="tags">
        ${l.map(c=>y`<span class="tag">${c}<button type="button" aria-label=${`Remove ${c}`} @click=${()=>u(c)}>×</button></span>`)}
        <slot></slot>
      </div>
    `}};customElements.define("forgeui-multi-select",tt);var rt=class extends g{static get styles(){return N`
    :host { display:block; margin-bottom:var(--forgeui-space-sm); }
    ...
    .hint { font-size:var(--forgeui-text-xs); color:var(--forgeui-color-text-tertiary); margin-top:var(--forgeui-space-2xs); }
  `}render(){let t=this.getString("label",""),e=this.getString("hint",""),o=this.getProp("options")||[],i=String(this.getBoundProp("value","")??""),r=this.getBool("disabled"),l=this._instanceId;return y`
      <fieldset ?disabled=${r}>
        ${t?y`<legend>${t}</legend>`:M}
        <div class="options">
          ${o.map((n,a)=>{let u=String(typeof n=="string"?n:n?.value??n?.label??""),c=String(typeof n=="string"?n:n?.label??u),d=`${l}-${a}`;return y`<label for=${d}>
      ...
      ${e?y`<div class="hint">${e}</div>`:M}
    `}};customElements.define("forgeui-radio-group",rt);var ot=class extends g{static get styles(){return N`
  ...
  `}render(){let t=this.getString("label",""),e=!!this.getBoundProp("checked",this.getProp("value")??!1),o=this._instanceId;return y`
      <input id="${o}" type="checkbox" ?checked=${e} @change=${i=>this.dispatchAction("change",{checked:i.target.checked})}>
      ${t?y`<label for="${o}">${t}</label>`:M}
    `}};customElements.define("forgeui-checkbox",ot);var it=class extends g{constructor(){super(...arguments);this._toggle=()=>{if(this.getBool("disabled"))return;let e=!!this.getBoundProp("on",this.getProp("value")??!1);this.dispatchAction("change",{value:!e,checked:!e})};this._onKeydown=e=>{(e.key==="Enter"||e.key===" "||e.key==="Spacebar")&&(e.preventDefault(),this._toggle())}}static get styles(){return N`
  ...
  `}render(){let e=!!this.getBoundProp("on",this.getProp("value")??!1),o=this.getString("label",""),i=this.getBool("disabled"),r=this._instanceId;return y`
      <label for="${r}" class="toggle-label">
        ...
        ></button>
        ${o?y`<span class="toggle-text">${o}</span>`:M}
      </label>
    `}};customElements.define("forgeui-toggle",it);var st=class extends g{static get styles(){return N`
    :host { display:block; flex:1 1 auto; min-width:0; max-width:100%; margin-bottom:var(--forgeui-space-sm); }
    label { display:block; font-size:var(--forgeui-text-sm); font-weight:var(--forgeui-weight-medium); margin-bottom:var(--forgeui-space-2xs); overflow-wrap:break-word; }
    input { width:100%; padding:var(--forgeui-space-xs) var(--forgeui-space-sm); border:1px solid var(--forgeui-color-border);
      border-radius:var(--forgeui-radius-md); font:inherit; height:var(--forgeui-input-height);
      background:var(--forgeui-color-surface); color:var(--forgeui-color-text); box-sizing:border-box; min-width:0; }
    input:focus { outline:none; border-color:var(--forgeui-color-primary); box-shadow:0 0 0 3px var(--forgeui-color-primary-subtle); }
  `}render(){let t=this.getString("label",""),e=this.getString("value",""),o=this._instanceId;return y`
      ${t?y`<label for="${o}">${t}</label>`:M}
      <input id="${o}" type="date" .value=${e} @change=${i=>this.dispatchAction("change",{value:i.target.value})}>
    `}};customElements.define("forgeui-date-picker",st);var nt=class extends g{static get styles(){return N`
    :host { display:block; flex:1 1 auto; min-width:0; max-width:100%; margin-bottom:var(--forgeui-space-sm); }
    label { display:block; font-size:var(--forgeui-text-sm); font-weight:var(--forgeui-weight-medium); margin-bottom:var(--forgeui-space-2xs); overflow-wrap:break-word; }
  ...
  `}render(){let t=this.getString("label",""),e=this.getNumber("min",0),o=this.getNumber("max",100),i=this.getNumber("step",1),r=this.getBoundProp("value",e),l=Number(r);Number.isFinite(l)||(l=e);let n=this._instanceId;return y`
      ${t?y`<label for="${n}">${t}</label>`:M}
      <input id="${n}" type="range" min=${e} max=${o} step=${i} .value=${l}
        @input=${a=>this.dispatchAction("change",{value:Number(a.target.value)})}>
      <div class="value">${l}</div>
    `}};customElements.define("forgeui-slider",nt);var at=class extends g{constructor(){super(...arguments);this._dragging=!1;this._openFilePicker=()=>{this.shadowRoot?.querySelector('input[type="file"]')?.click()};this._onDropzoneKeydown=e=>{e.key!=="Enter"&&e.key!==" "||(e.preventDefault(),this._openFilePicker())};this._onFileChange=e=>{let o=Array.from(e.target.files??[]);this._processFiles(o)};this._onDragOver=e=>{e.preventDefault(),!this._dragging&&(this._dragging=!0,this.requestUpdate())};this._onDragLeave=e=>{e.currentTarget===e.target&&(this._dragging=!1,this.requestUpdate())};this._onDrop=e=>{e.preventDefault(),this._dragging=!1,this.requestUpdate(),this._processFiles(Array.from(e.dataTransfer?.files??[]))}}static get styles(){return N`
    :host { display:block; margin-bottom:var(--forgeui-space-sm); }
  ...
  `}_maxSizeBytes(){let e=this.getProp("maxSize");if(typeof e=="number"&&Number.isFinite(e)&&e>=0)return Math.floor(e);if(typeof e!="string")return null;let o=e.trim().match(/^(\d+(?:\.\d+)?)\s*(b|kb|mb|gb)?$/i);if(!o)return null;let i=Number(o[1]),r=(o[2]||"b").toLowerCase(),l=r==="gb"?1<<30:r==="mb"?1<<20:r==="kb"?1024:1,n=i*l;return Number.isFinite(n)?Math.floor(n):null}_newFileId(){return globalThis.crypto?.randomUUID?.()??`${Date.now()}_${Math.random().toString(36).slice(2)}`}_processFiles(e){let o=this.getBool("multiple"),i=this._maxSizeBytes(),r=(o?e:e.slice(0,1)).map(d=>{let p=this._newFileId(),v=i==null||d.size<=i,D={id:p,name:d.name,size:d.size,type:d.type,lastModified:d.lastModified,accepted:v,storageKey:v?p:null};return v||(D.error="maxSize"),[d,D]}),l=r.filter(([,d])=>d.accepted),n=r.map(([,d])=>d),a=l.map(([,d])=>d),u=o?a:a[0]??null,c=a[0]??null;this.dispatchAction("change",{id:c?.id??null,uuid:c?.id??null,name:c?.name??null,size:c?.size??null,type:c?.type??null,lastModified:c?.lastModified??null,storageKey:c?.storageKey??null,value:u,files:n,rejected:n.filter(d=>!d.accepted),multiple:o,maxSize:i}),Vt(l.map(([d,p])=>({file:d,id:p.id})))}render(){let e=this.getString("label","Upload file"),o=this.getString("accept","*"),i=this.getBool("multiple");return y`
    ...
    `}};customElements.define("forgeui-file-upload",at);import{html as C,css as B,nothing as lt}from"lit";var ct=class extends g{static get properties(){return{props:{type:Object}}}static get styles(){return B`
  ...
  `}render(){let t=this.getProp("columns"),e;typeof t=="number"?e=String(t):typeof t=="string"&&t?e=t:e="1";let o=/^\d+$/.test(e)?`repeat(${e}, minmax(0, 1fr))`:e,i=this.getString("gap","md"),r=this.gapValue(i),l=this.getString("padding",""),n=l?this.gapValue(l):"0";return this.style.gridTemplateColumns=o,this.style.gap=r,this.style.padding=n,/^\d+$/.test(e)&&Number(e)>=2&&this.setAttribute("responsive",""),C`<slot></slot>`}};customElements.define("forgeui-grid",ut);var dt=class extends g{static get properties(){return{props:{type:Object}}}static get styles(){return B`
  ...
  `}render(){let t=this.getString("variant",""),e=this.getString("title",""),o=this.getString("subtitle","");return t&&this.setAttribute("variant",t),C`
      ${e||o?C`
        <div class="header">
          ${e?C`<div class="title">${e}</div>`:lt}
          ${o?C`<div class="subtitle">${o}</div>`:lt}
        </div>
      `:lt}
      <div class="body"><slot></slot></div>
    `}};customElements.define("forgeui-card",dt);var pt=class extends g{static get properties(){return{props:{type:Object}}}static get styles(){return B`:host { display:block; margin-inline:auto; width:100%; box-sizing:border-box; }`}render(){let t=this.getString("maxWidth",""),e={sm:"640px",md:"768px",lg:"1024px",xl:"1280px","2xl":"1536px",full:"100%",none:"none","":""},o=t in e?e[t]:t,i=this.getString("padding","");return o&&o!=="none"?this.style.maxWidth=o:this.style.maxWidth="",this.style.padding=i?this.gapValue(i):"",C`<slot></slot>`}};customElements.define("forgeui-container",pt);var gt=class extends g{static get properties(){return{props:{type:Object}}}constructor(){super(),this._active=""}static get styles(){return B`
    :host { display:block; }
  ...
  `}_itemKey(t){return typeof t=="string"?t:String(t&&typeof t=="object"?t.id??t.key??t.value??t.label??"":t??"")}_itemLabel(t){return typeof t=="string"?t:String(t&&typeof t=="object"?t.label??t.title??t.value??"":t??"")}updated(){Array.from(this.children).filter(e=>!(e instanceof HTMLScriptElement)).forEach((e,o)=>{let i=(e.props||{}).slot??e.getAttribute("slot");String(o)===this._active||i===this._active?e.setAttribute("data-active",""):e.removeAttribute("data-active")})}_moveTo(t,e){let o=this._itemKey(e[t])||String(t);this._active=o,this.requestUpdate(),this.dispatchAction("tab-change",{active:o,value:o}),this.updateComplete.then(()=>{this.shadowRoot?.querySelector(`#${this._instanceId}-tab-${t}`)?.focus()})}render(){let t=this.getProp("items")||this.getProp("tabs")||[],e=Array.isArray(t)?t:[],o=this.getBoundProp("activeTab",this.getProp("value"));o!==void 0&&String(o)!==this._active&&(this._active=String(o)),!this._active&&e.length>0&&(this._active=this._itemKey(e[0])||"0");let i=e.findIndex((l,n)=>(this._itemKey(l)||String(n))===this._active),r=(l,n)=>{let a=-1;l.key==="ArrowRight"?a=(n+1)%e.length:l.key==="ArrowLeft"?a=(n-1+e.length)%e.length:l.key==="Home"?a=0:l.key==="End"&&(a=e.length-1),a!==-1&&(l.preventDefault(),this._moveTo(a,e))};return C`
    ...
    `}};customElements.define("forgeui-tabs",gt);var ft=class extends g{static get properties(){return{props:{type:Object}}}static get styles(){return B`
    :host { display:block; }
  ...
  `}render(){let t=this.getString("title","Section");return C`<details><summary>${t}</summary><div class="content"><slot></slot></div></details>`}};customElements.define("forgeui-accordion",ft);var mt=class extends g{static get styles(){return B`
    :host { display:block; }
    hr { border:none; border-top:1px solid var(--forgeui-color-border); margin:var(--forgeui-space-sm) 0; }
  `}render(){return C`<hr>`}};customElements.define("forgeui-divider",mt);var ht=class extends g{static get styles(){return B`:host { display:block; }`}render(){let t=this.getString("size","md"),e=this.getString("height",""),o=this.getString("width",""),i=e?this.gapValue(e):this.gapValue(t),r=o?/^\d+(\.\d+)?%$/.test(o)?o:this.gapValue(o):"";return C`<div style="height:${i};${r?`width:${r}`:""}"></div>`}};customElements.define("forgeui-spacer",ht);var bt=class extends g{static get properties(){return{props:{type:Object}}}static get styles(){return B`
    :host { display:flex; flex-direction:column; gap:var(--forgeui-space-md); min-width:0; }
    :host([direction="row"]) { flex-direction:row; flex-wrap:wrap; }
    .empty { padding:var(--forgeui-space-lg); text-align:center; color:var(--forgeui-color-text-tertiary); font-size:var(--forgeui-text-sm); }
  `}render(){let t=this.getArray("data"),e=this.getString("emptyMessage",""),o=this.getString("direction","column");(o==="row"||o==="horizontal")&&this.setAttribute("direction","row");let i=this.getString("gap","md");return this.style.gap=this.gapValue(i),t.length===0&&e?C`<div class="empty">${e}</div>`:C`<slot></slot>`}};customElements.define("forgeui-repeater",bt);import{html as H,css as Ht,nothing as Or}from"lit";var yt=class extends g{static get styles(){return Ht`
  ...
  `}render(){let t=this.getProp("items")||[];return H`${t.map((e,o)=>{let i=o===t.length-1,r=typeof e=="string"?e:e.label,l=typeof e=="string"?"#":e.href;return H`
        ${o>0?H`<span class="sep">/</span>`:Or}
        ${i?H`<span class="current">${r}</span>`:H`<a href="${l}">${r}</a>`}
      `})}`}};customElements.define("forgeui-breadcrumb",yt);var vt=class extends g{static get styles(){return Ht`
