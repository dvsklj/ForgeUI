...
`)}function me(){return{type:"object",required:["manifest","id","elements"],properties:{manifest:{type:"string",const:"0.1.0"},id:{type:"string",pattern:"^[a-z0-9][a-z0-9-]*$"},root:{type:"string"},title:{type:"string"},schema:{type:"object",properties:{version:{type:"number"},tables:{type:"object",additionalProperties:{type:"object",properties:{columns:{type:"object",additionalProperties:{type:"object",properties:{type:{type:"string",enum:["string","number","boolean"]},default:{}},required:["type"]}}},required:["columns"]}}}},state:{type:"object",additionalProperties:{}},elements:{type:"object",additionalProperties:{type:"object",properties:{type:{type:"string",enum:se},props:{type:"object"},children:{type:"array",items:{type:"string"}},visible:{type:"object",properties:{$when:{type:"object",properties:{path:{type:"string"},eq:{},neq:{},gt:{type:"number"},lt:{type:"number"},gte:{type:"number"},lte:{type:"number"},in:{type:"array"},notIn:{type:"array"},exists:{type:"boolean"}},required:["path"]}}}},required:["type"]}},actions:{type:"object",additionalProperties:{type:"object",properties:{type:{type:"string",enum:["mutateState","navigate","openDialog","closeDialog","callApi","toast","custom"]},path:{type:"string"},value:{},operation:{type:"string",enum:["set","append","update","delete","increment","decrement","toggle"]},set:{type:"object"},data:{type:"object"},key:{type:"string"},formId:{type:"string"},action:{type:"string"},target:{type:"string"},url:{type:"string"},method:{type:"string"},body:{type:"object"}},required:["type"]}},dataAccess:{type:"object",properties:{enabled:{type:"boolean",default:!1},readable:{type:"array",items:{type:"string"}},restricted:{type:"array",items:{type:"string"}},summaries:{type:"boolean",default:!1}}},persistState:{type:"boolean"},skipPersistState:{type:"boolean"}}}}var dr={container:"Stack",row:"Stack",column:"Stack",text:"Text",heading:"Text",label:"Text",image:"Image",icon:"Icon",button:"Button",link:"Link",textInput:"TextInput",numberInput:"NumberInput",checkbox:"Checkbox",toggle:"Toggle",select:"Select",divider:"Divider",spacer:"Spacer",card:"Card",table:"Table",list:"List",alert:"Alert",progress:"Progress",badge:"Badge",avatar:"Avatar"};function pr(s){let t={},e=0;function o(n){let a=n.id||`a2ui-${e++}`,u=dr[n.type];if(!u||!H(u))return t[a]={type:"Text",props:{content:`[Unsupported A2UI type: ${n.type}]`,variant:"caption",colorScheme:"secondary"}},a;let c=gr(n.type,n.props||{}),d=(n.children||[]).map(g=>o(g));return t[a]={type:u,props:c,children:d.length>0?d:void 0},a}let r=(s.components||s.content||[]).map(n=>o(n)),l=r.length===1?r[0]:"a2ui-root";return r.length>1&&(t[l]={type:"Stack",props:{gap:"md"},children:r}),{manifest:"0.1.0",id:`a2ui-${Date.now()}`,root:l,elements:t,actions:{}}}function gr(s,t){let e={...t};switch(s){case"heading":e.variant="heading",e.content=t.text||t.content||"",delete e.text;break;case"text":case"label":e.content=t.text||t.content||"",delete e.text;break;case"row":e.direction="row",e.gap=t.gap||t.spacing||"md";break;case"column":e.direction="column",e.gap=t.gap||t.spacing||"md";break;case"container":e.gap=t.gap||t.spacing||"md";break;case"image":e.src=t.src||t.url||"",e.alt=t.alt||"";break;case"button":e.label=t.text||t.label||"",e.variant=t.variant||t.style||"default";break;case"textInput":e.placeholder=t.placeholder||"",e.value=t.value||"",e.label=t.label||"";break;case"numberInput":e.placeholder=t.placeholder||"",e.value=t.value??0,e.label=t.label||"";break;case"select":t.options&&Array.isArray(t.options)&&(e.options=t.options.map(o=>typeof o=="string"?{value:o,label:o}:o));break;case"alert":e.variant=t.type||t.severity||"info",e.content=t.message||t.text||t.content||"",delete e.message,delete e.text;break;case"progress":e.value=t.value??t.percent??0;break}return e}function St(s){if(!s||typeof s!="object")return!1;let t=s;return!!(Array.isArray(t.components)||Array.isArray(t.content)||typeof t.type=="string"&&(t.type==="adaptive-card"||t.type.startsWith("a2ui"))||typeof t.version=="string"&&t.version.startsWith("a2ui")||!t.elements&&!t.manifest&&Array.isArray(t.content))}function he(s){return St(s)?pr(s):s}function _t(s){return`forgeui_${(s||"global").replace(/[^a-zA-Z0-9-]/g,"_")}`}var be="f";function fr(s){return new Promise((t,e)=>{let o=r=>e(r??new Error("IDB"));if(!globalThis.indexedDB)return o();let i=indexedDB.open(`${_t(s)}_f`,1);i.onupgradeneeded=()=>{i.result.createObjectStore(be)},i.onsuccess=()=>t(i.result),i.onerror=i.onblocked=()=>o(i.error)})}async function At(s,t){if(s.length===0)return;let e=null;try{e=await fr(t),await new Promise((o,i)=>{let r=e.transaction(be,"readwrite"),l=r.objectStore(be);for(let{file:n,id:a}of s)l.put(n,a);r.oncomplete=()=>o(),r.onerror=r.onabort=()=>i(r.error)})}catch{return}finally{e?.close()}}function Pt(s,t,e="none"){let o=_t(t),i=e,r=null,l=!1,n=!1,a=null,u=null,c=null,d=[];function g(){let y=x();for(let w of d)try{w(y)}catch{}}function x(){return{mode:i,isPersisting:r!=null&&l,lastSaved:a,lastLoaded:u,error:c,dbName:i==="indexeddb"?o:null}}async function R(){if(r)return r;try{let{createIndexedDbPersister:y}=await import("tinybase/persisters/persister-indexed-db");return r=y(s,o),c=null,r}catch(y){throw c=`IndexedDB unavailable: ${y.message}`,g(),y}}async function V(){if(i==="none")return;let y=await R();try{await y.load(),u=Date.now()}catch(w){c=`Load failed: ${w.message}`,g()}try{y.startAutoSave(),l=!0}catch(w){c=`Auto-save failed: ${w.message}`}try{y.startAutoLoad(1),n=!0}catch(w){c=`Auto-load failed: ${w.message}`}g()}async function $(){if(r){l&&(r.stopAutoSave(),l=!1),n&&(r.stopAutoLoad(),n=!1);try{await r.save(),a=Date.now()}catch(y){c=`Final save failed: ${y.message}`}g()}}async function j(){if(!(i==="none"||!r)){try{await r.save(),a=Date.now(),c=null}catch(y){c=`Save failed: ${y.message}`}g()}}async function C(){if(!(i==="none"||!r)){try{await r.load(),u=Date.now(),c=null}catch(y){c=`Load failed: ${y.message}`}g()}}async function P(){if(await $(),r){try{r.destroy()}catch{}r=null}d=[],g()}function E(y){if(y===i)return;let w=i;i=y,w==="indexeddb"&&y==="none"&&(r&&l&&(r.stopAutoSave(),l=!1),r&&n&&(r.stopAutoLoad(),n=!1)),y==="indexeddb"&&w==="none"&&V().catch(()=>{}),g()}function k(y){return d.push(y),()=>{d=d.filter(w=>w!==y)}}return{start:V,stop:$,save:j,load:C,setMode:E,getStatus:x,addListener:k,destroy:P}}var Y=class{constructor(t=50){this._stack=[];this._position=-1;this._listeners=[];this._maxDepth=t}push(t){if(this._position<this._stack.length-1&&(this._stack=this._stack.slice(0,this._position+1)),this._position>=0){let e=this._stack[this._position];if(JSON.stringify(e)===JSON.stringify(t))return}this._stack.push(structuredClone(t)),this._stack.length>this._maxDepth?this._stack.shift():this._position++,this._notifyListeners()}undo(){return this._position<=0?null:(this._position--,this._notifyListeners(),structuredClone(this._stack[this._position]))}redo(){return this._position>=this._stack.length-1?null:(this._position++,this._notifyListeners(),structuredClone(this._stack[this._position]))}current(){return this._position<0?null:structuredClone(this._stack[this._position])}jumpTo(t){return t<0||t>=this._stack.length?null:(this._position=t,this._notifyListeners(),structuredClone(this._stack[this._position]))}getState(){return{canUndo:this._position>0,canRedo:this._position<this._stack.length-1,position:this._position,total:this._stack.length}}getTimeline(){return this._stack.map((t,e)=>({position:e,id:t.id}))}clear(){this._stack=[],this._position=-1,this._notifyListeners()}addListener(t){return this._listeners.push(t),()=>{this._listeners=this._listeners.filter(e=>e!==t)}}_notifyListeners(){let t=this.getState();for(let e of this._listeners)try{e(t)}catch{}}};function Et(s){if(!F(s))return s;let t=typeof s.manifest=="string"?s.manifest:"";if(!(/^0\.0(?:\.|$)/.test(t)||!t&&("version"in s||"manifestVersion"in s||"components"in s||"rootElement"in s||mr(s.elements))))return s;let r={...s,manifest:"0.1.0"};if(delete r.version,delete r.manifestVersion,!r.elements&&F(r.components)&&(r.elements=r.components,delete r.components),!r.root&&typeof r.rootElement=="string"&&(r.root=r.rootElement,delete r.rootElement),F(r.elements)){let l={};for(let[n,a]of Object.entries(r.elements)){if(!F(a))continue;let u={...a};!u.type&&typeof u.component=="string"&&(u.type=u.component,delete u.component),l[n]=u}r.elements=l}return r}function mr(s){return F(s)?Object.values(s).some(t=>F(t)&&"component"in t):!1}function F(s){return s!==null&&typeof s=="object"&&!Array.isArray(s)}import{html as p,css as b,svg as _,nothing as h}from"lit";import{LitElement as hr}from"lit";var X=class X extends hr{constructor(){super(...arguments);this._instanceId=`forge-${++X._instanceCounter}`;this.props={};this.store=null;this.onAction=null;this.itemContext=null}static get properties(){return{props:{type:Object}}}connectedCallback(){super.connectedCallback()}resolve(e){if(!this.store)return e;this.itemContext&&U(this.itemContext);try{return S(this.store,e)}finally{U(null)}}getProp(e){let o=this.props?.[e];return typeof o=="string"&&(o.startsWith("$state:")||o.startsWith("$computed:")||o.startsWith("$item:")||o.startsWith("$expr:")||o.includes("{{")&&o.includes("}}"))?this.resolve(o):o}getArray(e){let o=this.getProp(e);return Array.isArray(o)?o:o&&typeof o=="object"?Object.values(o):[]}getString(e,o=""){let i=this.getProp(e);return typeof i=="string"?i:String(i??o)}getNumber(e,o=0){let i=this.getProp(e);return typeof i=="number"?i:Number(i)||o}getBool(e,o=!1){let i=this.getProp(e);return typeof i=="boolean"?i:o}getBoundProp(e,o){let i=typeof this.props?.bind=="string"?this.props.bind:"";if(i){let l=this.resolve(i);if(l!==void 0)return l}let r=this.getProp(e);return r===void 0?o:r}dispatchAction(e,o){let i=typeof this.props?.bind=="string"?this.props.bind:"",r=i?{...o||{},bind:i}:o;this.onAction&&this.onAction(e,r),this.dispatchEvent(new CustomEvent("forgeui-action",{detail:{action:e,payload:r},bubbles:!0,composed:!0}))}handleAction(e){let o=this.getString("action");o&&this.dispatchAction(o,this.props)}prop(e){return this.getProp(e)}static get sharedStyles(){return[ge]}gapValue(e){let o={none:"0",0:"0","3xs":"var(--forgeui-space-3xs)","2xs":"var(--forgeui-space-2xs)",xs:"var(--forgeui-space-xs)",sm:"var(--forgeui-space-sm)",md:"var(--forgeui-space-md)",lg:"var(--forgeui-space-lg)",xl:"var(--forgeui-space-xl)","2xl":"var(--forgeui-space-2xl)"};if(e==null||e==="")return"var(--forgeui-space-md)";let i=String(e);return i in o?o[i]:/^\d+(\.\d+)?$/.test(i)?`${i}px`:/^\d+(\.\d+)?(px|rem|em|%|vw|vh|ch)$/.test(i)?i:"var(--forgeui-space-md)"}static get styles(){return[ge]}};X._instanceCounter=0;var m=X;var ye=class extends m{static get properties(){return{props:{type:Object}}}static get styles(){return b`
  ...
  `}render(){let t=this.getString("text","")||this.getString("label",""),e=this.getString("variant","");return p`<span class="badge" variant="${e}">${t}<slot></slot></span>`}};customElements.define("forgeui-badge",Te);var Ie=class extends m{static get styles(){return b`
  ...
  `}render(){let t=this.getString("src",""),e=this.getString("name","?"),o=e.split(" ").map(i=>i[0]).join("").toUpperCase().slice(0,2);return p`<div class="avatar">${t?p`<img src="${t}" alt="${e}">`:o}<slot></slot></div>`}};customElements.define("forgeui-avatar",Ie);var Ce=class extends m{static get styles(){return b`
  ...
  `}render(){let t=this.getString("title","Nothing here"),e=this.getString("description","");return p`
      ...
      <slot></slot>
    `}};customElements.define("forgeui-empty-state",Ce);var je=class extends m{static get styles(){return b`
  ...
  `}_niceMax(e){if(e<=0)return 1;let o=Math.pow(10,Math.floor(Math.log10(e))),i=e/o;return(i<=1?1:i<=2?2:i<=5?5:10)*o}render(){let e=this.getString("chartType","bar"),o=this.getProp("data")||[],i=this.getString("title",""),r=this.getString("xKey","label")||this.getString("labelKey","label"),l=this.getString("yKey","value")||this.getString("valueKey","value"),n=this.getString("color","");if(!o||o.length===0)return p`
      ...
      `;let a=o.map($=>typeof $=="number"?{label:"",value:$}:$&&typeof $=="object"?{label:String($[r]??$.label??$.name??$.x??""),value:Number($[l]??$.value??$.y??0)||0,color:$.color}:{label:String($),value:0}),u=600,c=260,d={top:8,right:16,bottom:36,left:48},g=u-d.left-d.right,x=c-d.top-d.bottom,R,V=h;if(e==="pie"||e==="donut"){let $=a.reduce((M,A)=>M+Math.max(0,A.value),0)||1,j=u/2,C=c/2,P=Math.min(g,x)/2-8,E=e==="donut"?P*.55:0,k=-Math.PI/2,y=[],w=[];a.forEach((M,A)=>{let L=Math.max(0,M.value)/$,T=k,I=k+L*Math.PI*2;k=I;let B=I-T>Math.PI?1:0,Z=j+P*Math.cos(T),it=C+P*Math.sin(T),st=j+P*Math.cos(I),nt=C+P*Math.sin(I),Q=M.color||this._palette[A%this._palette.length];if(w.push(Q),E>0){let Mt=j+E*Math.cos(T),Tt=C+E*Math.sin(T),It=j+E*Math.cos(I),Ct=C+E*Math.sin(I);y.push(_`<path class="slice" fill="${Q}" d="M ${Z} ${it} A ${P} ${P} 0 ${B} 1 ${st} ${nt} L ${It} ${Ct} A ${E} ${E} 0 ${B} 0 ${Mt} ${Tt} Z"/>`)}else y.push(_`<path class="slice" fill="${Q}" d="M ${j} ${C} L ${Z} ${it} A ${P} ${P} 0 ${B} 1 ${st} ${nt} Z"/>`)}),R=_`<g>${y}</g>`,V=p`<div class="legend">${a.map((M,A)=>p`
        <span class="legend-item"><span class="swatch" style="background:${w[A]}"></span>${M.label} (${M.value})</span>
      `)}</div>`}else{let $=Math.max(...a.map(k=>k.value),0),j=this._niceMax($),C=k=>d.top+x-k/j*x,P=4,E=[];for(let k=0;k<=P;k++){let y=j*k/P,w=C(y);E.push(_`<line class="grid" x1="${d.left}" x2="${d.left+g}" y1="${w}" y2="${w}"/>`),E.push(_`<text class="tick-label" x="${d.left-6}" y="${w+3}" text-anchor="end">${y.toLocaleString()}</text>`)}if(e==="line"||e==="area"){let k=g/Math.max(1,a.length-1),y=a.map((A,L)=>{let T=d.left+L*k,I=C(A.value);return`${L===0?"M":"L"} ${T} ${I}`}).join(" "),w=e==="area"?y+` L ${d.left+g} ${d.top+x} L ${d.left} ${d.top+x} Z`:"",M=n||"var(--forgeui-color-primary)";R=p`
          <g>${E}</g>
        ...
        `}else{let k=a.length,y=g/k,w=Math.max(2,y*.7),M=y-w;R=p`
          <g>${E}</g>
          ${a.map((A,L)=>{let T=d.left+L*y+M/2,I=C(A.value),B=Math.max(0,d.top+x-I),Z=A.color||n||"var(--forgeui-color-primary)";return _`<rect class="bar" x="${T}" y="${I}" width="${w}" height="${B}" rx="2" style="fill:${Z}">
