...
`;var Ht=["mutateState","navigate","openDialog","closeDialog","callApi","toast","custom"],Jt=["set","append","update","delete","increment","decrement","toggle"],Yt=["GET","POST","PUT","PATCH","DELETE","get","post","put","patch","delete"];function Ee(s="default"){switch(s){case"minimal":return Zt();case"default":return Xt();case"full":return Ur()}}function Zt(){let t=Object.entries(Dt).map(([e,o])=>`  ${e}: ${o.join(", ")}`).join(`
...
`)}function Te(){return{type:"object",required:["manifest","id","elements"],properties:{manifest:{type:"string",const:"0.1.0"},id:{type:"string",pattern:"^[a-z0-9][a-z0-9-]*$"},root:{type:"string"},title:{type:"string"},schema:{type:"object",properties:{version:{type:"number"},tables:{type:"object",additionalProperties:{type:"object",properties:{columns:{type:"object",additionalProperties:{type:"object",properties:{type:{type:"string",enum:["string","number","boolean"]},default:{}},required:["type"]}}},required:["columns"]}}}},state:{type:"object",additionalProperties:{}},elements:{type:"object",additionalProperties:{type:"object",properties:{type:{type:"string",enum:de},props:{type:"object"},children:{type:"array",items:{type:"string"}},visible:{type:"object",properties:{$when:{type:"object",properties:{path:{type:"string"},eq:{},neq:{},gt:{type:"number"},lt:{type:"number"},gte:{type:"number"},lte:{type:"number"},in:{type:"array"},notIn:{type:"array"},exists:{type:"boolean"}},required:["path"]}}}},required:["type"]}},actions:{type:"object",additionalProperties:{type:"object",properties:{type:{type:"string",enum:[...Ht]},path:{type:"string"},value:{},operation:{type:"string",enum:[...Jt]},set:{type:"object"},data:{type:"object"},key:{type:"string"},formId:{type:"string"},action:{type:"string"},target:{type:"string"},url:{type:"string"},method:{type:"string",enum:[...Yt]},body:{type:"object"},message:{type:"string"},duration:{type:"number",minimum:0}},required:["type"]}},dataAccess:{type:"object",properties:{enabled:{type:"boolean",default:!1},readable:{type:"array",items:{type:"string"}},restricted:{type:"array",items:{type:"string"}},summaries:{type:"boolean",default:!1}}},persistState:{type:"boolean"},skipPersistState:{type:"boolean"}}}}var Fr={container:"Stack",row:"Stack",column:"Stack",text:"Text",heading:"Text",label:"Text",image:"Image",icon:"Icon",button:"Button",link:"Link",textInput:"TextInput",textarea:"Textarea",textArea:"Textarea",numberInput:"NumberInput",checkbox:"Checkbox",toggle:"Toggle",select:"Select",divider:"Divider",spacer:"Spacer",card:"Card",table:"Table",list:"List",alert:"Alert",progress:"Progress",badge:"Badge",avatar:"Avatar"};function Br(s){let t={},e=0;function o(n){let a=n.id||`a2ui-${e++}`,u=Fr[n.type];if(!u||!ie(u))return t[a]={type:"Text",props:{content:`[Unsupported A2UI type: ${n.type}]`,variant:"caption",colorScheme:"secondary"}},a;let l=Vr(n.type,n.props||{}),d=(n.children||[]).map(p=>o(p));return t[a]={type:u,props:l,children:d.length>0?d:void 0},a}let r=(s.components||s.content||[]).map(n=>o(n)),c=r.length===1?r[0]:"a2ui-root";return r.length>1&&(t[c]={type:"Stack",props:{gap:"md"},children:r}),{manifest:"0.1.0",id:`a2ui-${Date.now()}`,root:c,elements:t,actions:{}}}function Vr(s,t){let e={...t};switch(s){case"heading":e.variant="heading",e.content=t.text||t.content||"",delete e.text;break;case"text":case"label":e.content=t.text||t.content||"",delete e.text;break;case"row":e.direction="row",e.gap=t.gap||t.spacing||"md";break;case"column":e.direction="column",e.gap=t.gap||t.spacing||"md";break;case"container":e.gap=t.gap||t.spacing||"md";break;case"image":e.src=t.src||t.url||"",e.alt=t.alt||"";break;case"button":e.label=t.text||t.label||"",e.variant=t.variant||t.style||"default";break;case"textInput":case"textarea":case"textArea":e.placeholder=t.placeholder||"",e.value=t.value||"",e.label=t.label||"";break;case"numberInput":e.placeholder=t.placeholder||"",e.value=t.value??0,e.label=t.label||"";break;case"select":t.options&&Array.isArray(t.options)&&(e.options=t.options.map(o=>typeof o=="string"?{value:o,label:o}:o));break;case"alert":e.variant=t.type||t.severity||"info",e.content=t.message||t.text||t.content||"",delete e.message,delete e.text;break;case"progress":e.value=t.value??t.percent??0;break}return e}function Qt(s){if(!s||typeof s!="object")return!1;let t=s;return!!(Array.isArray(t.components)||Array.isArray(t.content)||typeof t.type=="string"&&(t.type==="adaptive-card"||t.type.startsWith("a2ui"))||typeof t.version=="string"&&t.version.startsWith("a2ui")||!t.elements&&!t.manifest&&Array.isArray(t.content))}function Ie(s){return Qt(s)?Br(s):s}function er(s){return`forgeui_${(s||"global").replace(/[^a-zA-Z0-9-]/g,"_")}`}var Ce="f";function qr(s){return new Promise((t,e)=>{let o=r=>e(r??new Error("IDB"));if(!globalThis.indexedDB)return o();let i=indexedDB.open(`${er(s)}_f`,1);i.onupgradeneeded=()=>{i.result.createObjectStore(Ce)},i.onsuccess=()=>t(i.result),i.onerror=i.onblocked=()=>o(i.error)})}async function tr(s,t){if(s.length===0)return;let e=null;try{e=await qr(t),await new Promise((o,i)=>{let r=e.transaction(Ce,"readwrite"),c=r.objectStore(Ce);for(let{file:n,id:a}of s)c.put(n,a);r.oncomplete=()=>o(),r.onerror=r.onabort=()=>i(r.error)})}catch{return}finally{e?.close()}}function rr(s,t,e="none"){let o=er(t),i=e,r=null,c=!1,n=!1,a=null,u=null,l=null,d=[];function p(){let h=v();for(let w of d)try{w(h)}catch{}}function v(){return{mode:i,isPersisting:r!=null&&c,lastSaved:a,lastLoaded:u,error:l,dbName:i==="indexeddb"?o:null}}async function N(){if(r)return r;try{let{createIndexedDbPersister:h}=await import("tinybase/persisters/persister-indexed-db");return r=h(s,o),l=null,r}catch(h){throw l=`IndexedDB unavailable: ${h.message}`,p(),h}}async function P(){if(i==="none")return;let h=await N();try{await h.load(),u=Date.now()}catch(w){l=`Load failed: ${w.message}`,p()}try{h.startAutoSave(),c=!0}catch(w){l=`Auto-save failed: ${w.message}`}try{h.startAutoLoad(1),n=!0}catch(w){l=`Auto-load failed: ${w.message}`}p()}async function x(){if(r){c&&(r.stopAutoSave(),c=!1),n&&(r.stopAutoLoad(),n=!1);try{await r.save(),a=Date.now()}catch(h){l=`Final save failed: ${h.message}`}p()}}async function I(){if(!(i==="none"||!r)){try{await r.save(),a=Date.now(),l=null}catch(h){l=`Save failed: ${h.message}`}p()}}async function S(){if(!(i==="none"||!r)){try{await r.load(),u=Date.now(),l=null}catch(h){l=`Load failed: ${h.message}`}p()}}async function E(){if(await x(),r){try{r.destroy()}catch{}r=null}d=[],p()}function $(h){if(h===i)return;let w=i;i=h,w==="indexeddb"&&h==="none"&&(r&&c&&(r.stopAutoSave(),c=!1),r&&n&&(r.stopAutoLoad(),n=!1)),h==="indexeddb"&&w==="none"&&P().catch(()=>{}),p()}function _(h){return d.push(h),()=>{d=d.filter(w=>w!==h)}}return{start:P,stop:x,save:I,load:S,setMode:$,getStatus:v,addListener:_,destroy:E}}var ge=class{constructor(t=50){this._stack=[];this._position=-1;this._listeners=[];this._maxDepth=t}push(t){if(this._position<this._stack.length-1&&(this._stack=this._stack.slice(0,this._position+1)),this._position>=0){let e=this._stack[this._position];if(JSON.stringify(e)===JSON.stringify(t))return}this._stack.push(structuredClone(t)),this._stack.length>this._maxDepth?this._stack.shift():this._position++,this._notifyListeners()}undo(){return this._position<=0?null:(this._position--,this._notifyListeners(),structuredClone(this._stack[this._position]))}redo(){return this._position>=this._stack.length-1?null:(this._position++,this._notifyListeners(),structuredClone(this._stack[this._position]))}current(){return this._position<0?null:structuredClone(this._stack[this._position])}jumpTo(t){return t<0||t>=this._stack.length?null:(this._position=t,this._notifyListeners(),structuredClone(this._stack[this._position]))}getState(){return{canUndo:this._position>0,canRedo:this._position<this._stack.length-1,position:this._position,total:this._stack.length}}getTimeline(){return this._stack.map((t,e)=>({position:e,id:t.id}))}clear(){this._stack=[],this._position=-1,this._notifyListeners()}addListener(t){return this._listeners.push(t),()=>{this._listeners=this._listeners.filter(e=>e!==t)}}_notifyListeners(){let t=this.getState();for(let e of this._listeners)try{e(t)}catch{}}};function or(s){if(!Z(s))return s;let t=typeof s.manifest=="string"?s.manifest:"";if(!(/^0\.0(?:\.|$)/.test(t)||!t&&("version"in s||"manifestVersion"in s||"components"in s||"rootElement"in s||Kr(s.elements))))return s;let r={...s,manifest:"0.1.0"};if(delete r.version,delete r.manifestVersion,!r.elements&&Z(r.components)&&(r.elements=r.components,delete r.components),!r.root&&typeof r.rootElement=="string"&&(r.root=r.rootElement,delete r.rootElement),Z(r.elements)){let c={};for(let[n,a]of Object.entries(r.elements)){if(!Z(a))continue;let u={...a};!u.type&&typeof u.component=="string"&&(u.type=u.component,delete u.component),c[n]=u}r.elements=c}return r}function Kr(s){return Z(s)?Object.values(s).some(t=>Z(t)&&"component"in t):!1}function Z(s){return s!==null&&typeof s=="object"&&!Array.isArray(s)}import{html as Le,css as ze,nothing as Gr}from"lit";import{LitElement as Wr}from"lit";var fe=class fe extends Wr{constructor(){super(...arguments);this._instanceId=`forge-${++fe._instanceCounter}`;this.props={};this.store=null;this.onAction=null;this.itemContext=null}static get properties(){return{props:{type:Object}}}connectedCallback(){super.connectedCallback()}resolve(e){if(!this.store)return e;this.itemContext&&J(this.itemContext);try{return T(this.store,e)}finally{J(null)}}getProp(e){let o=this.props?.[e];return typeof o=="string"&&(o.startsWith("$state:")||o.startsWith("$computed:")||o.startsWith("$item:")||o.startsWith("$expr:")||o.includes("{{")&&o.includes("}}"))?this.resolve(o):o}getArray(e){let o=this.getProp(e);return Array.isArray(o)?o:o&&typeof o=="object"?Object.values(o):[]}getString(e,o=""){let i=this.getProp(e);return typeof i=="string"?i:String(i??o)}getNumber(e,o=0){let i=this.getProp(e);return typeof i=="number"?i:Number(i)||o}getBool(e,o=!1){let i=this.getProp(e);return typeof i=="boolean"?i:o}getBoundProp(e,o){let i=typeof this.props?.bind=="string"?this.props.bind:"";if(i){let c=this.resolve(i);if(c!==void 0)return c}let r=this.getProp(e);return r===void 0?o:r}dispatchAction(e,o){let i=typeof this.props?.bind=="string"?this.props.bind:"",r=i?{...o||{},bind:i}:o;this.onAction&&this.onAction(e,r),this.dispatchEvent(new CustomEvent("forgeui-action",{detail:{action:e,payload:r},bubbles:!0,composed:!0}))}handleAction(e){let o=this.getString("action");o&&this.dispatchAction(o,this.props)}prop(e){return this.getProp(e)}static get sharedStyles(){return[Pe]}gapValue(e){let o={none:"0",0:"0","3xs":"var(--forgeui-space-3xs)","2xs":"var(--forgeui-space-2xs)",xs:"var(--forgeui-space-xs)",sm:"var(--forgeui-space-sm)",md:"var(--forgeui-space-md)",lg:"var(--forgeui-space-lg)",xl:"var(--forgeui-space-xl)","2xl":"var(--forgeui-space-2xl)"};if(e==null||e==="")return"var(--forgeui-space-md)";let i=String(e);return i in o?o[i]:/^\d+(\.\d+)?$/.test(i)?`${i}px`:/^\d+(\.\d+)?(px|rem|em|%|vw|vh|ch)$/.test(i)?i:"var(--forgeui-space-md)"}static get styles(){return[Pe]}};fe._instanceCounter=0;var g=fe;var Me=class extends g{static get styles(){return ze`
  ...
  `}render(){let t=this.getString("label","Button"),e=this.getString("variant","primary"),o=this.getString("size",""),i=this.getBool("disabled"),r=this.getProp("pressed");return Le`<button class="${e} ${o}" ?disabled=${i}
      ...
      @click=${c=>this.handleAction(c)}>${t}<slot></slot></button>`}};customElements.define("forgeui-button",Me);var je=class extends g{static get styles(){return ze`
  ...
  `}render(){let t=this.getString("label",""),e=this.getString("href","#");return Le`<a href="${e}">${t}<slot></slot></a>`}};customElements.define("forgeui-link",Re);import{html as O,css as X,nothing as ir}from"lit";var De=class extends g{static get properties(){return{props:{type:Object}}}static get styles(){return X`
  ...
  `}render(){let t=this.getString("src",""),e=this.getString("alt",""),o=this.getString("fit","contain");return t?O`<img src="${t}" alt="${e}" style="object-fit:${o}" loading="lazy">`:O`${ir}`}};customElements.define("forgeui-image",Oe);var Ne=class extends g{static get styles(){return X`
  ...
  `}render(){let t=this.getString("title","Nothing here"),e=this.getString("description","");return O`
      ...
      ${e?O`<div class="desc">${e}</div>`:ir}
      <slot></slot>
    `}};customElements.define("forgeui-empty-state",Be);import{html as y,css as Q,svg as B,nothing as k}from"lit";var Ve=class extends g{constructor(){super(...arguments);this._query="";this._sortKey="";this._sortDir="asc";this._page=0}static get styles(){return Q`
  ...
  `}_niceMax(e){if(e<=0)return 1;let o=Math.pow(10,Math.floor(Math.log10(e))),i=e/o;return(i<=1?1:i<=2?2:i<=5?5:10)*o}render(){let e=this.getString("chartType","bar"),o=this.getProp("data")||[],i=this.getString("title",""),r=this.getString("xKey","label")||this.getString("labelKey","label"),c=this.getString("yKey","value")||this.getString("valueKey","value"),n=this.getString("color","");if(!o||o.length===0)return y`
      ...
      `;let a=o.map(x=>typeof x=="number"?{label:"",value:x}:x&&typeof x=="object"?{label:String(x[r]??x.label??x.name??x.x??""),value:Number(x[c]??x.value??x.y??0)||0,color:x.color}:{label:String(x),value:0}),u=600,l=260,d={top:8,right:16,bottom:36,left:48},p=u-d.left-d.right,v=l-d.top-d.bottom,N,P=k;if(e==="pie"||e==="donut"){let x=a.reduce((L,C)=>L+Math.max(0,C.value),0)||1,I=u/2,S=l/2,E=Math.min(p,v)/2-8,$=e==="donut"?E*.55:0,_=-Math.PI/2,h=[],w=[];a.forEach((L,C)=>{let q=Math.max(0,L.value)/x,z=_,D=_+q*Math.PI*2;_=D;let ee=D-z>Math.PI?1:0,ue=I+E*Math.cos(z),Ct=S+E*Math.sin(z),Mt=I+E*Math.cos(D),jt=S+E*Math.sin(D),me=L.color||this._palette[C%this._palette.length];if(w.push(me),$>0){let sr=I+$*Math.cos(z),ar=S+$*Math.sin(z),nr=I+$*Math.cos(D),lr=S+$*Math.sin(D);h.push(B`<path class="slice" fill="${me}" d="M ${ue} ${Ct} A ${E} ${E} 0 ${ee} 1 ${Mt} ${jt} L ${nr} ${lr} A ${$} ${$} 0 ${ee} 0 ${sr} ${ar} Z"/>`)}else h.push(B`<path class="slice" fill="${me}" d="M ${I} ${S} L ${ue} ${Ct} A ${E} ${E} 0 ${ee} 1 ${Mt} ${jt} Z"/>`)}),N=B`<g>${h}</g>`,P=y`<div class="legend">${a.map((L,C)=>y`
        <span class="legend-item"><span class="swatch" style="background:${w[C]}"></span>${L.label} (${L.value})</span>
      `)}</div>`}else{let x=Math.max(...a.map(_=>_.value),0),I=this._niceMax(x),S=_=>d.top+v-_/I*v,E=4,$=[];for(let _=0;_<=E;_++){let h=I*_/E,w=S(h);$.push(B`<line class="grid" x1="${d.left}" x2="${d.left+p}" y1="${w}" y2="${w}"/>`),$.push(B`<text class="tick-label" x="${d.left-6}" y="${w+3}" text-anchor="end">${h.toLocaleString()}</text>`)}if(e==="line"||e==="area"){let _=p/Math.max(1,a.length-1),h=a.map((C,q)=>{let z=d.left+q*_,D=S(C.value);return`${q===0?"M":"L"} ${z} ${D}`}).join(" "),w=e==="area"?h+` L ${d.left+p} ${d.top+v} L ${d.left} ${d.top+v} Z`:"",L=n||"var(--forgeui-color-primary)";N=y`
          <g>${$}</g>
          ${e==="area"?B`<path class="area" d="${w}" style="fill:${L};opacity:0.15"/>`:k}
          ${B`<path class="line" d="${h}" style="stroke:${L}"/>`}
          ${a.map((C,q)=>{let z=d.left+q*_,D=S(C.value);return B`<circle class="point" cx="${z}" cy="${D}" r="3" style="fill:${L}"/>
              <text class="tick-label" x="${z}" y="${d.top+v+14}" text-anchor="middle">${C.label}</text>`})}
        `}else{let _=a.length,h=p/_,w=Math.max(2,h*.7),L=h-w;N=y`
          <g>${$}</g>
          ${a.map((C,q)=>{let z=d.left+q*h+L/2,D=S(C.value),ee=Math.max(0,d.top+v-D),ue=C.color||n||"var(--forgeui-color-primary)";return B`<rect class="bar" x="${z}" y="${D}" width="${w}" height="${ee}" rx="2" style="fill:${ue}">
  ...
  `}_trendMeta(t){if(t==null||t==="")return null;if(typeof t=="number")return t>0?{dir:"up",arrow:"\u2191",display:`${Math.abs(t)}%`}:t<0?{dir:"down",arrow:"\u2193",display:`${Math.abs(t)}%`}:{dir:"neutral",arrow:"\u2192",display:"0%"};if(typeof t=="string"){let e=t.toLowerCase(),o=t.match(/^\s*([+-]?\d+(?:\.\d+)?)\s*(%?)\s*$/);if(o){let i=parseFloat(o[1]),r=o[2];return i>0?{dir:"up",arrow:"\u2191",display:`${Math.abs(i)}${r}`}:i<0?{dir:"down",arrow:"\u2193",display:`${Math.abs(i)}${r}`}:{dir:"neutral",arrow:"\u2192",display:`0${r}`}}return e==="up"||e==="positive"||e==="increase"?{dir:"up",arrow:"\u2191",display:""}:e==="down"||e==="negative"||e==="decrease"?{dir:"down",arrow:"\u2193",display:""}:e==="flat"||e==="neutral"||e==="same"?{dir:"neutral",arrow:"\u2192",display:""}:{dir:"neutral",arrow:"",display:t}}return null}render(){let t=this.getString("label",""),e=this.getProp("value"),o=this.getProp("trend"),i=this.getString("trendLabel",""),r=this.getProp("goal"),c=this.getString("unit",""),n=this.getString("suffix",""),a=this.getString("subtitle",""),u=this.getString("variant","");u&&this.setAttribute("variant",u);let l=typeof e=="number"?e.toLocaleString():e==null||e===""?"\u2014":String(e),d=this._trendMeta(o);return y`
    ...
    `}};customElements.define("forgeui-metric",He);import{css as Hr,svg as K}from"lit";var Je=class extends g{static get properties(){return{props:{type:Object}}}static get styles(){return Hr`
    :host { display:block; }
    svg { display:block; }
  ...
  `}render(){let t=this.getString("msg","Unknown error");return U`<div class="error" role="alert">⚠ ${t}</div>`}};customElements.define("forgeui-error",et);import{html as b,css as j,nothing as A}from"lit";var tt=class extends g{static get styles(){return j`
  ...
  `}render(){let t=this.getString("label",""),e=this.getString("placeholder",""),o=this.getString("hint",""),i=this.getString("error",""),r=this.getString("inputType","")||this.getString("type","text"),c=this.getBool("multiline"),n=String(this.getBoundProp("value","")??""),a=this._instanceId;return b`
    ...
    `}};customElements.define("forgeui-text-input",tt);var rt=class extends g{static get styles(){return j`
    :host { display:block; flex:1 1 auto; min-width:0; max-width:100%; margin-bottom:var(--forgeui-space-sm); }
    label { display:block; font-size:var(--forgeui-text-sm); font-weight:var(--forgeui-weight-medium); margin-bottom:var(--forgeui-space-2xs); color:var(--forgeui-color-text); overflow-wrap:break-word; }
  ...
  `}render(){let t=this.getString("label",""),e=this.getString("placeholder",""),o=this.getString("hint",""),i=this.getString("error",""),r=Math.max(1,Math.floor(this.getNumber("rows",4))),c=this.getProp("maxLength"),n=this.getBool("required"),a=this.getBool("disabled"),u=String(this.getBoundProp("value","")??""),l=this._instanceId;return b`
      ...
      ${o&&!i?b`<div class="hint">${o}</div>`:A}
      ${i?b`<div class="error">${i}</div>`:A}
    `}};customElements.define("forgeui-textarea",rt);var ot=class extends g{static get styles(){return j`
    :host { display:block; min-width:0; }
    form { display:flex; flex-direction:column; gap:var(--forgeui-space-md); min-width:0; }
  `}render(){let t=this.getString("action","");return b`<form @submit=${e=>{e.preventDefault();let o={submitted:!0};t&&this.dispatchAction(t,o),this.dispatchEvent(new CustomEvent("forgeui-submit",{detail:o,bubbles:!0,composed:!0}))}}><slot></slot></form>`}};customElements.define("forgeui-form",ot);var it=class extends g{static get styles(){return j`
    :host { display:block; min-width:0; }
  ...
  `}render(){let t=this.getString("label",""),e=this.getString("description",""),o=this.getString("error","");return b`<fieldset>
    ...
    </fieldset>`}};customElements.define("forgeui-field-group",it);var st=class extends g{static get styles(){return j`
    :host { display:block; flex:1 1 auto; min-width:0; max-width:100%; margin-bottom:var(--forgeui-space-sm); }
  ...
  `}render(){let t=this.getString("label",""),e=this.getProp("min"),o=this.getProp("max"),i=this.getProp("step"),r=this.getBoundProp("value"),c=this._instanceId;return b`
    ...
    `}};customElements.define("forgeui-number-input",st);var at=class extends g{static get styles(){return j`
    :host { display:block; flex:1 1 auto; min-width:0; max-width:100%; margin-bottom:var(--forgeui-space-sm); }
    label { display:block; font-size:var(--forgeui-text-sm); font-weight:var(--forgeui-weight-medium); margin-bottom:var(--forgeui-space-2xs); overflow-wrap:break-word; }
  ...
  `}render(){let t=this.getString("label",""),e=this.getProp("options")||[],o=String(this.getBoundProp("value","")??""),i=this._instanceId;return b`
    ...
    `}};customElements.define("forgeui-select",at);var nt=class extends g{static get styles(){return j`
    :host { display:block; flex:1 1 auto; min-width:0; max-width:100%; margin-bottom:var(--forgeui-space-sm); }
    label { display:block; font-size:var(--forgeui-text-sm); font-weight:var(--forgeui-weight-medium); margin-bottom:var(--forgeui-space-2xs); overflow-wrap:break-word; }
    input { width:100%; padding:var(--forgeui-space-xs) var(--forgeui-space-sm); border:1px solid var(--forgeui-color-border);
      border-radius:var(--forgeui-radius-md); font:inherit; height:var(--forgeui-input-height);
  ...
  `}render(){let t=this.getString("label",""),e=this.getString("placeholder",""),o=this.getString("hint",""),i=this.getProp("options")||[],r=String(this.getBoundProp("value","")??""),c=this.getBool("disabled"),n=this.getBool("required"),a=this._instanceId,u=`${a}-list`;return b`
    ...
    `}};customElements.define("forgeui-combobox",nt);var lt=class extends g{static get styles(){return j`
  ...
  `}render(){let t=this.getString("label",""),e=this.getProp("options")||[],o=this.getBoundProp("value",this.getProp("selected")??[]),i=Number(this.getProp("maxSelections")),r=Number.isFinite(i)&&i>=0?i:1/0,c=(Array.isArray(o)?o.map(l=>String(l)):[]).slice(0,r),n=this.getBool("disabled"),a=this._instanceId,u=l=>{let d=c.filter(p=>p!==l);this.dispatchAction("remove",{value:l}),this.dispatchAction("change",{value:d,selected:d})};return b`
    ...
    `}};customElements.define("forgeui-multi-select",lt);var ct=class extends g{static get styles(){return j`
    :host { display:block; margin-bottom:var(--forgeui-space-sm); }
  ...
  `}render(){let t=this.getString("label",""),e=this.getString("hint",""),o=this.getProp("options")||[],i=String(this.getBoundProp("value","")??""),r=this.getBool("disabled"),c=this._instanceId;return b`
    ...
    `}};customElements.define("forgeui-radio-group",ct);var ut=class extends g{static get styles(){return j`
  ...
  `}render(){let e=!!this.getBoundProp("on",this.getProp("value")??!1),o=this.getString("label",""),i=this.getBool("disabled"),r=this._instanceId;return b`
    ...
    `}};customElements.define("forgeui-toggle",dt);var pt=class extends g{static get styles(){return j`
    :host { display:block; flex:1 1 auto; min-width:0; max-width:100%; margin-bottom:var(--forgeui-space-sm); }
    label { display:block; font-size:var(--forgeui-text-sm); font-weight:var(--forgeui-weight-medium); margin-bottom:var(--forgeui-space-2xs); overflow-wrap:break-word; }
    input { width:100%; padding:var(--forgeui-space-xs) var(--forgeui-space-sm); border:1px solid var(--forgeui-color-border);
      border-radius:var(--forgeui-radius-md); font:inherit; height:var(--forgeui-input-height);
  ...
  `}render(){let t=this.getString("label",""),e=this.getString("value",""),o=this._instanceId;return b`
    ...
    `}};customElements.define("forgeui-date-picker",pt);var gt=class extends g{static get styles(){return j`
    :host { display:block; flex:1 1 auto; min-width:0; max-width:100%; margin-bottom:var(--forgeui-space-sm); }
    label { display:block; font-size:var(--forgeui-text-sm); font-weight:var(--forgeui-weight-medium); margin-bottom:var(--forgeui-space-2xs); overflow-wrap:break-word; }
  ...
  `}_maxSizeBytes(){let e=this.getProp("maxSize");if(typeof e=="number"&&Number.isFinite(e)&&e>=0)return Math.floor(e);if(typeof e!="string")return null;let o=e.trim().match(/^(\d+(?:\.\d+)?)\s*(b|kb|mb|gb)?$/i);if(!o)return null;let i=Number(o[1]),r=(o[2]||"b").toLowerCase(),c=r==="gb"?1<<30:r==="mb"?1<<20:r==="kb"?1024:1,n=i*c;return Number.isFinite(n)?Math.floor(n):null}_newFileId(){return globalThis.crypto?.randomUUID?.()??`${Date.now()}_${Math.random().toString(36).slice(2)}`}_processFiles(e){let o=this.getBool("multiple"),i=this._maxSizeBytes(),r=(o?e:e.slice(0,1)).map(d=>{let p=this._newFileId(),v=i==null||d.size<=i,N={id:p,name:d.name,size:d.size,type:d.type,lastModified:d.lastModified,accepted:v,storageKey:v?p:null};return v||(N.error="maxSize"),[d,N]}),c=r.filter(([,d])=>d.accepted),n=r.map(([,d])=>d),a=c.map(([,d])=>d),u=o?a:a[0]??null,l=a[0]??null;this.dispatchAction("change",{id:l?.id??null,uuid:l?.id??null,name:l?.name??null,size:l?.size??null,type:l?.type??null,lastModified:l?.lastModified??null,storageKey:l?.storageKey??null,value:u,files:n,rejected:n.filter(d=>!d.accepted),multiple:o,maxSize:i}),tr(c.map(([d,p])=>({file:d,id:p.id})))}render(){let e=this.getString("label","Upload file"),o=this.getString("accept","*"),i=this.getBool("multiple");return b`
    ...
    `}};customElements.define("forgeui-file-upload",ft);import{html as R,css as V,nothing as mt}from"lit";var ht=class extends g{static get properties(){return{props:{type:Object}}}static get styles(){return V`
  ...
  `}render(){let t=this.getProp("columns"),e;typeof t=="number"?e=String(t):typeof t=="string"&&t?e=t:e="1";let o=/^\d+$/.test(e)?`repeat(${e}, minmax(0, 1fr))`:e,i=this.getString("gap","md"),r=this.gapValue(i),c=this.getString("padding",""),n=c?this.gapValue(c):"0";return this.style.gridTemplateColumns=o,this.style.gap=r,this.style.padding=n,/^\d+$/.test(e)&&Number(e)>=2&&this.setAttribute("responsive",""),R`<slot></slot>`}};customElements.define("forgeui-grid",bt);var yt=class extends g{static get properties(){return{props:{type:Object}}}static get styles(){return V`
  ...
  `}render(){let t=this.getString("variant",""),e=this.getString("title",""),o=this.getString("subtitle","");return t&&this.setAttribute("variant",t),R`
      ${e||o?R`
        <div class="header">
          ${e?R`<div class="title">${e}</div>`:mt}
          ${o?R`<div class="subtitle">${o}</div>`:mt}
        </div>
      `:mt}
      <div class="body"><slot></slot></div>
    `}};customElements.define("forgeui-card",yt);var vt=class extends g{static get properties(){return{props:{type:Object}}}static get styles(){return V`:host { display:block; margin-inline:auto; width:100%; box-sizing:border-box; }`}render(){let t=this.getString("maxWidth",""),e={sm:"640px",md:"768px",lg:"1024px",xl:"1280px","2xl":"1536px",full:"100%",none:"none","":""},o=t in e?e[t]:t,i=this.getString("padding","");return o&&o!=="none"?this.style.maxWidth=o:this.style.maxWidth="",this.style.padding=i?this.gapValue(i):"",R`<slot></slot>`}};customElements.define("forgeui-container",vt);var xt=class extends g{static get properties(){return{props:{type:Object}}}constructor(){super(),this._active=""}static get styles(){return V`
    :host { display:block; }
  ...
  `}_itemKey(t){return typeof t=="string"?t:String(t&&typeof t=="object"?t.id??t.key??t.value??t.label??"":t??"")}_itemLabel(t){return typeof t=="string"?t:String(t&&typeof t=="object"?t.label??t.title??t.value??"":t??"")}updated(){Array.from(this.children).filter(e=>!(e instanceof HTMLScriptElement)).forEach((e,o)=>{let i=(e.props||{}).slot??e.getAttribute("slot");String(o)===this._active||i===this._active?e.setAttribute("data-active",""):e.removeAttribute("data-active")})}_moveTo(t,e){let o=this._itemKey(e[t])||String(t);this._active=o,this.requestUpdate(),this.dispatchAction("tab-change",{active:o,value:o}),this.updateComplete.then(()=>{this.shadowRoot?.querySelector(`#${this._instanceId}-tab-${t}`)?.focus()})}render(){let t=this.getProp("items")||this.getProp("tabs")||[],e=Array.isArray(t)?t:[],o=this.getBoundProp("activeTab",this.getProp("value"));o!==void 0&&String(o)!==this._active&&(this._active=String(o)),!this._active&&e.length>0&&(this._active=this._itemKey(e[0])||"0");let i=e.findIndex((c,n)=>(this._itemKey(c)||String(n))===this._active),r=(c,n)=>{let a=-1;c.key==="ArrowRight"?a=(n+1)%e.length:c.key==="ArrowLeft"?a=(n-1+e.length)%e.length:c.key==="Home"?a=0:c.key==="End"&&(a=e.length-1),a!==-1&&(c.preventDefault(),this._moveTo(a,e))};return R`
    ...
    `}};customElements.define("forgeui-tabs",xt);var wt=class extends g{static get properties(){return{props:{type:Object}}}static get styles(){return V`
    :host { display:block; }
  ...
  `}render(){let t=this.getString("title","Section");return R`<details><summary>${t}</summary><div class="content"><slot></slot></div></details>`}};customElements.define("forgeui-accordion",wt);var $t=class extends g{static get styles(){return V`
    :host { display:block; }
    hr { border:none; border-top:1px solid var(--forgeui-color-border); margin:var(--forgeui-space-sm) 0; }
  `}render(){return R`<hr>`}};customElements.define("forgeui-divider",$t);var kt=class extends g{static get styles(){return V`:host { display:block; }`}render(){let t=this.getString("size","md"),e=this.getString("height",""),o=this.getString("width",""),i=e?this.gapValue(e):this.gapValue(t),r=o?/^\d+(\.\d+)?%$/.test(o)?o:this.gapValue(o):"";return R`<div style="height:${i};${r?`width:${r}`:""}"></div>`}};customElements.define("forgeui-spacer",kt);var St=class extends g{static get properties(){return{props:{type:Object}}}static get styles(){return V`
    :host { display:flex; flex-direction:column; gap:var(--forgeui-space-md); min-width:0; }
    :host([direction="row"]) { flex-direction:row; flex-wrap:wrap; }
    .empty { padding:var(--forgeui-space-lg); text-align:center; color:var(--forgeui-color-text-tertiary); font-size:var(--forgeui-text-sm); }
  `}render(){let t=this.getArray("data"),e=this.getString("emptyMessage",""),o=this.getString("direction","column");(o==="row"||o==="horizontal")&&this.setAttribute("direction","row");let i=this.getString("gap","md");return this.style.gap=this.gapValue(i),t.length===0&&e?R`<div class="empty">${e}</div>`:R`<slot></slot>`}};customElements.define("forgeui-repeater",St);import{html as F,css as ne,nothing as Jr}from"lit";var _t=class extends g{static get styles(){return ne`
  ...
  `}render(){let t=this.getProp("items")||[];return F`${t.map((e,o)=>{let i=o===t.length-1,r=typeof e=="string"?e:e.label,c=typeof e=="string"?"#":e.href;return F`
        ${o>0?F`<span class="sep">/</span>`:Jr}
        ${i?F`<span class="current">${r}</span>`:F`<a href="${c}">${r}</a>`}
      `})}`}};customElements.define("forgeui-breadcrumb",_t);var At=class extends g{static get styles(){return ne`
  ...
  `}render(){let t=this.getProp("steps")||[],e=this.getBoundProp("active",this.getProp("activeStep")??0),o=Number(e)||0;return F`${t.map((i,r)=>{let c=typeof i=="string"?i:i.label||i.title||`Step ${r+1}`,n=r===o,a=r<o;return F`<div class="step" ?active=${n} ?completed=${a}>
      ...
      </div>`})}`}};customElements.define("forgeui-stepper",At);var Pt=class extends g{static get styles(){return ne`
    :host { display:block; min-width:0; }
  ...
  `}render(){let t=this.getString("label","Search"),e=this.getString("placeholder","Search"),o=String(this.getBoundProp("value","")??""),i=this.getBool("disabled"),r=this.getString("action","change"),c=this._instanceId;return F`<div class="field">
    ...
    </div>`}};customElements.define("forgeui-search-box",Pt);var Et=class extends g{static get styles(){return ne`
  ...
  `}render(){let t=this.getArray("options"),e=String(this.getBoundProp("value",this.getProp("value")??this._optionValue(t[0]))??""),o=this.getBool("disabled"),i=this.getString("action","change");return F`
    ...
    `}_optionValue(t){if(t&&typeof t=="object"){let e=t;return String(e.value??e.label??"")}return String(t??"")}_optionLabel(t,e){if(t&&typeof t=="object"){let o=t;return String(o.label??o.value??e)}return e}};customElements.define("forgeui-segmented-control",Et);var Tt=class extends g{static get styles(){return ne`
