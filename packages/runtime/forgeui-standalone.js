...
`)}function Pe(){return{type:"object",required:["manifest","id","elements"],properties:{manifest:{type:"string",const:"0.1.0"},id:{type:"string",pattern:"^[a-z0-9][a-z0-9-]*$"},root:{type:"string"},title:{type:"string"},schema:{type:"object",properties:{version:{type:"number"},tables:{type:"object",additionalProperties:{type:"object",properties:{columns:{type:"object",additionalProperties:{type:"object",properties:{type:{type:"string",enum:["string","number","boolean"]},default:{}},required:["type"]}}},required:["columns"]}}}},state:{type:"object",additionalProperties:{}},elements:{type:"object",additionalProperties:{type:"object",properties:{type:{type:"string",enum:ye},props:{type:"object"},children:{type:"array",items:{type:"string"}},visible:{type:"object",properties:{$when:{type:"object",properties:{path:{type:"string"},eq:{},neq:{},gt:{type:"number"},lt:{type:"number"},gte:{type:"number"},lte:{type:"number"},in:{type:"array"},notIn:{type:"array"},exists:{type:"boolean"}},required:["path"]}}}},required:["type"]}},actions:{type:"object",additionalProperties:{type:"object",properties:{type:{type:"string",enum:["mutateState","navigate","openDialog","closeDialog","callApi","toast","custom"]},path:{type:"string"},value:{},operation:{type:"string",enum:["set","append","update","delete","increment","decrement","toggle"]},set:{type:"object"},data:{type:"object"},key:{type:"string"},formId:{type:"string"},action:{type:"string"},target:{type:"string"},url:{type:"string"},method:{type:"string"},body:{type:"object"}},required:["type"]}},dataAccess:{type:"object",properties:{enabled:{type:"boolean",default:!1},readable:{type:"array",items:{type:"string"}},restricted:{type:"array",items:{type:"string"}},summaries:{type:"boolean",default:!1}}},persistState:{type:"boolean"},skipPersistState:{type:"boolean"}}}}var zr={container:"Stack",row:"Stack",column:"Stack",text:"Text",heading:"Text",label:"Text",image:"Image",icon:"Icon",button:"Button",link:"Link",textInput:"TextInput",textarea:"Textarea",textArea:"Textarea",numberInput:"NumberInput",checkbox:"Checkbox",toggle:"Toggle",select:"Select",divider:"Divider",spacer:"Spacer",card:"Card",table:"Table",list:"List",alert:"Alert",progress:"Progress",badge:"Badge",avatar:"Avatar"};function Lr(s){let t={},e=0;function o(n){let a=n.id||`a2ui-${e++}`,u=zr[n.type];if(!u||!ie(u))return t[a]={type:"Text",props:{content:`[Unsupported A2UI type: ${n.type}]`,variant:"caption",colorScheme:"secondary"}},a;let c=Dr(n.type,n.props||{}),d=(n.children||[]).map(p=>o(p));return t[a]={type:u,props:c,children:d.length>0?d:void 0},a}let r=(s.components||s.content||[]).map(n=>o(n)),l=r.length===1?r[0]:"a2ui-root";return r.length>1&&(t[l]={type:"Stack",props:{gap:"md"},children:r}),{manifest:"0.1.0",id:`a2ui-${Date.now()}`,root:l,elements:t,actions:{}}}function Dr(s,t){let e={...t};switch(s){case"heading":e.variant="heading",e.content=t.text||t.content||"",delete e.text;break;case"text":case"label":e.content=t.text||t.content||"",delete e.text;break;case"row":e.direction="row",e.gap=t.gap||t.spacing||"md";break;case"column":e.direction="column",e.gap=t.gap||t.spacing||"md";break;case"container":e.gap=t.gap||t.spacing||"md";break;case"image":e.src=t.src||t.url||"",e.alt=t.alt||"";break;case"button":e.label=t.text||t.label||"",e.variant=t.variant||t.style||"default";break;case"textInput":case"textarea":case"textArea":e.placeholder=t.placeholder||"",e.value=t.value||"",e.label=t.label||"";break;case"numberInput":e.placeholder=t.placeholder||"",e.value=t.value??0,e.label=t.label||"";break;case"select":t.options&&Array.isArray(t.options)&&(e.options=t.options.map(o=>typeof o=="string"?{value:o,label:o}:o));break;case"alert":e.variant=t.type||t.severity||"info",e.content=t.message||t.text||t.content||"",delete e.message,delete e.text;break;case"progress":e.value=t.value??t.percent??0;break}return e}function Wt(s){if(!s||typeof s!="object")return!1;let t=s;return!!(Array.isArray(t.components)||Array.isArray(t.content)||typeof t.type=="string"&&(t.type==="adaptive-card"||t.type.startsWith("a2ui"))||typeof t.version=="string"&&t.version.startsWith("a2ui")||!t.elements&&!t.manifest&&Array.isArray(t.content))}function Ee(s){return Wt(s)?Lr(s):s}function Gt(s){return`forgeui_${(s||"global").replace(/[^a-zA-Z0-9-]/g,"_")}`}var Ie="f";function Or(s){return new Promise((t,e)=>{let o=r=>e(r??new Error("IDB"));if(!globalThis.indexedDB)return o();let i=indexedDB.open(`${Gt(s)}_f`,1);i.onupgradeneeded=()=>{i.result.createObjectStore(Ie)},i.onsuccess=()=>t(i.result),i.onerror=i.onblocked=()=>o(i.error)})}async function Ht(s,t){if(s.length===0)return;let e=null;try{e=await Or(t),await new Promise((o,i)=>{let r=e.transaction(Ie,"readwrite"),l=r.objectStore(Ie);for(let{file:n,id:a}of s)l.put(n,a);r.oncomplete=()=>o(),r.onerror=r.onabort=()=>i(r.error)})}catch{return}finally{e?.close()}}function Jt(s,t,e="none"){let o=Gt(t),i=e,r=null,l=!1,n=!1,a=null,u=null,c=null,d=[];function p(){let h=v();for(let w of d)try{w(h)}catch{}}function v(){return{mode:i,isPersisting:r!=null&&l,lastSaved:a,lastLoaded:u,error:c,dbName:i==="indexeddb"?o:null}}async function O(){if(r)return r;try{let{createIndexedDbPersister:h}=await import("tinybase/persisters/persister-indexed-db");return r=h(s,o),c=null,r}catch(h){throw c=`IndexedDB unavailable: ${h.message}`,p(),h}}async function P(){if(i==="none")return;let h=await O();try{await h.load(),u=Date.now()}catch(w){c=`Load failed: ${w.message}`,p()}try{h.startAutoSave(),l=!0}catch(w){c=`Auto-save failed: ${w.message}`}try{h.startAutoLoad(1),n=!0}catch(w){c=`Auto-load failed: ${w.message}`}p()}async function x(){if(r){l&&(r.stopAutoSave(),l=!1),n&&(r.stopAutoLoad(),n=!1);try{await r.save(),a=Date.now()}catch(h){c=`Final save failed: ${h.message}`}p()}}async function C(){if(!(i==="none"||!r)){try{await r.save(),a=Date.now(),c=null}catch(h){c=`Save failed: ${h.message}`}p()}}async function S(){if(!(i==="none"||!r)){try{await r.load(),u=Date.now(),c=null}catch(h){c=`Load failed: ${h.message}`}p()}}async function E(){if(await x(),r){try{r.destroy()}catch{}r=null}d=[],p()}function $(h){if(h===i)return;let w=i;i=h,w==="indexeddb"&&h==="none"&&(r&&l&&(r.stopAutoSave(),l=!1),r&&n&&(r.stopAutoLoad(),n=!1)),h==="indexeddb"&&w==="none"&&P().catch(()=>{}),p()}function _(h){return d.push(h),()=>{d=d.filter(w=>w!==h)}}return{start:P,stop:x,save:C,load:S,setMode:$,getStatus:v,addListener:_,destroy:E}}var ue=class{constructor(t=50){this._stack=[];this._position=-1;this._listeners=[];this._maxDepth=t}push(t){if(this._position<this._stack.length-1&&(this._stack=this._stack.slice(0,this._position+1)),this._position>=0){let e=this._stack[this._position];if(JSON.stringify(e)===JSON.stringify(t))return}this._stack.push(structuredClone(t)),this._stack.length>this._maxDepth?this._stack.shift():this._position++,this._notifyListeners()}undo(){return this._position<=0?null:(this._position--,this._notifyListeners(),structuredClone(this._stack[this._position]))}redo(){return this._position>=this._stack.length-1?null:(this._position++,this._notifyListeners(),structuredClone(this._stack[this._position]))}current(){return this._position<0?null:structuredClone(this._stack[this._position])}jumpTo(t){return t<0||t>=this._stack.length?null:(this._position=t,this._notifyListeners(),structuredClone(this._stack[this._position]))}getState(){return{canUndo:this._position>0,canRedo:this._position<this._stack.length-1,position:this._position,total:this._stack.length}}getTimeline(){return this._stack.map((t,e)=>({position:e,id:t.id}))}clear(){this._stack=[],this._position=-1,this._notifyListeners()}addListener(t){return this._listeners.push(t),()=>{this._listeners=this._listeners.filter(e=>e!==t)}}_notifyListeners(){let t=this.getState();for(let e of this._listeners)try{e(t)}catch{}}};function Zt(s){if(!Y(s))return s;let t=typeof s.manifest=="string"?s.manifest:"";if(!(/^0\.0(?:\.|$)/.test(t)||!t&&("version"in s||"manifestVersion"in s||"components"in s||"rootElement"in s||Ur(s.elements))))return s;let r={...s,manifest:"0.1.0"};if(delete r.version,delete r.manifestVersion,!r.elements&&Y(r.components)&&(r.elements=r.components,delete r.components),!r.root&&typeof r.rootElement=="string"&&(r.root=r.rootElement,delete r.rootElement),Y(r.elements)){let l={};for(let[n,a]of Object.entries(r.elements)){if(!Y(a))continue;let u={...a};!u.type&&typeof u.component=="string"&&(u.type=u.component,delete u.component),l[n]=u}r.elements=l}return r}function Ur(s){return Y(s)?Object.values(s).some(t=>Y(t)&&"component"in t):!1}function Y(s){return s!==null&&typeof s=="object"&&!Array.isArray(s)}import{html as je,css as Re,nothing as Fr}from"lit";import{LitElement as Nr}from"lit";var de=class de extends Nr{constructor(){super(...arguments);this._instanceId=`forge-${++de._instanceCounter}`;this.props={};this.store=null;this.onAction=null;this.itemContext=null}static get properties(){return{props:{type:Object}}}connectedCallback(){super.connectedCallback()}resolve(e){if(!this.store)return e;this.itemContext&&J(this.itemContext);try{return I(this.store,e)}finally{J(null)}}getProp(e){let o=this.props?.[e];return typeof o=="string"&&(o.startsWith("$state:")||o.startsWith("$computed:")||o.startsWith("$item:")||o.startsWith("$expr:")||o.includes("{{")&&o.includes("}}"))?this.resolve(o):o}getArray(e){let o=this.getProp(e);return Array.isArray(o)?o:o&&typeof o=="object"?Object.values(o):[]}getString(e,o=""){let i=this.getProp(e);return typeof i=="string"?i:String(i??o)}getNumber(e,o=0){let i=this.getProp(e);return typeof i=="number"?i:Number(i)||o}getBool(e,o=!1){let i=this.getProp(e);return typeof i=="boolean"?i:o}getBoundProp(e,o){let i=typeof this.props?.bind=="string"?this.props.bind:"";if(i){let l=this.resolve(i);if(l!==void 0)return l}let r=this.getProp(e);return r===void 0?o:r}dispatchAction(e,o){let i=typeof this.props?.bind=="string"?this.props.bind:"",r=i?{...o||{},bind:i}:o;this.onAction&&this.onAction(e,r),this.dispatchEvent(new CustomEvent("forgeui-action",{detail:{action:e,payload:r},bubbles:!0,composed:!0}))}handleAction(e){let o=this.getString("action");o&&this.dispatchAction(o,this.props)}prop(e){return this.getProp(e)}static get sharedStyles(){return[_e]}gapValue(e){let o={none:"0",0:"0","3xs":"var(--forgeui-space-3xs)","2xs":"var(--forgeui-space-2xs)",xs:"var(--forgeui-space-xs)",sm:"var(--forgeui-space-sm)",md:"var(--forgeui-space-md)",lg:"var(--forgeui-space-lg)",xl:"var(--forgeui-space-xl)","2xl":"var(--forgeui-space-2xl)"};if(e==null||e==="")return"var(--forgeui-space-md)";let i=String(e);return i in o?o[i]:/^\d+(\.\d+)?$/.test(i)?`${i}px`:/^\d+(\.\d+)?(px|rem|em|%|vw|vh|ch)$/.test(i)?i:"var(--forgeui-space-md)"}static get styles(){return[_e]}};de._instanceCounter=0;var g=de;var Ce=class extends g{static get styles(){return Re`
  ...
  `}render(){let t=this.getString("label","Button"),e=this.getString("variant","primary"),o=this.getString("size",""),i=this.getBool("disabled"),r=this.getProp("pressed");return je`<button class="${e} ${o}" ?disabled=${i}
      aria-pressed=${r==null?Fr:String(!!r)}
      @click=${l=>this.handleAction(l)}>${t}<slot></slot></button>`}};customElements.define("forgeui-button",Ce);var Me=class extends g{static get styles(){return Re`
    :host { display:flex; gap:var(--forgeui-space-xs); }
  `}render(){return je`<slot></slot>`}};customElements.define("forgeui-button-group",Me);var Te=class extends g{static get styles(){return Re`
    :host { display:inline-flex; }
  ...
  `}render(){let t=this.getString("label",""),e=this.getString("href","#");return je`<a href="${e}">${t}<slot></slot></a>`}};customElements.define("forgeui-link",Te);import{html as D,css as X,nothing as Yt}from"lit";var ze=class extends g{static get properties(){return{props:{type:Object}}}static get styles(){return X`
  ...
  `}render(){let t=this.getString("src",""),e=this.getString("alt",""),o=this.getString("fit","contain");return t?D`<img src="${t}" alt="${e}" style="object-fit:${o}" loading="lazy">`:D`${Yt}`}};customElements.define("forgeui-image",Le);var De=class extends g{static get styles(){return X`
  ...
  `}render(){let t=this.getString("title","Nothing here"),e=this.getString("description","");return D`
      ...
      ${e?D`<div class="desc">${e}</div>`:Yt}
      <slot></slot>
    `}};customElements.define("forgeui-empty-state",Ne);import{html as y,css as Q,svg as F,nothing as k}from"lit";var Fe=class extends g{constructor(){super(...arguments);this._query="";this._sortKey="";this._sortDir="asc";this._page=0}static get styles(){return Q`
  ...
  `}_colKey(e){return typeof e=="string"?e:String(e?.key??"")}_colLabel(e){return typeof e=="string"?e:String(e?.label??e?.key??"")}_statusClass(e){let o=String(e??"").toLowerCase().trim();return["done","complete","completed","success","active","ok","approved","paid"].includes(o)?"success":["in progress","in-progress","pending","warning","waiting","review"].includes(o)?"warning":["to do","to-do","todo","backlog","draft","new","inactive"].includes(o)?"neutral":["high","urgent","critical"].includes(o)?"error":["medium","med"].includes(o)?"warning":["low"].includes(o)?"info":["failed","error","rejected","blocked","overdue"].includes(o)?"error":"neutral"}_renderCell(e,o){let i=this._colKey(e),r=o[i],l=e&&typeof e=="object"?e.type:void 0;if(r==null||r==="")return y`<span style="color:var(--forgeui-color-text-tertiary)">—</span>`;if(l==="badge"||l==="status"){let n=(e.variant&&typeof e.variant=="object"?e.variant[String(r).toLowerCase()]:null)||this._statusClass(r);return y`<span class="badge ${n}">${String(r)}</span>`}if(l==="number")return typeof r=="number"?r.toLocaleString():String(r);if(l==="date"){let n=typeof r=="string"||typeof r=="number"?new Date(r):r;return n instanceof Date&&!isNaN(n.getTime())?n.toLocaleDateString():String(r)}if(l==="currency"){let n=Number(r);return isNaN(n)?String(r):n.toLocaleString(void 0,{style:"currency",currency:e.currency||"USD"})}return l==="boolean"?r?"\u2713":"\u2717":String(r)}_sortBy(e){e&&(this._sortKey===e?this._sortDir=this._sortDir==="asc"?"desc":"asc":(this._sortKey=e,this._sortDir="asc"),this._page=0,this.requestUpdate())}_setQuery(e){this._query=e,this._page=0,this.requestUpdate()}_filteredRows(e,o){let i=this._query.trim().toLowerCase();return i?e.filter(r=>o.some(l=>String(r[this._colKey(l)]??"").toLowerCase().includes(i))):e}_sortedRows(e){if(!this._sortKey)return e;let o=this._sortDir==="asc"?1:-1;return[...e].sort((i,r)=>{let l=i?.[this._sortKey],n=r?.[this._sortKey];if(typeof l=="number"&&typeof n=="number")return(l-n)*o;let a=String(l??"").toLowerCase(),u=String(n??"").toLowerCase();return(a>u?1:a<u?-1:0)*o})}_setPage(e,o){this._page=Math.max(0,Math.min(e,Math.max(0,o-1))),this.requestUpdate()}render(){let e=this.getProp("data"),o=this.getProp("columns")||[],i=this.getString("emptyMessage","No data yet"),r=this.getString("rowAction",""),l=this.getString("caption",""),n=this.getBool("searchable",!1),a=Math.max(0,Math.floor(this.getNumber("pageSize",0)));if(!Array.isArray(e))return y`<div class="empty">${i}</div>`;let u=o.length>0?o:e.length>0?Object.keys(e[0]):[];if(u.length===0)return y`<div class="empty">${i}</div>`;let c=this._filteredRows(e,u),d=this._sortedRows(c),p=a>0?Math.max(1,Math.ceil(d.length/a)):1,v=Math.min(this._page,p-1);v!==this._page&&(this._page=v);let O=a>0?d.slice(v*a,v*a+a):d;return y`
      ...
      <table>
        ...
        <thead><tr>${u.map(P=>{let x=this._colLabel(P),C=this._colKey(P),S=typeof P=="object"?P.align:void 0,E=typeof P=="object"?P.width:void 0,$=S==="right"?"align-right":S==="center"?"align-center":"",_=typeof P=="object"&&P.sortable===!0,h=this._sortKey===C;return y`<th class="${$}" style="${E?`width:${E}`:""}" aria-sort=${h?this._sortDir==="asc"?"ascending":"descending":k}>
            ${_?y`
              <button type="button" @click=${()=>this._sortBy(C)}>
                <span>${x}</span>${h?y`<span class="sort" aria-hidden="true">${this._sortDir==="asc"?"\u25B2":"\u25BC"}</span>`:k}
              </button>
            `:x}
          </th>`})}</tr></thead>
        <tbody>${O.length===0?y`<tr><td colspan=${u.length} class="empty">${i}</td></tr>`:O.map((P,x)=>{let C=a>0?v*a+x:x,S=!!r,E=S?String(P[typeof u[0]=="string"?u[0]:u[0]?.key]??`Row ${x+1}`):"";return y`<tr class="${S?"row-action":""}"
                tabindex=${S?0:k}
                role=${S?"button":k}
                aria-label=${S?E:k}
                @click=${S?()=>this.dispatchAction(r,{row:P,index:C}):void 0}
                @keydown=${S?$=>{($.key==="Enter"||$.key===" ")&&($.preventDefault(),this.dispatchAction(r,{row:P,index:C}))}:void 0}>
      ...
      `:k}
    `}};customElements.define("forgeui-table",Fe);var Be=class extends g{static get styles(){return Q`
    :host { display:block; }
  ...
  `}render(){let t=this.getProp("data"),e=this.getString("dataPath","");!("data"in(this.props||{}))&&e&&this.store?.hasTable(e)&&(t=Object.values(this.store.getTable(e)));let o=this.getString("emptyMessage","No items");return!Array.isArray(t)||t.length===0?y`<div class="empty">${o}</div>`:y`<div class="list">${t.map((i,r)=>y`
    ...
    `)}</div>`}};customElements.define("forgeui-list",Be);var Ve=class extends g{constructor(){super(...arguments);this._palette=["var(--forgeui-color-primary)","var(--forgeui-color-success)","var(--forgeui-color-warning)","var(--forgeui-color-error)","var(--forgeui-color-info)","var(--forgeui-color-chart-6)","var(--forgeui-color-chart-7)","var(--forgeui-color-chart-8)","var(--forgeui-color-chart-9)","var(--forgeui-color-chart-10)"]}static get styles(){return Q`
    :host { display:block; min-width:0; }
  ...
  `}_niceMax(e){if(e<=0)return 1;let o=Math.pow(10,Math.floor(Math.log10(e))),i=e/o;return(i<=1?1:i<=2?2:i<=5?5:10)*o}render(){let e=this.getString("chartType","bar"),o=this.getProp("data")||[],i=this.getString("title",""),r=this.getString("xKey","label")||this.getString("labelKey","label"),l=this.getString("yKey","value")||this.getString("valueKey","value"),n=this.getString("color","");if(!o||o.length===0)return y`
      ...
      `;let a=o.map(x=>typeof x=="number"?{label:"",value:x}:x&&typeof x=="object"?{label:String(x[r]??x.label??x.name??x.x??""),value:Number(x[l]??x.value??x.y??0)||0,color:x.color}:{label:String(x),value:0}),u=600,c=260,d={top:8,right:16,bottom:36,left:48},p=u-d.left-d.right,v=c-d.top-d.bottom,O,P=k;if(e==="pie"||e==="donut"){let x=a.reduce((R,M)=>R+Math.max(0,M.value),0)||1,C=u/2,S=c/2,E=Math.min(p,v)/2-8,$=e==="donut"?E*.55:0,_=-Math.PI/2,h=[],w=[];a.forEach((R,M)=>{let V=Math.max(0,R.value)/x,z=_,L=_+V*Math.PI*2;_=L;let ee=L-z>Math.PI?1:0,le=C+E*Math.cos(z),At=S+E*Math.sin(z),Pt=C+E*Math.cos(L),Et=S+E*Math.sin(L),pe=R.color||this._palette[M%this._palette.length];if(w.push(pe),$>0){let Qt=C+$*Math.cos(z),er=S+$*Math.sin(z),tr=C+$*Math.cos(L),rr=S+$*Math.sin(L);h.push(F`<path class="slice" fill="${pe}" d="M ${le} ${At} A ${E} ${E} 0 ${ee} 1 ${Pt} ${Et} L ${tr} ${rr} A ${$} ${$} 0 ${ee} 0 ${Qt} ${er} Z"/>`)}else h.push(F`<path class="slice" fill="${pe}" d="M ${C} ${S} L ${le} ${At} A ${E} ${E} 0 ${ee} 1 ${Pt} ${Et} Z"/>`)}),O=F`<g>${h}</g>`,P=y`<div class="legend">${a.map((R,M)=>y`
        <span class="legend-item"><span class="swatch" style="background:${w[M]}"></span>${R.label} (${R.value})</span>
      `)}</div>`}else{let x=Math.max(...a.map(_=>_.value),0),C=this._niceMax(x),S=_=>d.top+v-_/C*v,E=4,$=[];for(let _=0;_<=E;_++){let h=C*_/E,w=S(h);$.push(F`<line class="grid" x1="${d.left}" x2="${d.left+p}" y1="${w}" y2="${w}"/>`),$.push(F`<text class="tick-label" x="${d.left-6}" y="${w+3}" text-anchor="end">${h.toLocaleString()}</text>`)}if(e==="line"||e==="area"){let _=p/Math.max(1,a.length-1),h=a.map((M,V)=>{let z=d.left+V*_,L=S(M.value);return`${V===0?"M":"L"} ${z} ${L}`}).join(" "),w=e==="area"?h+` L ${d.left+p} ${d.top+v} L ${d.left} ${d.top+v} Z`:"",R=n||"var(--forgeui-color-primary)";O=y`
          <g>${$}</g>
          ${e==="area"?F`<path class="area" d="${w}" style="fill:${R};opacity:0.15"/>`:k}
          ${F`<path class="line" d="${h}" style="stroke:${R}"/>`}
          ${a.map((M,V)=>{let z=d.left+V*_,L=S(M.value);return F`<circle class="point" cx="${z}" cy="${L}" r="3" style="fill:${R}"/>
              <text class="tick-label" x="${z}" y="${d.top+v+14}" text-anchor="middle">${M.label}</text>`})}
        `}else{let _=a.length,h=p/_,w=Math.max(2,h*.7),R=h-w;O=y`
          <g>${$}</g>
          ${a.map((M,V)=>{let z=d.left+V*h+R/2,L=S(M.value),ee=Math.max(0,d.top+v-L),le=M.color||n||"var(--forgeui-color-primary)";return F`<rect class="bar" x="${z}" y="${L}" width="${w}" height="${ee}" rx="2" style="fill:${le}">
                <title>${M.label}: ${M.value}</title>
              </rect>
              <text class="tick-label" x="${z+w/2}" y="${d.top+v+14}" text-anchor="middle">${M.label}</text>`})}
        `}}return y`
      ${i?y`<div class="title">${i}</div>`:k}
      <div class="wrap">
    ...
    `}};customElements.define("forgeui-chart",Ve);var qe=class extends g{static get styles(){return Q`
    :host { display:block; min-width:0; }
  ...
  `}_trendClass(t){let e=String(t??"").toLowerCase();return e==="up"||e==="positive"||e.startsWith("+")?"up":e==="down"||e==="negative"||e.startsWith("-")?"down":"neutral"}render(){let t=this.getString("label",""),e=this.getProp("value"),o=this.getProp("trend"),i=this.getString("trendLabel",""),r=this.getString("subtitle",""),l=this.getString("unit",""),n=typeof e=="number"?e.toLocaleString():e==null||e===""?"\u2014":String(e),a=i||(o==null?"":String(o)),u=this._trendClass(o);return y`<div class="card">
      ...
      <div class="value">${n}${l?y` <span class="meta">${l}</span>`:k}</div>
      ${r?y`<div class="meta">${r}</div>`:k}
    </div>`}};customElements.define("forgeui-stat-card",qe);var Ke=class extends g{static get styles(){return Q`
    :host { display:grid; min-width:0; gap:var(--forgeui-space-md); grid-template-columns:repeat(auto-fit,minmax(min(12rem,100%),1fr)); }
  `}render(){let t=Math.max(0,Math.floor(this.getNumber("columns",0))),e=this.gapValue(this.getString("gap","md"));return this.style.gap=e,this.style.gridTemplateColumns=t>0?`repeat(${t}, minmax(0, 1fr))`:"",y`<slot></slot>`}};customElements.define("forgeui-kpi-grid",Ke);var We=class extends g{static get styles(){return Q`
  ...
  `}_trendMeta(t){if(t==null||t==="")return null;if(typeof t=="number")return t>0?{dir:"up",arrow:"\u2191",display:`${Math.abs(t)}%`}:t<0?{dir:"down",arrow:"\u2193",display:`${Math.abs(t)}%`}:{dir:"neutral",arrow:"\u2192",display:"0%"};if(typeof t=="string"){let e=t.toLowerCase(),o=t.match(/^\s*([+-]?\d+(?:\.\d+)?)\s*(%?)\s*$/);if(o){let i=parseFloat(o[1]),r=o[2];return i>0?{dir:"up",arrow:"\u2191",display:`${Math.abs(i)}${r}`}:i<0?{dir:"down",arrow:"\u2193",display:`${Math.abs(i)}${r}`}:{dir:"neutral",arrow:"\u2192",display:`0${r}`}}return e==="up"||e==="positive"||e==="increase"?{dir:"up",arrow:"\u2191",display:""}:e==="down"||e==="negative"||e==="decrease"?{dir:"down",arrow:"\u2193",display:""}:e==="flat"||e==="neutral"||e==="same"?{dir:"neutral",arrow:"\u2192",display:""}:{dir:"neutral",arrow:"",display:t}}return null}render(){let t=this.getString("label",""),e=this.getProp("value"),o=this.getProp("trend"),i=this.getString("trendLabel",""),r=this.getProp("goal"),l=this.getString("unit",""),n=this.getString("suffix",""),a=this.getString("subtitle",""),u=this.getString("variant","");u&&this.setAttribute("variant",u);let c=typeof e=="number"?e.toLocaleString():e==null||e===""?"\u2014":String(e),d=this._trendMeta(o);return y`
    ...
    `}};customElements.define("forgeui-metric",We);import{css as Br,svg as q}from"lit";var Ge=class extends g{static get properties(){return{props:{type:Object}}}static get styles(){return Br`
    :host { display:block; }
    svg { display:block; }
  `}render(){let t=this.getNumber("width",400),e=this.getNumber("height",300),o=this.getString("background","transparent"),i=this.getProp("shapes")||[];return q`
    ...
    `}renderShape(t){let e={fill:t.fill??void 0,stroke:t.stroke??void 0,"stroke-width":t.strokeWidth??void 0,opacity:t.opacity??void 0},o=t.action?()=>{this.onAction&&this.onAction(t.action)}:void 0,i=t.action?"cursor:pointer":void 0;switch(t.type){case"rect":return q`<rect
        ...
        >${t.content??""}</text>`;case"path":return q`<path
          ...
          style="${i}"
          @click=${o}
        />`;default:return q``}}};customElements.define("forgeui-drawing",Ge);import{html as N,css as se,nothing as K}from"lit";var He=class extends g{static get styles(){return se`
  ...
  `}render(){let t=this.getString("variant","info"),e=this.getString("title",""),o=this.getString("message","");return N`<div class="alert ${t}" role=${t==="error"||t==="warning"?"alert":"status"}>
    ...
    </div>`}};customElements.define("forgeui-alert",He);var Je=class extends g{constructor(){super(...arguments);this._priorFocus=null;this._keydownHandler=e=>this._onKeydown(e);this._close=()=>{this.dispatchAction("close")}}static get styles(){return se`
    :host { display:none; }
  ...
  `}render(){let t=this.getProp("value"),e=this.getNumber("max",100),o=t==null,i=o?0:Math.max(0,Math.min(Number(t),e)),r=o?0:i/e*100,l=this.getString("label",""),n=this.getBool("showValue");return N`
    ...
    `}};customElements.define("forgeui-progress",Ze);var Ye=class extends g{static get styles(){return se`
  ...
  `}render(){let t=this.getString("message","");return t?N`<div class="toast">${t}</div>`:N`${K}`}};customElements.define("forgeui-toast",Ye);var Xe=class extends g{static get styles(){return se`
    :host { display:block; }
  ...
  `}render(){let t=this.getString("msg","Unknown error");return N`<div class="error" role="alert">⚠ ${t}</div>`}};customElements.define("forgeui-error",Xe);import{html as b,css as T,nothing as A}from"lit";var Qe=class extends g{static get styles(){return T`
  ...
  `}render(){let t=this.getString("label",""),e=this.getString("placeholder",""),o=this.getString("hint",""),i=this.getString("error",""),r=this.getString("inputType","")||this.getString("type","text"),l=this.getBool("multiline"),n=String(this.getBoundProp("value","")??""),a=this._instanceId;return b`
    ...
    `}};customElements.define("forgeui-text-input",Qe);var et=class extends g{static get styles(){return T`
    :host { display:block; flex:1 1 auto; min-width:0; max-width:100%; margin-bottom:var(--forgeui-space-sm); }
    label { display:block; font-size:var(--forgeui-text-sm); font-weight:var(--forgeui-weight-medium); margin-bottom:var(--forgeui-space-2xs); color:var(--forgeui-color-text); overflow-wrap:break-word; }
  ...
  `}render(){let t=this.getString("label",""),e=this.getString("placeholder",""),o=this.getString("hint",""),i=this.getString("error",""),r=Math.max(1,Math.floor(this.getNumber("rows",4))),l=this.getProp("maxLength"),n=this.getBool("required"),a=this.getBool("disabled"),u=String(this.getBoundProp("value","")??""),c=this._instanceId;return b`
      ...
      ${o&&!i?b`<div class="hint">${o}</div>`:A}
      ${i?b`<div class="error">${i}</div>`:A}
    `}};customElements.define("forgeui-textarea",et);var tt=class extends g{static get styles(){return T`
    :host { display:block; min-width:0; }
    form { display:flex; flex-direction:column; gap:var(--forgeui-space-md); min-width:0; }
  `}render(){let t=this.getString("action","");return b`<form @submit=${e=>{e.preventDefault();let o={submitted:!0};t&&this.dispatchAction(t,o),this.dispatchEvent(new CustomEvent("forgeui-submit",{detail:o,bubbles:!0,composed:!0}))}}><slot></slot></form>`}};customElements.define("forgeui-form",tt);var rt=class extends g{static get styles(){return T`
    :host { display:block; min-width:0; }
  ...
  `}render(){let t=this.getString("label",""),e=this.getString("description",""),o=this.getString("error","");return b`<fieldset>
    ...
    </fieldset>`}};customElements.define("forgeui-field-group",rt);var ot=class extends g{static get styles(){return T`
    :host { display:block; flex:1 1 auto; min-width:0; max-width:100%; margin-bottom:var(--forgeui-space-sm); }
  ...
  `}render(){let t=this.getString("label",""),e=this.getProp("min"),o=this.getProp("max"),i=this.getProp("step"),r=this.getBoundProp("value"),l=this._instanceId;return b`
    ...
    `}};customElements.define("forgeui-number-input",ot);var it=class extends g{static get styles(){return T`
    :host { display:block; flex:1 1 auto; min-width:0; max-width:100%; margin-bottom:var(--forgeui-space-sm); }
    label { display:block; font-size:var(--forgeui-text-sm); font-weight:var(--forgeui-weight-medium); margin-bottom:var(--forgeui-space-2xs); overflow-wrap:break-word; }
  ...
  `}render(){let t=this.getString("label",""),e=this.getProp("options")||[],o=String(this.getBoundProp("value","")??""),i=this._instanceId;return b`
    ...
    `}};customElements.define("forgeui-select",it);var st=class extends g{static get styles(){return T`
    :host { display:block; flex:1 1 auto; min-width:0; max-width:100%; margin-bottom:var(--forgeui-space-sm); }
    label { display:block; font-size:var(--forgeui-text-sm); font-weight:var(--forgeui-weight-medium); margin-bottom:var(--forgeui-space-2xs); overflow-wrap:break-word; }
    input { width:100%; padding:var(--forgeui-space-xs) var(--forgeui-space-sm); border:1px solid var(--forgeui-color-border);
      border-radius:var(--forgeui-radius-md); font:inherit; height:var(--forgeui-input-height);
  ...
  `}render(){let t=this.getString("label",""),e=this.getString("placeholder",""),o=this.getString("hint",""),i=this.getProp("options")||[],r=String(this.getBoundProp("value","")??""),l=this.getBool("disabled"),n=this.getBool("required"),a=this._instanceId,u=`${a}-list`;return b`
    ...
    `}};customElements.define("forgeui-combobox",st);var nt=class extends g{static get styles(){return T`
  ...
  `}render(){let t=this.getString("label",""),e=this.getProp("options")||[],o=this.getBoundProp("value",this.getProp("selected")??[]),i=Number(this.getProp("maxSelections")),r=Number.isFinite(i)&&i>=0?i:1/0,l=(Array.isArray(o)?o.map(c=>String(c)):[]).slice(0,r),n=this.getBool("disabled"),a=this._instanceId,u=c=>{let d=l.filter(p=>p!==c);this.dispatchAction("remove",{value:c}),this.dispatchAction("change",{value:d,selected:d})};return b`
    ...
    `}};customElements.define("forgeui-multi-select",nt);var at=class extends g{static get styles(){return T`
    :host { display:block; margin-bottom:var(--forgeui-space-sm); }
  ...
  `}render(){let t=this.getString("label",""),e=this.getString("hint",""),o=this.getProp("options")||[],i=String(this.getBoundProp("value","")??""),r=this.getBool("disabled"),l=this._instanceId;return b`
    ...
    `}};customElements.define("forgeui-radio-group",at);var lt=class extends g{static get styles(){return T`
  ...
  `}render(){let t=this.getString("label",""),e=!!this.getBoundProp("checked",this.getProp("value")??!1),o=this._instanceId;return b`
    ...
    `}};customElements.define("forgeui-checkbox",lt);var ct=class extends g{constructor(){super(...arguments);this._toggle=()=>{if(this.getBool("disabled"))return;let e=!!this.getBoundProp("on",this.getProp("value")??!1);this.dispatchAction("change",{value:!e,checked:!e})};this._onKeydown=e=>{(e.key==="Enter"||e.key===" "||e.key==="Spacebar")&&(e.preventDefault(),this._toggle())}}static get styles(){return T`
  ...
  `}render(){let e=!!this.getBoundProp("on",this.getProp("value")??!1),o=this.getString("label",""),i=this.getBool("disabled"),r=this._instanceId;return b`
    ...
    `}};customElements.define("forgeui-toggle",ct);var ut=class extends g{static get styles(){return T`
    :host { display:block; flex:1 1 auto; min-width:0; max-width:100%; margin-bottom:var(--forgeui-space-sm); }
    label { display:block; font-size:var(--forgeui-text-sm); font-weight:var(--forgeui-weight-medium); margin-bottom:var(--forgeui-space-2xs); overflow-wrap:break-word; }
    input { width:100%; padding:var(--forgeui-space-xs) var(--forgeui-space-sm); border:1px solid var(--forgeui-color-border);
      border-radius:var(--forgeui-radius-md); font:inherit; height:var(--forgeui-input-height);
  ...
  `}render(){let t=this.getString("label",""),e=this.getString("value",""),o=this._instanceId;return b`
    ...
    `}};customElements.define("forgeui-date-picker",ut);var dt=class extends g{static get styles(){return T`
    :host { display:block; flex:1 1 auto; min-width:0; max-width:100%; margin-bottom:var(--forgeui-space-sm); }
    label { display:block; font-size:var(--forgeui-text-sm); font-weight:var(--forgeui-weight-medium); margin-bottom:var(--forgeui-space-2xs); overflow-wrap:break-word; }
  ...
  `}render(){let t=this.getString("label",""),e=this.getNumber("min",0),o=this.getNumber("max",100),i=this.getNumber("step",1),r=this.getBoundProp("value",e),l=Number(r);Number.isFinite(l)||(l=e);let n=this._instanceId;return b`
    ...
    `}};customElements.define("forgeui-slider",dt);var pt=class extends g{constructor(){super(...arguments);this._dragging=!1;this._openFilePicker=()=>{this.shadowRoot?.querySelector('input[type="file"]')?.click()};this._onDropzoneKeydown=e=>{e.key!=="Enter"&&e.key!==" "||(e.preventDefault(),this._openFilePicker())};this._onFileChange=e=>{let o=Array.from(e.target.files??[]);this._processFiles(o)};this._onDragOver=e=>{e.preventDefault(),!this._dragging&&(this._dragging=!0,this.requestUpdate())};this._onDragLeave=e=>{e.currentTarget===e.target&&(this._dragging=!1,this.requestUpdate())};this._onDrop=e=>{e.preventDefault(),this._dragging=!1,this.requestUpdate(),this._processFiles(Array.from(e.dataTransfer?.files??[]))}}static get styles(){return T`
    :host { display:block; margin-bottom:var(--forgeui-space-sm); }
  ...
  `}_maxSizeBytes(){let e=this.getProp("maxSize");if(typeof e=="number"&&Number.isFinite(e)&&e>=0)return Math.floor(e);if(typeof e!="string")return null;let o=e.trim().match(/^(\d+(?:\.\d+)?)\s*(b|kb|mb|gb)?$/i);if(!o)return null;let i=Number(o[1]),r=(o[2]||"b").toLowerCase(),l=r==="gb"?1<<30:r==="mb"?1<<20:r==="kb"?1024:1,n=i*l;return Number.isFinite(n)?Math.floor(n):null}_newFileId(){return globalThis.crypto?.randomUUID?.()??`${Date.now()}_${Math.random().toString(36).slice(2)}`}_processFiles(e){let o=this.getBool("multiple"),i=this._maxSizeBytes(),r=(o?e:e.slice(0,1)).map(d=>{let p=this._newFileId(),v=i==null||d.size<=i,O={id:p,name:d.name,size:d.size,type:d.type,lastModified:d.lastModified,accepted:v,storageKey:v?p:null};return v||(O.error="maxSize"),[d,O]}),l=r.filter(([,d])=>d.accepted),n=r.map(([,d])=>d),a=l.map(([,d])=>d),u=o?a:a[0]??null,c=a[0]??null;this.dispatchAction("change",{id:c?.id??null,uuid:c?.id??null,name:c?.name??null,size:c?.size??null,type:c?.type??null,lastModified:c?.lastModified??null,storageKey:c?.storageKey??null,value:u,files:n,rejected:n.filter(d=>!d.accepted),multiple:o,maxSize:i}),Ht(l.map(([d,p])=>({file:d,id:p.id})))}render(){let e=this.getString("label","Upload file"),o=this.getString("accept","*"),i=this.getBool("multiple");return b`
    ...
    `}};customElements.define("forgeui-file-upload",pt);import{html as j,css as B,nothing as gt}from"lit";var ft=class extends g{static get properties(){return{props:{type:Object}}}static get styles(){return B`
  ...
  `}render(){let t=this.getString("variant",""),e=this.getString("title",""),o=this.getString("subtitle","");return t&&this.setAttribute("variant",t),j`
      ${e||o?j`
        <div class="header">
          ${e?j`<div class="title">${e}</div>`:gt}
          ${o?j`<div class="subtitle">${o}</div>`:gt}
        </div>
      `:gt}
      <div class="body"><slot></slot></div>
    `}};customElements.define("forgeui-card",ht);var bt=class extends g{static get properties(){return{props:{type:Object}}}static get styles(){return B`:host { display:block; margin-inline:auto; width:100%; box-sizing:border-box; }`}render(){let t=this.getString("maxWidth",""),e={sm:"640px",md:"768px",lg:"1024px",xl:"1280px","2xl":"1536px",full:"100%",none:"none","":""},o=t in e?e[t]:t,i=this.getString("padding","");return o&&o!=="none"?this.style.maxWidth=o:this.style.maxWidth="",this.style.padding=i?this.gapValue(i):"",j`<slot></slot>`}};customElements.define("forgeui-container",bt);var yt=class extends g{static get properties(){return{props:{type:Object}}}constructor(){super(),this._active=""}static get styles(){return B`
    :host { display:block; }
  ...
  `}_itemKey(t){return typeof t=="string"?t:String(t&&typeof t=="object"?t.id??t.key??t.value??t.label??"":t??"")}_itemLabel(t){return typeof t=="string"?t:String(t&&typeof t=="object"?t.label??t.title??t.value??"":t??"")}updated(){Array.from(this.children).filter(e=>!(e instanceof HTMLScriptElement)).forEach((e,o)=>{let i=(e.props||{}).slot??e.getAttribute("slot");String(o)===this._active||i===this._active?e.setAttribute("data-active",""):e.removeAttribute("data-active")})}_moveTo(t,e){let o=this._itemKey(e[t])||String(t);this._active=o,this.requestUpdate(),this.dispatchAction("tab-change",{active:o,value:o}),this.updateComplete.then(()=>{this.shadowRoot?.querySelector(`#${this._instanceId}-tab-${t}`)?.focus()})}render(){let t=this.getProp("items")||this.getProp("tabs")||[],e=Array.isArray(t)?t:[],o=this.getBoundProp("activeTab",this.getProp("value"));o!==void 0&&String(o)!==this._active&&(this._active=String(o)),!this._active&&e.length>0&&(this._active=this._itemKey(e[0])||"0");let i=e.findIndex((l,n)=>(this._itemKey(l)||String(n))===this._active),r=(l,n)=>{let a=-1;l.key==="ArrowRight"?a=(n+1)%e.length:l.key==="ArrowLeft"?a=(n-1+e.length)%e.length:l.key==="Home"?a=0:l.key==="End"&&(a=e.length-1),a!==-1&&(l.preventDefault(),this._moveTo(a,e))};return j`
    ...
    `}};customElements.define("forgeui-tabs",yt);var vt=class extends g{static get properties(){return{props:{type:Object}}}static get styles(){return B`
    :host { display:block; }
  ...
  `}render(){let t=this.getString("title","Section");return j`<details><summary>${t}</summary><div class="content"><slot></slot></div></details>`}};customElements.define("forgeui-accordion",vt);var xt=class extends g{static get styles(){return B`
    :host { display:block; }
    hr { border:none; border-top:1px solid var(--forgeui-color-border); margin:var(--forgeui-space-sm) 0; }
  `}render(){return j`<hr>`}};customElements.define("forgeui-divider",xt);var wt=class extends g{static get styles(){return B`:host { display:block; }`}render(){let t=this.getString("size","md"),e=this.getString("height",""),o=this.getString("width",""),i=e?this.gapValue(e):this.gapValue(t),r=o?/^\d+(\.\d+)?%$/.test(o)?o:this.gapValue(o):"";return j`<div style="height:${i};${r?`width:${r}`:""}"></div>`}};customElements.define("forgeui-spacer",wt);var $t=class extends g{static get properties(){return{props:{type:Object}}}static get styles(){return B`
    :host { display:flex; flex-direction:column; gap:var(--forgeui-space-md); min-width:0; }
    :host([direction="row"]) { flex-direction:row; flex-wrap:wrap; }
    .empty { padding:var(--forgeui-space-lg); text-align:center; color:var(--forgeui-color-text-tertiary); font-size:var(--forgeui-text-sm); }
  `}render(){let t=this.getArray("data"),e=this.getString("emptyMessage",""),o=this.getString("direction","column");(o==="row"||o==="horizontal")&&this.setAttribute("direction","row");let i=this.getString("gap","md");return this.style.gap=this.gapValue(i),t.length===0&&e?j`<div class="empty">${e}</div>`:j`<slot></slot>`}};customElements.define("forgeui-repeater",$t);import{html as G,css as Xt,nothing as Vr}from"lit";var kt=class extends g{static get styles(){return Xt`
  ...
  `}render(){let t=this.getProp("items")||[];return G`${t.map((e,o)=>{let i=o===t.length-1,r=typeof e=="string"?e:e.label,l=typeof e=="string"?"#":e.href;return G`
        ${o>0?G`<span class="sep">/</span>`:Vr}
        ${i?G`<span class="current">${r}</span>`:G`<a href="${l}">${r}</a>`}
      `})}`}};customElements.define("forgeui-breadcrumb",kt);var St=class extends g{static get styles(){return Xt`
