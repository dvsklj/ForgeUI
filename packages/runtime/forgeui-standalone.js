...
`;var Zt=["mutateState","navigate","openDialog","closeDialog","callApi","toast","custom"],Xt=["set","append","update","delete","increment","decrement","toggle"],Qt=["GET","POST","PUT","PATCH","DELETE","get","post","put","patch","delete"];function Te(s="default"){switch(s){case"minimal":return er();case"default":return tr();case"full":return Vr()}}function er(){let t=Object.entries(Ut).map(([e,o])=>`  ${e}: ${o.join(", ")}`).join(`
...
`)}function Ie(){return{type:"object",required:["manifest","id","elements"],properties:{manifest:{type:"string",const:"0.1.0"},id:{type:"string",pattern:"^[a-z0-9][a-z0-9-]*$"},root:{type:"string"},title:{type:"string"},schema:{type:"object",properties:{version:{type:"number"},tables:{type:"object",additionalProperties:{type:"object",properties:{columns:{type:"object",additionalProperties:{type:"object",properties:{type:{type:"string",enum:["string","number","boolean"]},default:{}},required:["type"]}}},required:["columns"]}}}},state:{type:"object",additionalProperties:{}},elements:{type:"object",additionalProperties:{type:"object",properties:{type:{type:"string",enum:pe},props:{type:"object"},children:{type:"array",items:{type:"string"}},visible:{type:"object",properties:{$when:{type:"object",properties:{path:{type:"string"},eq:{},neq:{},gt:{type:"number"},lt:{type:"number"},gte:{type:"number"},lte:{type:"number"},in:{type:"array"},notIn:{type:"array"},exists:{type:"boolean"}},required:["path"]}}}},required:["type"]}},actions:{type:"object",additionalProperties:{type:"object",properties:{type:{type:"string",enum:[...Zt]},path:{type:"string"},value:{},operation:{type:"string",enum:[...Xt]},set:{type:"object"},data:{type:"object"},key:{type:"string"},formId:{type:"string"},action:{type:"string"},target:{type:"string"},url:{type:"string"},method:{type:"string",enum:[...Qt]},body:{type:"object"},message:{type:"string"},duration:{type:"number",minimum:0}},required:["type"]}},dataAccess:{type:"object",properties:{enabled:{type:"boolean",default:!1},readable:{type:"array",items:{type:"string"}},restricted:{type:"array",items:{type:"string"}},summaries:{type:"boolean",default:!1}}},persistState:{type:"boolean"},skipPersistState:{type:"boolean"}}}}var qr={container:"Stack",row:"Stack",column:"Stack",text:"Text",heading:"Text",label:"Text",image:"Image",icon:"Icon",button:"Button",link:"Link",textInput:"TextInput",textarea:"Textarea",textArea:"Textarea",numberInput:"NumberInput",checkbox:"Checkbox",toggle:"Toggle",select:"Select",divider:"Divider",spacer:"Spacer",card:"Card",table:"Table",list:"List",alert:"Alert",progress:"Progress",badge:"Badge",avatar:"Avatar"};function Kr(s){let t={},e=0;function o(n){let a=n.id||`a2ui-${e++}`,u=qr[n.type];if(!u||!se(u))return t[a]={type:"Text",props:{content:`[Unsupported A2UI type: ${n.type}]`,variant:"caption",colorScheme:"secondary"}},a;let l=Hr(n.type,n.props||{}),d=(n.children||[]).map(p=>o(p));return t[a]={type:u,props:l,children:d.length>0?d:void 0},a}let r=(s.components||s.content||[]).map(n=>o(n)),c=r.length===1?r[0]:"a2ui-root";return r.length>1&&(t[c]={type:"Stack",props:{gap:"md"},children:r}),{manifest:"0.1.0",id:`a2ui-${Date.now()}`,root:c,elements:t,actions:{}}}function Hr(s,t){let e={...t};switch(s){case"heading":e.variant="heading",e.content=t.text||t.content||"",delete e.text;break;case"text":case"label":e.content=t.text||t.content||"",delete e.text;break;case"row":e.direction="row",e.gap=t.gap||t.spacing||"md";break;case"column":e.direction="column",e.gap=t.gap||t.spacing||"md";break;case"container":e.gap=t.gap||t.spacing||"md";break;case"image":e.src=t.src||t.url||"",e.alt=t.alt||"";break;case"button":e.label=t.text||t.label||"",e.variant=t.variant||t.style||"default";break;case"textInput":case"textarea":case"textArea":e.placeholder=t.placeholder||"",e.value=t.value||"",e.label=t.label||"";break;case"numberInput":e.placeholder=t.placeholder||"",e.value=t.value??0,e.label=t.label||"";break;case"select":t.options&&Array.isArray(t.options)&&(e.options=t.options.map(o=>typeof o=="string"?{value:o,label:o}:o));break;case"alert":e.variant=t.type||t.severity||"info",e.content=t.message||t.text||t.content||"",delete e.message,delete e.text;break;case"progress":e.value=t.value??t.percent??0;break}return e}function rr(s){if(!s||typeof s!="object")return!1;let t=s;return!!(Array.isArray(t.components)||Array.isArray(t.content)||typeof t.type=="string"&&(t.type==="adaptive-card"||t.type.startsWith("a2ui"))||typeof t.version=="string"&&t.version.startsWith("a2ui")||!t.elements&&!t.manifest&&Array.isArray(t.content))}function Ce(s){return rr(s)?Kr(s):s}function or(s){return`forgeui_${(s||"global").replace(/[^a-zA-Z0-9-]/g,"_")}`}var Me="f";function Wr(s){return new Promise((t,e)=>{let o=r=>e(r??new Error("IDB"));if(!globalThis.indexedDB)return o();let i=indexedDB.open(`${or(s)}_f`,1);i.onupgradeneeded=()=>{i.result.createObjectStore(Me)},i.onsuccess=()=>t(i.result),i.onerror=i.onblocked=()=>o(i.error)})}async function ir(s,t){if(s.length===0)return;let e=null;try{e=await Wr(t),await new Promise((o,i)=>{let r=e.transaction(Me,"readwrite"),c=r.objectStore(Me);for(let{file:n,id:a}of s)c.put(n,a);r.oncomplete=()=>o(),r.onerror=r.onabort=()=>i(r.error)})}catch{return}finally{e?.close()}}function sr(s,t,e="none"){let o=or(t),i=e,r=null,c=!1,n=!1,a=null,u=null,l=null,d=[];function p(){let y=v();for(let k of d)try{k(y)}catch{}}function v(){return{mode:i,isPersisting:r!=null&&c,lastSaved:a,lastLoaded:u,error:l,dbName:i==="indexeddb"?o:null}}async function R(){if(r)return r;try{let{createIndexedDbPersister:y}=await import("tinybase/persisters/persister-indexed-db");return r=y(s,o),l=null,r}catch(y){throw l=`IndexedDB unavailable: ${y.message}`,p(),y}}async function S(){if(i==="none")return;let y=await R();try{await y.load(),u=Date.now()}catch(k){l=`Load failed: ${k.message}`,p()}try{y.startAutoSave(),c=!0}catch(k){l=`Auto-save failed: ${k.message}`}try{y.startAutoLoad(1),n=!0}catch(k){l=`Auto-load failed: ${k.message}`}p()}async function x(){if(r){c&&(r.stopAutoSave(),c=!1),n&&(r.stopAutoLoad(),n=!1);try{await r.save(),a=Date.now()}catch(y){l=`Final save failed: ${y.message}`}p()}}async function C(){if(!(i==="none"||!r)){try{await r.save(),a=Date.now(),l=null}catch(y){l=`Save failed: ${y.message}`}p()}}async function A(){if(!(i==="none"||!r)){try{await r.load(),u=Date.now(),l=null}catch(y){l=`Load failed: ${y.message}`}p()}}async function E(){if(await x(),r){try{r.destroy()}catch{}r=null}d=[],p()}function _(y){if(y===i)return;let k=i;i=y,k==="indexeddb"&&y==="none"&&(r&&c&&(r.stopAutoSave(),c=!1),r&&n&&(r.stopAutoLoad(),n=!1)),y==="indexeddb"&&k==="none"&&S().catch(()=>{}),p()}function P(y){return d.push(y),()=>{d=d.filter(k=>k!==y)}}return{start:S,stop:x,save:C,load:A,setMode:_,getStatus:v,addListener:P,destroy:E}}var fe=class{constructor(t=50){this._stack=[];this._position=-1;this._listeners=[];this._maxDepth=t}push(t){if(this._position<this._stack.length-1&&(this._stack=this._stack.slice(0,this._position+1)),this._position>=0){let e=this._stack[this._position];if(JSON.stringify(e)===JSON.stringify(t))return}this._stack.push(structuredClone(t)),this._stack.length>this._maxDepth?this._stack.shift():this._position++,this._notifyListeners()}undo(){return this._position<=0?null:(this._position--,this._notifyListeners(),structuredClone(this._stack[this._position]))}redo(){return this._position>=this._stack.length-1?null:(this._position++,this._notifyListeners(),structuredClone(this._stack[this._position]))}current(){return this._position<0?null:structuredClone(this._stack[this._position])}jumpTo(t){return t<0||t>=this._stack.length?null:(this._position=t,this._notifyListeners(),structuredClone(this._stack[this._position]))}getState(){return{canUndo:this._position>0,canRedo:this._position<this._stack.length-1,position:this._position,total:this._stack.length}}getTimeline(){return this._stack.map((t,e)=>({position:e,id:t.id}))}clear(){this._stack=[],this._position=-1,this._notifyListeners()}addListener(t){return this._listeners.push(t),()=>{this._listeners=this._listeners.filter(e=>e!==t)}}_notifyListeners(){let t=this.getState();for(let e of this._listeners)try{e(t)}catch{}}};function ar(s){if(!X(s))return s;let t=typeof s.manifest=="string"?s.manifest:"";if(!(/^0\.0(?:\.|$)/.test(t)||!t&&("version"in s||"manifestVersion"in s||"components"in s||"rootElement"in s||Gr(s.elements))))return s;let r={...s,manifest:"0.1.0"};if(delete r.version,delete r.manifestVersion,!r.elements&&X(r.components)&&(r.elements=r.components,delete r.components),!r.root&&typeof r.rootElement=="string"&&(r.root=r.rootElement,delete r.rootElement),X(r.elements)){let c={};for(let[n,a]of Object.entries(r.elements)){if(!X(a))continue;let u={...a};!u.type&&typeof u.component=="string"&&(u.type=u.component,delete u.component),c[n]=u}r.elements=c}return r}function Gr(s){return X(s)?Object.values(s).some(t=>X(t)&&"component"in t):!1}function X(s){return s!==null&&typeof s=="object"&&!Array.isArray(s)}import{html as ze,css as De,nothing as Yr}from"lit";import{LitElement as Jr}from"lit";var me=class me extends Jr{constructor(){super(...arguments);this._instanceId=`forge-${++me._instanceCounter}`;this.props={};this.store=null;this.onAction=null;this.itemContext=null}static get properties(){return{props:{type:Object}}}connectedCallback(){super.connectedCallback()}resolve(e){if(!this.store)return e;this.itemContext&&Y(this.itemContext);try{return I(this.store,e)}finally{Y(null)}}getProp(e){let o=this.props?.[e];return typeof o=="string"&&(o.startsWith("$state:")||o.startsWith("$computed:")||o.startsWith("$item:")||o.startsWith("$expr:")||o.includes("{{")&&o.includes("}}"))?this.resolve(o):o}getArray(e){let o=this.getProp(e);return Array.isArray(o)?o:o&&typeof o=="object"?Object.values(o):[]}getString(e,o=""){let i=this.getProp(e);return typeof i=="string"?i:String(i??o)}getNumber(e,o=0){let i=this.getProp(e);return typeof i=="number"?i:Number(i)||o}getBool(e,o=!1){let i=this.getProp(e);return typeof i=="boolean"?i:o}getBoundProp(e,o){let i=typeof this.props?.bind=="string"?this.props.bind:"";if(i){let c=this.resolve(i);if(c!==void 0)return c}let r=this.getProp(e);return r===void 0?o:r}dispatchAction(e,o){let i=typeof this.props?.bind=="string"?this.props.bind:"",r=i?{...o||{},bind:i}:o;this.onAction&&this.onAction(e,r),this.dispatchEvent(new CustomEvent("forgeui-action",{detail:{action:e,payload:r},bubbles:!0,composed:!0}))}handleAction(e){let o=this.getString("action");o&&this.dispatchAction(o,this.props)}prop(e){return this.getProp(e)}static get sharedStyles(){return[Ee]}gapValue(e){let o={none:"0",0:"0","3xs":"var(--forgeui-space-3xs)","2xs":"var(--forgeui-space-2xs)",xs:"var(--forgeui-space-xs)",sm:"var(--forgeui-space-sm)",md:"var(--forgeui-space-md)",lg:"var(--forgeui-space-lg)",xl:"var(--forgeui-space-xl)","2xl":"var(--forgeui-space-2xl)"};if(e==null||e==="")return"var(--forgeui-space-md)";let i=String(e);return i in o?o[i]:/^\d+(\.\d+)?$/.test(i)?`${i}px`:/^\d+(\.\d+)?(px|rem|em|%|vw|vh|ch)$/.test(i)?i:"var(--forgeui-space-md)"}static get styles(){return[Ee]}};me._instanceCounter=0;var g=me;var je=class extends g{static get styles(){return De`
  ...
  `}render(){let t=this.getString("label","Button"),e=this.getString("variant","primary"),o=this.getString("size",""),i=this.getBool("disabled"),r=this.getProp("pressed");return ze`<button class="${e} ${o}" ?disabled=${i}
      aria-pressed=${r==null?Yr:String(!!r)}
  ...
  `}render(){let t=this.getString("label",""),e=this.getString("href","#");return ze`<a href="${e}">${t}<slot></slot></a>`}};customElements.define("forgeui-link",Le);import{html as N,css as Q,nothing as nr}from"lit";var Oe=class extends g{static get properties(){return{props:{type:Object}}}static get styles(){return Q`
  ...
  `}render(){let t=this.getString("content",""),e=this.getString("variant","body"),i={h1:"heading1",h2:"heading2",h3:"heading3",title:"heading2",subtitle:"subheading",paragraph:"body",text:"body",secondary:"muted",tertiary:"caption"}[e]||e,r=this.getString("colorScheme",""),c=this.getString("align",""),n=this.getString("weight",""),a={primary:"var(--forgeui-color-primary)",secondary:"var(--forgeui-color-text-secondary)",tertiary:"var(--forgeui-color-text-tertiary)",success:"var(--forgeui-color-success)",warning:"var(--forgeui-color-warning)",error:"var(--forgeui-color-error)",info:"var(--forgeui-color-info)"},u={normal:"var(--forgeui-weight-normal)",medium:"var(--forgeui-weight-medium)",semibold:"var(--forgeui-weight-semibold)",bold:"var(--forgeui-weight-bold)"},l=[];r&&a[r]&&l.push(`color:${a[r]}`),n&&u[n]&&l.push(`font-weight:${u[n]}`);let d=c?`align-${c}`:"",p=N`${t}<slot></slot>`;return i==="heading1"?N`<h1 class="${i} ${d}" style="${l.join(";")}">${p}</h1>`:i==="heading2"?N`<h2 class="${i} ${d}" style="${l.join(";")}">${p}</h2>`:i==="heading3"?N`<h3 class="${i} ${d}" style="${l.join(";")}">${p}</h3>`:N`<div class="${i} ${d}" style="${l.join(";")}">${t}<slot></slot></div>`}};customElements.define("forgeui-text",Oe);var Ne=class extends g{static get styles(){return Q`
    :host { display:block; }
    img { max-width:100%; height:auto; display:block; border-radius:var(--forgeui-radius-md); }
  `}render(){let t=this.getString("src",""),e=this.getString("alt",""),o=this.getString("fit","contain");return t?N`<img src="${t}" alt="${e}" style="object-fit:${o}" loading="lazy">`:N`${nr}`}};customElements.define("forgeui-image",Ne);var Ue=class extends g{static get styles(){return Q`
    :host { display:inline-flex; align-items:center; justify-content:center; }
    svg { width:var(--forgeui-icon-md); height:var(--forgeui-icon-md); fill:currentColor; }
  `}render(){let t=this.getString("name","circle"),e={check:"M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z",x:"M6 18L18 6M6 6l12 12",plus:"M12 4v16m8-8H4",minus:"M20 12H4",chevron:"M9 5l7 7-7 7",arrow:"M13 7l5 5m0 0l-5 5m5-5H6",star:"M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.286 3.96a1 1 0 00.95.69h4.162c.969 0 1.371 1.24.588 1.81l-3.37 2.448a1 1 0 00-.364 1.118l1.287 3.96c.3.921-.755 1.688-1.54 1.118l-3.37-2.448a1 1 0 00-1.176 0l-3.37 2.448c-.784.57-1.838-.197-1.539-1.118l1.287-3.96a1 1 0 00-.364-1.118L2.063 8.387c-.783-.57-.38-1.81.588-1.81h4.162a1 1 0 00.95-.69l1.286-3.96z",circle:"M12 2a10 10 0 100 20 10 10 0 000-20z",alert:"M12 9v2m0 4h.01M4.93 4.93l14.14 14.14M12 2a10 10 0 100 20 10 10 0 000-20z"},o=e[t]||e.circle;return N`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="${o}"/></svg>`}};customElements.define("forgeui-icon",Ue);var Fe=class extends g{static get styles(){return Q`
  ...
  `}render(){let t=this.getString("text","")||this.getString("label",""),e=this.getString("variant","");return N`<span class="badge" variant="${e}">${t}<slot></slot></span>`}};customElements.define("forgeui-badge",Fe);var Be=class extends g{static get styles(){return Q`
    :host { display:inline-flex; }
  ...
  `}render(){let t=this.getString("src",""),e=this.getString("name","?"),o=e.split(" ").map(i=>i[0]).join("").toUpperCase().slice(0,2);return N`<div class="avatar">${t?N`<img src="${t}" alt="${e}">`:o}<slot></slot></div>`}};customElements.define("forgeui-avatar",Be);var Ve=class extends g{static get styles(){return Q`
  ...
  `}render(){let t=this.getString("title","Nothing here"),e=this.getString("description","");return N`
      <div class="title">${t}</div>
      ${e?N`<div class="desc">${e}</div>`:nr}
      <slot></slot>
    `}};customElements.define("forgeui-empty-state",Ve);import{html as h,css as G,svg as V,nothing as $}from"lit";var qe=class extends g{constructor(){super(...arguments);this._query="";this._sortKey="";this._sortDir="asc";this._page=0}static get styles(){return G`
  ...
  `}_colKey(e){return typeof e=="string"?e:String(e?.key??"")}_colLabel(e){return typeof e=="string"?e:String(e?.label??e?.key??"")}_statusClass(e){let o=String(e??"").toLowerCase().trim();return["done","complete","completed","success","active","ok","approved","paid"].includes(o)?"success":["in progress","in-progress","pending","warning","waiting","review"].includes(o)?"warning":["to do","to-do","todo","backlog","draft","new","inactive"].includes(o)?"neutral":["high","urgent","critical"].includes(o)?"error":["medium","med"].includes(o)?"warning":["low"].includes(o)?"info":["failed","error","rejected","blocked","overdue"].includes(o)?"error":"neutral"}_renderCell(e,o){let i=this._colKey(e),r=o[i],c=e&&typeof e=="object"?e.type:void 0;if(r==null||r==="")return h`<span style="color:var(--forgeui-color-text-tertiary)">—</span>`;if(c==="badge"||c==="status"){let n=(e.variant&&typeof e.variant=="object"?e.variant[String(r).toLowerCase()]:null)||this._statusClass(r);return h`<span class="badge ${n}">${String(r)}</span>`}if(c==="number")return typeof r=="number"?r.toLocaleString():String(r);if(c==="date"){let n=typeof r=="string"||typeof r=="number"?new Date(r):r;return n instanceof Date&&!isNaN(n.getTime())?n.toLocaleDateString():String(r)}if(c==="currency"){let n=Number(r);return isNaN(n)?String(r):n.toLocaleString(void 0,{style:"currency",currency:e.currency||"USD"})}return c==="boolean"?r?"\u2713":"\u2717":String(r)}_sortBy(e){e&&(this._sortKey===e?this._sortDir=this._sortDir==="asc"?"desc":"asc":(this._sortKey=e,this._sortDir="asc"),this._page=0,this.requestUpdate())}_setQuery(e){this._query=e,this._page=0,this.requestUpdate()}_filteredRows(e,o){let i=this._query.trim().toLowerCase();return i?e.filter(r=>o.some(c=>String(r[this._colKey(c)]??"").toLowerCase().includes(i))):e}_sortedRows(e){if(!this._sortKey)return e;let o=this._sortDir==="asc"?1:-1;return[...e].sort((i,r)=>{let c=i?.[this._sortKey],n=r?.[this._sortKey];if(typeof c=="number"&&typeof n=="number")return(c-n)*o;let a=String(c??"").toLowerCase(),u=String(n??"").toLowerCase();return(a>u?1:a<u?-1:0)*o})}_setPage(e,o){this._page=Math.max(0,Math.min(e,Math.max(0,o-1))),this.requestUpdate()}render(){let e=this.getProp("data"),o=this.getProp("columns")||[],i=this.getString("emptyMessage","No data yet"),r=this.getString("rowAction",""),c=this.getString("caption",""),n=this.getBool("searchable",!1),a=Math.max(0,Math.floor(this.getNumber("pageSize",0)));if(!Array.isArray(e))return h`<div class="empty">${i}</div>`;let u=o.length>0?o:e.length>0?Object.keys(e[0]):[];if(u.length===0)return h`<div class="empty">${i}</div>`;let l=this._filteredRows(e,u),d=this._sortedRows(l),p=a>0?Math.max(1,Math.ceil(d.length/a)):1,v=Math.min(this._page,p-1);v!==this._page&&(this._page=v);let R=a>0?d.slice(v*a,v*a+a):d;return h`
      ...
      `:$}
    `}};customElements.define("forgeui-table",qe);var Ke=class extends g{static get styles(){return G`
    :host { display:block; }
  ...
  `}render(){let t=this.getProp("data"),e=this.getString("dataPath","");!("data"in(this.props||{}))&&e&&this.store?.hasTable(e)&&(t=Object.values(this.store.getTable(e)));let o=this.getString("emptyMessage","No items");return!Array.isArray(t)||t.length===0?h`<div class="empty">${o}</div>`:h`<div class="list">${t.map((i,r)=>h`
      <div class="item" data-index=${r}><slot name="item" .item=${i} .index=${r}>${JSON.stringify(i)}</slot></div>
    `)}</div>`}};customElements.define("forgeui-list",Ke);var He=class extends g{constructor(){super(...arguments);this._palette=["var(--forgeui-color-primary)","var(--forgeui-color-success)","var(--forgeui-color-warning)","var(--forgeui-color-error)","var(--forgeui-color-info)","var(--forgeui-color-chart-6)","var(--forgeui-color-chart-7)","var(--forgeui-color-chart-8)","var(--forgeui-color-chart-9)","var(--forgeui-color-chart-10)"]}static get styles(){return G`
    :host { display:block; min-width:0; }
  ...
  `}_niceMax(e){if(e<=0)return 1;let o=Math.pow(10,Math.floor(Math.log10(e))),i=e/o;return(i<=1?1:i<=2?2:i<=5?5:10)*o}render(){let e=this.getString("chartType","bar"),o=this.getProp("data")||[],i=this.getString("title",""),r=this.getString("xKey","label")||this.getString("labelKey","label"),c=this.getString("yKey","value")||this.getString("valueKey","value"),n=this.getString("color","");if(!o||o.length===0)return h`
        ${i?h`<div class="title">${i}</div>`:$}
        <div class="empty">No data to display</div>
      `;let a=o.map(x=>typeof x=="number"?{label:"",value:x}:x&&typeof x=="object"?{label:String(x[r]??x.label??x.name??x.x??""),value:Number(x[c]??x.value??x.y??0)||0,color:x.color}:{label:String(x),value:0}),u=600,l=260,d={top:8,right:16,bottom:36,left:48},p=u-d.left-d.right,v=l-d.top-d.bottom,R,S=$;if(e==="pie"||e==="donut"){let x=a.reduce((z,M)=>z+Math.max(0,M.value),0)||1,C=u/2,A=l/2,E=Math.min(p,v)/2-8,_=e==="donut"?E*.55:0,P=-Math.PI/2,y=[],k=[];a.forEach((z,M)=>{let q=Math.max(0,z.value)/x,D=P,O=P+q*Math.PI*2;P=O;let te=O-D>Math.PI?1:0,de=C+E*Math.cos(D),Rt=A+E*Math.sin(D),Lt=C+E*Math.cos(O),zt=A+E*Math.sin(O),he=z.color||this._palette[M%this._palette.length];if(k.push(he),_>0){let lr=C+_*Math.cos(D),cr=A+_*Math.sin(D),ur=C+_*Math.cos(O),dr=A+_*Math.sin(O);y.push(V`<path class="slice" fill="${he}" d="M ${de} ${Rt} A ${E} ${E} 0 ${te} 1 ${Lt} ${zt} L ${ur} ${dr} A ${_} ${_} 0 ${te} 0 ${lr} ${cr} Z"/>`)}else y.push(V`<path class="slice" fill="${he}" d="M ${C} ${A} L ${de} ${Rt} A ${E} ${E} 0 ${te} 1 ${Lt} ${zt} Z"/>`)}),R=V`<g>${y}</g>`,S=h`<div class="legend">${a.map((z,M)=>h`
        <span class="legend-item"><span class="swatch" style="background:${k[M]}"></span>${z.label} (${z.value})</span>
      `)}</div>`}else{let x=Math.max(...a.map(P=>P.value),0),C=this._niceMax(x),A=P=>d.top+v-P/C*v,E=4,_=[];for(let P=0;P<=E;P++){let y=C*P/E,k=A(y);_.push(V`<line class="grid" x1="${d.left}" x2="${d.left+p}" y1="${k}" y2="${k}"/>`),_.push(V`<text class="tick-label" x="${d.left-6}" y="${k+3}" text-anchor="end">${y.toLocaleString()}</text>`)}if(e==="line"||e==="area"){let P=p/Math.max(1,a.length-1),y=a.map((M,q)=>{let D=d.left+q*P,O=A(M.value);return`${q===0?"M":"L"} ${D} ${O}`}).join(" "),k=e==="area"?y+` L ${d.left+p} ${d.top+v} L ${d.left} ${d.top+v} Z`:"",z=n||"var(--forgeui-color-primary)";R=h`
          <g>${_}</g>
          ${e==="area"?V`<path class="area" d="${k}" style="fill:${z};opacity:0.15"/>`:$}
          ${V`<path class="line" d="${y}" style="stroke:${z}"/>`}
          ${a.map((M,q)=>{let D=d.left+q*P,O=A(M.value);return V`<circle class="point" cx="${D}" cy="${O}" r="3" style="fill:${z}"/>
              <text class="tick-label" x="${D}" y="${d.top+v+14}" text-anchor="middle">${M.label}</text>`})}
        `}else{let P=a.length,y=p/P,k=Math.max(2,y*.7),z=y-k;R=h`
          <g>${_}</g>
          ${a.map((M,q)=>{let D=d.left+q*y+z/2,O=A(M.value),te=Math.max(0,d.top+v-O),de=M.color||n||"var(--forgeui-color-primary)";return V`<rect class="bar" x="${D}" y="${O}" width="${k}" height="${te}" rx="2" style="fill:${de}">
                <title>${M.label}: ${M.value}</title>
              </rect>
              <text class="tick-label" x="${D+k/2}" y="${d.top+v+14}" text-anchor="middle">${M.label}</text>`})}
        `}}return h`
      ${i?h`<div class="title">${i}</div>`:$}
      <div class="wrap">
    ...
    `}};customElements.define("forgeui-chart",He);var We=class extends g{constructor(){super(...arguments);this._palette=["var(--forgeui-color-primary)","var(--forgeui-color-success)","var(--forgeui-color-warning)","var(--forgeui-color-error)","var(--forgeui-color-info)","var(--forgeui-color-chart-6)","var(--forgeui-color-chart-7)","var(--forgeui-color-chart-8)","var(--forgeui-color-chart-9)","var(--forgeui-color-chart-10)"]}static get styles(){return G`
    :host { display:block; min-width:0; }
  ...
  `}_itemValue(e,o,i){if(e&&typeof e=="object"){let r=e;return String(r[o]??r[i]??"")}return String(e??"")}render(){let e=this.getString("title",""),o=this.getProp("items")??this.getProp("data")??[],i=this.getString("dataPath","");!("items"in(this.props||{}))&&!("data"in(this.props||{}))&&i&&this.store?.hasTable(i)&&(o=Object.values(this.store.getTable(i)));let r=Array.isArray(o)?o:[],c=this.getString("labelKey","label"),n=this.getString("valueKey","value"),a=this.getString("colorKey","color"),u=this.getString("orientation","")||this.getString("direction","horizontal"),l=this.getBool("showValues",!0),d=this.getString("emptyMessage","No legend items");return u==="vertical"?this.setAttribute("orientation","vertical"):this.removeAttribute("orientation"),h`
      ${e?h`<div class="title">${e}</div>`:$}
      ${r.length===0?h`<div class="empty">${d}</div>`:h`
        <ul aria-label=${e||"Chart legend"}>
          ${r.map((p,v)=>{let R=this._itemValue(p,c,"name"),S=this._itemValue(p,n,"value"),x=this._itemValue(p,a,"color")||this._palette[v%this._palette.length];return h`<li>
              <span class="swatch" style="background:${x}" aria-hidden="true"></span>
              <span class="label">${R||`Series ${v+1}`}</span>
              ${l&&S?h`<span class="value">${S}</span>`:$}
            </li>`})}
        </ul>
      `}
    `}};customElements.define("forgeui-chart-legend",We);var Ge=class extends g{static get styles(){return G`
    :host { display:block; min-width:0; }
  ...
  `}_trendClass(t){let e=String(t??"").toLowerCase();return e==="up"||e==="positive"||e.startsWith("+")?"up":e==="down"||e==="negative"||e.startsWith("-")?"down":"neutral"}render(){let t=this.getString("label",""),e=this.getProp("value"),o=this.getProp("trend"),i=this.getString("trendLabel",""),r=this.getString("subtitle",""),c=this.getString("unit",""),n=typeof e=="number"?e.toLocaleString():e==null||e===""?"\u2014":String(e),a=i||(o==null?"":String(o)),u=this._trendClass(o);return h`<div class="card">
      <div class="top">
        ${t?h`<div class="label">${t}</div>`:$}
        ${a?h`<span class="trend ${u}">${u==="up"?"\u2191":u==="down"?"\u2193":"\u2192"} ${a}</span>`:$}
      </div>
      <div class="value">${n}${c?h` <span class="meta">${c}</span>`:$}</div>
      ${r?h`<div class="meta">${r}</div>`:$}
    </div>`}};customElements.define("forgeui-stat-card",Ge);var Je=class extends g{static get styles(){return G`
    :host { display:grid; min-width:0; gap:var(--forgeui-space-md); grid-template-columns:repeat(auto-fit,minmax(min(12rem,100%),1fr)); }
  `}render(){let t=Math.max(0,Math.floor(this.getNumber("columns",0))),e=this.gapValue(this.getString("gap","md"));return this.style.gap=e,this.style.gridTemplateColumns=t>0?`repeat(${t}, minmax(0, 1fr))`:"",h`<slot></slot>`}};customElements.define("forgeui-kpi-grid",Je);var Ye=class extends g{static get styles(){return G`
  ...
  `}render(){let t=this.getNumber("width",400),e=this.getNumber("height",300),o=this.getString("background","transparent"),i=this.getProp("shapes")||[];return K`
    ...
    `}renderShape(t){let e={fill:t.fill??void 0,stroke:t.stroke??void 0,"stroke-width":t.strokeWidth??void 0,opacity:t.opacity??void 0},o=t.action?()=>{this.onAction&&this.onAction(t.action)}:void 0,i=t.action?"cursor:pointer":void 0;switch(t.type){case"rect":return K`<rect
        ...
        >${t.content??""}</text>`;case"path":return K`<path
          ...
          style="${i}"
          @click=${o}
        />`;default:return K``}}};customElements.define("forgeui-drawing",Ze);import{html as U,css as ne,nothing as H}from"lit";var Xe=class extends g{static get styles(){return ne`
  ...
  `}render(){let t=this.getString("variant","info"),e=this.getString("title",""),o=this.getString("message","");return U`<div class="alert ${t}" role=${t==="error"||t==="warning"?"alert":"status"}>
    ...
    </div>`}};customElements.define("forgeui-alert",Xe);var Qe=class extends g{constructor(){super(...arguments);this._priorFocus=null;this._keydownHandler=e=>this._onKeydown(e);this._close=()=>{this.dispatchAction("close")}}static get styles(){return ne`
    :host { display:none; }
  ...
  `}render(){let t=this.getProp("value"),e=this.getNumber("max",100),o=t==null,i=o?0:Math.max(0,Math.min(Number(t),e)),r=o?0:i/e*100,c=this.getString("label",""),n=this.getBool("showValue");return U`
    ...
    `}};customElements.define("forgeui-progress",et);var tt=class extends g{static get styles(){return ne`
  ...
  `}render(){let t=this.getString("message","");return t?U`<div class="toast">${t}</div>`:U`${H}`}};customElements.define("forgeui-toast",tt);var rt=class extends g{static get styles(){return ne`
    :host { display:block; }
  ...
  `}render(){let t=this.getString("msg","Unknown error");return U`<div class="error" role="alert">⚠ ${t}</div>`}};customElements.define("forgeui-error",rt);import{html as b,css as j,nothing as w}from"lit";var ot=class extends g{static get styles(){return j`
  ...
  `}render(){let t=this.getString("label",""),e=this.getString("placeholder",""),o=this.getString("hint",""),i=this.getString("error",""),r=this.getString("inputType","")||this.getString("type","text"),c=this.getBool("multiline"),n=String(this.getBoundProp("value","")??""),a=this._instanceId;return b`
      ...
      ${o&&!i?b`<div class="hint">${o}</div>`:w}
      ${i?b`<div class="error">${i}</div>`:w}
    `}};customElements.define("forgeui-text-input",ot);var it=class extends g{static get styles(){return j`
    :host { display:block; flex:1 1 auto; min-width:0; max-width:100%; margin-bottom:var(--forgeui-space-sm); }
    label { display:block; font-size:var(--forgeui-text-sm); font-weight:var(--forgeui-weight-medium); margin-bottom:var(--forgeui-space-2xs); color:var(--forgeui-color-text); overflow-wrap:break-word; }
  ...
  `}render(){let t=this.getString("label",""),e=this.getString("placeholder",""),o=this.getString("hint",""),i=this.getString("error",""),r=Math.max(1,Math.floor(this.getNumber("rows",4))),c=this.getProp("maxLength"),n=this.getBool("required"),a=this.getBool("disabled"),u=String(this.getBoundProp("value","")??""),l=this._instanceId;return b`
      ...
      ${o&&!i?b`<div class="hint">${o}</div>`:w}
      ${i?b`<div class="error">${i}</div>`:w}
    `}};customElements.define("forgeui-textarea",it);var st=class extends g{static get styles(){return j`
    :host { display:block; min-width:0; }
    form { display:flex; flex-direction:column; gap:var(--forgeui-space-md); min-width:0; }
  `}render(){let t=this.getString("action","");return b`<form @submit=${e=>{e.preventDefault();let o={submitted:!0};t&&this.dispatchAction(t,o),this.dispatchEvent(new CustomEvent("forgeui-submit",{detail:o,bubbles:!0,composed:!0}))}}><slot></slot></form>`}};customElements.define("forgeui-form",st);var at=class extends g{static get styles(){return j`
    :host { display:block; min-width:0; }
  ...
  `}render(){let t=this.getString("label",""),e=this.getString("description",""),o=this.getString("error","");return b`<fieldset>
      ${t?b`<legend>${t}</legend>`:w}
      ${e?b`<div class="description">${e}</div>`:w}
      <div class="body"><slot></slot></div>
      ${o?b`<div class="error">${o}</div>`:w}
    </fieldset>`}};customElements.define("forgeui-field-group",at);var nt=class extends g{static get styles(){return j`
    :host { display:block; flex:1 1 auto; min-width:0; max-width:100%; margin-bottom:var(--forgeui-space-sm); }
  ...
  `}render(){let t=this.getString("label",""),e=this.getProp("min"),o=this.getProp("max"),i=this.getProp("step"),r=this.getBoundProp("value"),c=this._instanceId;return b`
      ${t?b`<label for="${c}">${t}</label>`:w}
      <input id="${c}" type="number" min=${e} max=${o} step=${i} .value=${r??""}
        @input=${n=>this.dispatchAction("change",{value:Number(n.target.value)})}>
    `}};customElements.define("forgeui-number-input",nt);var lt=class extends g{static get styles(){return j`
    :host { display:block; flex:1 1 auto; min-width:0; max-width:100%; margin-bottom:var(--forgeui-space-sm); }
    label { display:block; font-size:var(--forgeui-text-sm); font-weight:var(--forgeui-weight-medium); margin-bottom:var(--forgeui-space-2xs); overflow-wrap:break-word; }
  ...
  `}render(){let t=this.getString("label",""),e=this.getProp("options")||[],o=String(this.getBoundProp("value","")??""),i=this._instanceId;return b`
    ...
    `}};customElements.define("forgeui-select",lt);var ct=class extends g{static get styles(){return j`
    :host { display:block; flex:1 1 auto; min-width:0; max-width:100%; margin-bottom:var(--forgeui-space-sm); }
    label { display:block; font-size:var(--forgeui-text-sm); font-weight:var(--forgeui-weight-medium); margin-bottom:var(--forgeui-space-2xs); overflow-wrap:break-word; }
    input { width:100%; padding:var(--forgeui-space-xs) var(--forgeui-space-sm); border:1px solid var(--forgeui-color-border);
      border-radius:var(--forgeui-radius-md); font:inherit; height:var(--forgeui-input-height);
  ...
  `}render(){let t=this.getString("label",""),e=this.getString("placeholder",""),o=this.getString("hint",""),i=this.getProp("options")||[],r=String(this.getBoundProp("value","")??""),c=this.getBool("disabled"),n=this.getBool("required"),a=this._instanceId,u=`${a}-list`;return b`
      ...
      ${o?b`<div class="hint">${o}</div>`:w}
    `}};customElements.define("forgeui-combobox",ct);var ut=class extends g{static get styles(){return j`
  ...
  `}render(){let t=this.getString("label",""),e=this.getProp("options")||[],o=this.getBoundProp("value",this.getProp("selected")??[]),i=Number(this.getProp("maxSelections")),r=Number.isFinite(i)&&i>=0?i:1/0,c=(Array.isArray(o)?o.map(l=>String(l)):[]).slice(0,r),n=this.getBool("disabled"),a=this._instanceId,u=l=>{let d=c.filter(p=>p!==l);this.dispatchAction("remove",{value:l}),this.dispatchAction("change",{value:d,selected:d})};return b`
    ...
    `}};customElements.define("forgeui-multi-select",ut);var dt=class extends g{static get styles(){return j`
    :host { display:block; margin-bottom:var(--forgeui-space-sm); }
  ...
  `}render(){let t=this.getString("label",""),e=this.getString("hint",""),o=this.getProp("options")||[],i=String(this.getBoundProp("value","")??""),r=this.getBool("disabled"),c=this._instanceId;return b`
      ...
      ${e?b`<div class="hint">${e}</div>`:w}
    `}};customElements.define("forgeui-radio-group",dt);var pt=class extends g{static get styles(){return j`
  ...
  `}render(){let t=this.getString("label",""),e=!!this.getBoundProp("checked",this.getProp("value")??!1),o=this._instanceId;return b`
      ...
      ${t?b`<label for="${o}">${t}</label>`:w}
    `}};customElements.define("forgeui-checkbox",pt);var gt=class extends g{constructor(){super(...arguments);this._toggle=()=>{if(this.getBool("disabled"))return;let e=!!this.getBoundProp("on",this.getProp("value")??!1);this.dispatchAction("change",{value:!e,checked:!e})};this._onKeydown=e=>{(e.key==="Enter"||e.key===" "||e.key==="Spacebar")&&(e.preventDefault(),this._toggle())}}static get styles(){return j`
  ...
  `}render(){let e=!!this.getBoundProp("on",this.getProp("value")??!1),o=this.getString("label",""),i=this.getBool("disabled"),r=this._instanceId;return b`
      <label for="${r}" class="toggle-label">
        ...
        ></button>
        ${o?b`<span class="toggle-text">${o}</span>`:w}
      </label>
    `}};customElements.define("forgeui-toggle",gt);var ft=class extends g{static get styles(){return j`
    :host { display:block; flex:1 1 auto; min-width:0; max-width:100%; margin-bottom:var(--forgeui-space-sm); }
    label { display:block; font-size:var(--forgeui-text-sm); font-weight:var(--forgeui-weight-medium); margin-bottom:var(--forgeui-space-2xs); overflow-wrap:break-word; }
    input { width:100%; padding:var(--forgeui-space-xs) var(--forgeui-space-sm); border:1px solid var(--forgeui-color-border);
      border-radius:var(--forgeui-radius-md); font:inherit; height:var(--forgeui-input-height);
  ...
  `}render(){let t=this.getString("label",""),e=this.getString("value",""),o=this._instanceId;return b`
    ...
    `}};customElements.define("forgeui-date-picker",ft);var mt=class extends g{static get styles(){return j`
    :host { display:block; flex:1 1 auto; min-width:0; max-width:100%; margin-bottom:var(--forgeui-space-sm); }
  ...
  `}render(){let t=this.getString("label",""),e=this.getBoundProp("value",this.getProp("value")),o=e&&typeof e=="object"&&!Array.isArray(e)?e:{},i=String(o.start??this.getProp("start")??""),r=String(o.end??this.getProp("end")??""),c=this.getString("min",""),n=this.getString("max",""),a=this.getBool("disabled"),u=this.getString("action","change"),l=`${this._instanceId}-start`,d=`${this._instanceId}-end`,p=v=>{this.dispatchAction(u,{value:v,start:v.start,end:v.end})};return b`
    ...
    `}};customElements.define("forgeui-date-range-picker",mt);var ht=class extends g{static get styles(){return j`
    :host { display:block; flex:1 1 auto; min-width:0; max-width:100%; margin-bottom:var(--forgeui-space-sm); }
    label { display:block; font-size:var(--forgeui-text-sm); font-weight:var(--forgeui-weight-medium); margin-bottom:var(--forgeui-space-2xs); overflow-wrap:break-word; }
  ...
  `}render(){let t=this.getString("label",""),e=this.getNumber("min",0),o=this.getNumber("max",100),i=this.getNumber("step",1),r=this.getBoundProp("value",e),c=Number(r);Number.isFinite(c)||(c=e);let n=this._instanceId;return b`
      ${t?b`<label for="${n}">${t}</label>`:w}
      <input id="${n}" type="range" min=${e} max=${o} step=${i} .value=${c}
        @input=${a=>this.dispatchAction("change",{value:Number(a.target.value)})}>
      <div class="value">${c}</div>
    `}};customElements.define("forgeui-slider",ht);var bt=class extends g{constructor(){super(...arguments);this._dragging=!1;this._openFilePicker=()=>{this.shadowRoot?.querySelector('input[type="file"]')?.click()};this._onDropzoneKeydown=e=>{e.key!=="Enter"&&e.key!==" "||(e.preventDefault(),this._openFilePicker())};this._onFileChange=e=>{let o=Array.from(e.target.files??[]);this._processFiles(o)};this._onDragOver=e=>{e.preventDefault(),!this._dragging&&(this._dragging=!0,this.requestUpdate())};this._onDragLeave=e=>{e.currentTarget===e.target&&(this._dragging=!1,this.requestUpdate())};this._onDrop=e=>{e.preventDefault(),this._dragging=!1,this.requestUpdate(),this._processFiles(Array.from(e.dataTransfer?.files??[]))}}static get styles(){return j`
    :host { display:block; margin-bottom:var(--forgeui-space-sm); }
  ...
  `}_maxSizeBytes(){let e=this.getProp("maxSize");if(typeof e=="number"&&Number.isFinite(e)&&e>=0)return Math.floor(e);if(typeof e!="string")return null;let o=e.trim().match(/^(\d+(?:\.\d+)?)\s*(b|kb|mb|gb)?$/i);if(!o)return null;let i=Number(o[1]),r=(o[2]||"b").toLowerCase(),c=r==="gb"?1<<30:r==="mb"?1<<20:r==="kb"?1024:1,n=i*c;return Number.isFinite(n)?Math.floor(n):null}_newFileId(){return globalThis.crypto?.randomUUID?.()??`${Date.now()}_${Math.random().toString(36).slice(2)}`}_processFiles(e){let o=this.getBool("multiple"),i=this._maxSizeBytes(),r=(o?e:e.slice(0,1)).map(d=>{let p=this._newFileId(),v=i==null||d.size<=i,R={id:p,name:d.name,size:d.size,type:d.type,lastModified:d.lastModified,accepted:v,storageKey:v?p:null};return v||(R.error="maxSize"),[d,R]}),c=r.filter(([,d])=>d.accepted),n=r.map(([,d])=>d),a=c.map(([,d])=>d),u=o?a:a[0]??null,l=a[0]??null;this.dispatchAction("change",{id:l?.id??null,uuid:l?.id??null,name:l?.name??null,size:l?.size??null,type:l?.type??null,lastModified:l?.lastModified??null,storageKey:l?.storageKey??null,value:u,files:n,rejected:n.filter(d=>!d.accepted),multiple:o,maxSize:i}),ir(c.map(([d,p])=>({file:d,id:p.id})))}render(){let e=this.getString("label","Upload file"),o=this.getString("accept","*"),i=this.getBool("multiple");return b`
    ...
    `}};customElements.define("forgeui-file-upload",bt);import{html as T,css as B,nothing as ee}from"lit";var yt=class extends g{static get styles(){return B`
    :host { display:block; min-width:0; }
  ...
  `}render(){let t=this.getString("title","Untitled"),e=this.getString("subtitle",""),o=this.getString("eyebrow",""),i=this.getString("meta",""),r=this.getString("density",""),c=this.getString("align","");return r?this.setAttribute("density",r):this.removeAttribute("density"),c?this.setAttribute("align",c):this.removeAttribute("align"),T`
    ...
    `}};customElements.define("forgeui-page-header",yt);var vt=class extends g{static get properties(){return{props:{type:Object}}}static get styles(){return B`
  ...
  `}render(){let t=this.getProp("columns"),e;typeof t=="number"?e=String(t):typeof t=="string"&&t?e=t:e="1";let o=/^\d+$/.test(e)?`repeat(${e}, minmax(0, 1fr))`:e,i=this.getString("gap","md"),r=this.gapValue(i),c=this.getString("padding",""),n=c?this.gapValue(c):"0";return this.style.gridTemplateColumns=o,this.style.gap=r,this.style.padding=n,/^\d+$/.test(e)&&Number(e)>=2&&this.setAttribute("responsive",""),T`<slot></slot>`}};customElements.define("forgeui-grid",xt);var wt=class extends g{static get properties(){return{props:{type:Object}}}static get styles(){return B`
  ...
  `}render(){let t=this.getString("variant",""),e=this.getString("title",""),o=this.getString("subtitle","");return t&&this.setAttribute("variant",t),T`
      ...
      `:ee}
      <div class="body"><slot></slot></div>
    `}};customElements.define("forgeui-card",wt);var $t=class extends g{static get properties(){return{props:{type:Object}}}static get styles(){return B`:host { display:block; margin-inline:auto; width:100%; box-sizing:border-box; }`}render(){let t=this.getString("maxWidth",""),e={sm:"640px",md:"768px",lg:"1024px",xl:"1280px","2xl":"1536px",full:"100%",none:"none","":""},o=t in e?e[t]:t,i=this.getString("padding","");return o&&o!=="none"?this.style.maxWidth=o:this.style.maxWidth="",this.style.padding=i?this.gapValue(i):"",T`<slot></slot>`}};customElements.define("forgeui-container",$t);var kt=class extends g{static get properties(){return{props:{type:Object}}}constructor(){super(),this._active=""}static get styles(){return B`
    :host { display:block; }
  ...
  `}_itemKey(t){return typeof t=="string"?t:String(t&&typeof t=="object"?t.id??t.key??t.value??t.label??"":t??"")}_itemLabel(t){return typeof t=="string"?t:String(t&&typeof t=="object"?t.label??t.title??t.value??"":t??"")}updated(){Array.from(this.children).filter(e=>!(e instanceof HTMLScriptElement)).forEach((e,o)=>{let i=(e.props||{}).slot??e.getAttribute("slot");String(o)===this._active||i===this._active?e.setAttribute("data-active",""):e.removeAttribute("data-active")})}_moveTo(t,e){let o=this._itemKey(e[t])||String(t);this._active=o,this.requestUpdate(),this.dispatchAction("tab-change",{active:o,value:o}),this.updateComplete.then(()=>{this.shadowRoot?.querySelector(`#${this._instanceId}-tab-${t}`)?.focus()})}render(){let t=this.getProp("items")||this.getProp("tabs")||[],e=Array.isArray(t)?t:[],o=this.getBoundProp("activeTab",this.getProp("value"));o!==void 0&&String(o)!==this._active&&(this._active=String(o)),!this._active&&e.length>0&&(this._active=this._itemKey(e[0])||"0");let i=e.findIndex((c,n)=>(this._itemKey(c)||String(n))===this._active),r=(c,n)=>{let a=-1;c.key==="ArrowRight"?a=(n+1)%e.length:c.key==="ArrowLeft"?a=(n-1+e.length)%e.length:c.key==="Home"?a=0:c.key==="End"&&(a=e.length-1),a!==-1&&(c.preventDefault(),this._moveTo(a,e))};return T`
    ...
    `}};customElements.define("forgeui-tabs",kt);var St=class extends g{static get properties(){return{props:{type:Object}}}static get styles(){return B`
    :host { display:block; }
  ...
  `}render(){let t=this.getString("title","Section");return T`<details><summary>${t}</summary><div class="content"><slot></slot></div></details>`}};customElements.define("forgeui-accordion",St);var _t=class extends g{static get styles(){return B`
    :host { display:block; }
    hr { border:none; border-top:1px solid var(--forgeui-color-border); margin:var(--forgeui-space-sm) 0; }
  `}render(){return T`<hr>`}};customElements.define("forgeui-divider",_t);var At=class extends g{static get styles(){return B`:host { display:block; }`}render(){let t=this.getString("size","md"),e=this.getString("height",""),o=this.getString("width",""),i=e?this.gapValue(e):this.gapValue(t),r=o?/^\d+(\.\d+)?%$/.test(o)?o:this.gapValue(o):"";return T`<div style="height:${i};${r?`width:${r}`:""}"></div>`}};customElements.define("forgeui-spacer",At);var Pt=class extends g{static get properties(){return{props:{type:Object}}}static get styles(){return B`
    :host { display:flex; flex-direction:column; gap:var(--forgeui-space-md); min-width:0; }
    :host([direction="row"]) { flex-direction:row; flex-wrap:wrap; }
    .empty { padding:var(--forgeui-space-lg); text-align:center; color:var(--forgeui-color-text-tertiary); font-size:var(--forgeui-text-sm); }
  `}render(){let t=this.getArray("data"),e=this.getString("emptyMessage",""),o=this.getString("direction","column");(o==="row"||o==="horizontal")&&this.setAttribute("direction","row");let i=this.getString("gap","md");return this.style.gap=this.gapValue(i),t.length===0&&e?T`<div class="empty">${e}</div>`:T`<slot></slot>`}};customElements.define("forgeui-repeater",Pt);import{html as F,css as le,nothing as Xr}from"lit";var Et=class extends g{static get styles(){return le`
  ...
  `}render(){let t=this.getProp("items")||[];return F`${t.map((e,o)=>{let i=o===t.length-1,r=typeof e=="string"?e:e.label,c=typeof e=="string"?"#":e.href;return F`
        ${o>0?F`<span class="sep">/</span>`:Xr}
        ${i?F`<span class="current">${r}</span>`:F`<a href="${c}">${r}</a>`}
      `})}`}};customElements.define("forgeui-breadcrumb",Et);var Tt=class extends g{static get styles(){return le`
  ...
  `}render(){let t=this.getProp("steps")||[],e=this.getBoundProp("active",this.getProp("activeStep")??0),o=Number(e)||0;return F`${t.map((i,r)=>{let c=typeof i=="string"?i:i.label||i.title||`Step ${r+1}`,n=r===o,a=r<o;return F`<div class="step" ?active=${n} ?completed=${a}>
      ...
      </div>`})}`}};customElements.define("forgeui-stepper",Tt);var It=class extends g{static get styles(){return le`
    :host { display:block; min-width:0; }
  ...
  `}render(){let t=this.getString("label","Search"),e=this.getString("placeholder","Search"),o=String(this.getBoundProp("value","")??""),i=this.getBool("disabled"),r=this.getString("action","change"),c=this._instanceId;return F`<div class="field">
    ...
    </div>`}};customElements.define("forgeui-search-box",It);var Ct=class extends g{static get styles(){return le`
  ...
  `}render(){let t=this.getArray("options"),e=String(this.getBoundProp("value",this.getProp("value")??this._optionValue(t[0]))??""),o=this.getBool("disabled"),i=this.getString("action","change");return F`
    ...
    `}_optionValue(t){if(t&&typeof t=="object"){let e=t;return String(e.value??e.label??"")}return String(t??"")}_optionLabel(t,e){if(t&&typeof t=="object"){let o=t;return String(o.label??o.value??e)}return e}};customElements.define("forgeui-segmented-control",Ct);var Mt=class extends g{static get styles(){return le`
