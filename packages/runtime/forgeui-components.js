import{html as u,css as m,svg as v,nothing as p}from"lit";import{LitElement as nt}from"lit";import{createStore as pt}from"tinybase";var et=new Set(["__proto__","prototype","constructor"]);function T(n){if(n.length===0||n.length>256)return!1;for(let t of n.normalize("NFC").split("."))if(et.has(t))return!1;return!0}function U(n,t){if(t.includes("/")){let e=t.split("/");if(e.length===3){let[r,o,i]=e;return n.getCell(r,o,i)}if(e.length===2){let[r,o]=e,i=n.getValue(t);if(i!==void 0)return i;let s=n.getCellIds(r,o);if(s.length>0){let a={};for(let l of s)a[l]=n.getCell(r,o,l);return a}}}return n.getValue(t)}function tt(n,t){if(t.startsWith("count:")){let e=t.slice(6);return n.getRowCount(e)}if(t.startsWith("sum:")){let[e,r]=t.split(":"),[o,i]=r.split("/"),s=0,a=n.getRowIds(o);for(let l of a){let d=n.getCell(o,l,i);typeof d=="number"&&(s+=d)}return s}if(t.startsWith("avg:")){let[e,r]=t.split(":"),[o,i]=r.split("/"),s=0,a=0,l=n.getRowIds(o);for(let d of l){let g=n.getCell(o,d,i);typeof g=="number"&&(s+=g,a++)}return a>0?s/a:0}return U(n,t)}var W=null;function q(n){W=n}function rt(n,t){if(t.length>1024)return;let e="(state\\.[a-zA-Z_][a-zA-Z0-9_.]*|-?\\d+(?:\\.\\d+)?)",r=t.trim().match(new RegExp(`^${e}\\s*(>=|<=|[+\\-*/><])\\s*${e}$`));if(!r)return;let o=He(n,r[1]),i=He(n,r[3]);if(!(typeof o!="number"||typeof i!="number"))switch(r[2]){case"+":return o+i;case"-":return o-i;case"*":return o*i;case"/":return i===0?void 0:o/i;case">":return o>i;case"<":return o<i;case">=":return o>=i;case"<=":return o<=i}}function He(n,t){if(/^-?\d/.test(t))return Number(t);if(!t.startsWith("state."))return;let e=t.slice(6);return T(e)?Fe(n,e):void 0}function J(n,t){let e=t.trim();if(e==="")return;if(e.startsWith('"')&&e.endsWith('"')||e.startsWith("'")&&e.endsWith("'"))return e.slice(1,-1);if(e.startsWith('"')&&!e.endsWith('"')||e.startsWith("'")&&!e.endsWith("'"))return;if(e==="true")return!0;if(e==="false")return!1;if(e==="null")return null;if(/^-?\d+(\.\d+)?$/.test(e))return Number(e);if(/(?:[+\-*/%]|===?|!==?|>=?|<=?|\&\&|\|\|)/.test(e)&&!e.includes("|"))return rt(n,e);if(e.includes("|")){let[o,...i]=e.split("|").map(l=>l.trim()),a=J(n,o);for(let l of i){let[d,...g]=l.split(/\s+/);a=ot(a,d,g)}return a}if(e.startsWith("item.")||e==="item"){if(e==="item")return W;let o=e.slice(5);return N(W,o)}if(e.startsWith("state.")||e==="state"){if(e==="state")return;let o=e.slice(6);return Fe(n,o)}return U(n,e)}function ot(n,t,e){switch(t){case"values":return Array.isArray(n)?n:n&&typeof n=="object"?Object.values(n):[];case"keys":return n&&typeof n=="object"?Object.keys(n):[];case"count":case"length":return Array.isArray(n)?n.length:n&&typeof n=="object"?Object.keys(n).length:typeof n=="string"?n.length:0;case"sum":return Array.isArray(n)?n.reduce((r,o)=>r+(typeof o=="number"?o:0),0):0;case"first":return Array.isArray(n)?n[0]:void 0;case"last":return Array.isArray(n)?n[n.length-1]:void 0;default:return n}}function N(n,t){if(!n||typeof n!="object"||!t||!T(t))return;let e=t.split(".");if(e.length>32)return;let r=n;for(let o of e){if(r==null)return;r=r[o]}return r}function Fe(n,t){if(!T(t))return;let e=n.getValue(t);if(e!==void 0){if(typeof e=="string")try{return JSON.parse(e)}catch{}return e}let r=t.split(".");if(r.length>=3){let[i,s,a,...l]=r;if(n.hasTable(i)&&n.hasRow(i,s)){let d=n.getCell(i,s,a);if(l.length===0)return d;if(typeof d=="string")try{let g=JSON.parse(d);return N(g,l.join("."))}catch{}return}}if(r.length>=2){let[i,s,...a]=r;if(n.hasTable(i)&&n.hasRow(i,s)){let l=n.getRow(i,s);return a.length===0?l:N(l,a.join("."))}}if(r.length>=1){let[i,...s]=r;if(n.hasTable(i)){let a=n.getRowIds(i),l={};for(let d of a)l[d]=n.getRow(i,d);return s.length===0?l:N(l,s.join("."))}}let o=n.getValue(r[0]);if(typeof o=="string"&&r.length>1)try{let i=JSON.parse(o);return N(i,r.slice(1).join("."))}catch{}}function D(n,t){if(typeof t!="string"){if(t!==null&&typeof t=="object"){let e=t;if("$expr"in e)return D(n,`$expr:${e.$expr}`);if("$state"in e)return D(n,`$state:${e.$state}`);if("$computed"in e)return D(n,`$computed:${e.$computed}`);if("$item"in e)return D(n,`$item:${e.$item}`)}return t}if(t.startsWith("$state:")){let e=t.slice(7);return T(e)?U(n,e):void 0}if(t.startsWith("$computed:")){let e=t.slice(10);return e.length>1024?void 0:tt(n,e)}if(t.startsWith("$item:")){let e=t.slice(6);return T(e)?e.includes(".")?N(W,e):W?.[e]:void 0}if(t.startsWith("$expr:")){let e=t.slice(6);return e.length>1024?void 0:J(n,e)}return t.length>4096?t:t.includes("{{")&&t.includes("}}")?it(t,n):t}function it(n,t){let e="",r=0;for(;r<n.length;)if(n[r]==="{"&&n[r+1]==="{"){let o=r+2,i=1,s=o;for(;s<n.length-1&&i>0;){let a=n[s],l=n[s+1];a==="{"&&l==="{"?(i++,s+=2):a==="}"&&l==="}"?(i--,s+=2):s++}if(i)e+=n[r++];else{let a=n.slice(o,s-2);if(a.length<=256){let l=a.trim(),d=l.startsWith("$")?D(t,l):J(t,l);e+=d==null?"":String(d)}else e+=n.slice(r,s);r=s}}else e+=n[r++];return e}import{css as Z}from"lit";var wt=Z`
  @layer tokens {
    :host {
...
`;var H=class H extends nt{constructor(){super(...arguments);this._instanceId=`forge-${++H._instanceCounter}`;this.props={};this.store=null;this.onAction=null;this.itemContext=null}static get properties(){return{props:{type:Object}}}connectedCallback(){super.connectedCallback()}resolve(e){if(!this.store)return e;this.itemContext&&q(this.itemContext);try{return D(this.store,e)}finally{q(null)}}getProp(e){let r=this.props?.[e];return typeof r=="string"&&(r.startsWith("$state:")||r.startsWith("$computed:")||r.startsWith("$item:")||r.startsWith("$expr:")||r.includes("{{")&&r.includes("}}"))?this.resolve(r):r}getArray(e){let r=this.getProp(e);return Array.isArray(r)?r:r&&typeof r=="object"?Object.values(r):[]}getString(e,r=""){let o=this.getProp(e);return typeof o=="string"?o:String(o??r)}getNumber(e,r=0){let o=this.getProp(e);return typeof o=="number"?o:Number(o)||r}getBool(e,r=!1){let o=this.getProp(e);return typeof o=="boolean"?o:r}getBoundProp(e,r){let o=typeof this.props?.bind=="string"?this.props.bind:"";if(o){let s=this.resolve(o);if(s!==void 0)return s}let i=this.getProp(e);return i===void 0?r:i}dispatchAction(e,r){let o=typeof this.props?.bind=="string"?this.props.bind:"",i=o?{...r||{},bind:o}:r;this.onAction&&this.onAction(e,i),this.dispatchEvent(new CustomEvent("forgeui-action",{detail:{action:e,payload:i},bubbles:!0,composed:!0}))}handleAction(e){let r=this.getString("action");r&&this.dispatchAction(r,this.props)}prop(e){return this.getProp(e)}static get sharedStyles(){return[X]}gapValue(e){let r={none:"0",0:"0","3xs":"var(--forgeui-space-3xs)","2xs":"var(--forgeui-space-2xs)",xs:"var(--forgeui-space-xs)",sm:"var(--forgeui-space-sm)",md:"var(--forgeui-space-md)",lg:"var(--forgeui-space-lg)",xl:"var(--forgeui-space-xl)","2xl":"var(--forgeui-space-2xl)"};if(e==null||e==="")return"var(--forgeui-space-md)";let o=String(e);return o in r?r[o]:/^\d+(\.\d+)?$/.test(o)?`${o}px`:/^\d+(\.\d+)?(px|rem|em|%|vw|vh|ch)$/.test(o)?o:"var(--forgeui-space-md)"}static get styles(){return[X]}};H._instanceCounter=0;var f=H;function st(n){return`forgeui_${(n||"global").replace(/[^a-zA-Z0-9-]/g,"_")}`}var Y="f";function at(n){return new Promise((t,e)=>{let r=i=>e(i??new Error("IDB"));if(!globalThis.indexedDB)return r();let o=indexedDB.open(`${st(n)}_f`,1);o.onupgradeneeded=()=>{o.result.createObjectStore(Y)},o.onsuccess=()=>t(o.result),o.onerror=o.onblocked=()=>r(o.error)})}async function Ue(n,t){if(n.length===0)return;let e=null;try{e=await at(t),await new Promise((r,o)=>{let i=e.transaction(Y,"readwrite"),s=i.objectStore(Y);for(let{file:a,id:l}of n)s.put(a,l);i.oncomplete=()=>r(),i.onerror=i.onabort=()=>o(i.error)})}catch{return}finally{e?.close()}}import{html as te,css as re,nothing as lt}from"lit";var G=class extends f{static get styles(){return re`
  ...
  `}render(){let t=this.getString("label","Button"),e=this.getString("variant","primary"),r=this.getString("size",""),o=this.getBool("disabled"),i=this.getProp("pressed");return te`<button class="${e} ${r}" ?disabled=${o}
      ...
      @click=${s=>this.handleAction(s)}>${t}<slot></slot></button>`}};customElements.define("forgeui-button",G);var Q=class extends f{static get styles(){return re`
    :host { display:flex; gap:var(--forgeui-space-xs); }
  `}render(){return te`<slot></slot>`}};customElements.define("forgeui-button-group",Q);var ee=class extends f{static get styles(){return re`
    :host { display:inline-flex; }
  ...
  `}render(){let t=this.getString("label",""),e=this.getString("href","#");return te`<a href="${e}">${t}<slot></slot></a>`}};customElements.define("forgeui-link",ee);import{html as E,css as B,nothing as qe}from"lit";var oe=class extends f{static get properties(){return{props:{type:Object}}}static get styles(){return B`
  ...
  `}render(){let t=this.getString("text","")||this.getString("label",""),e=this.getString("variant","");return E`<span class="badge" variant="${e}">${t}<slot></slot></span>`}};customElements.define("forgeui-badge",se);var ae=class extends f{static get styles(){return B`
    :host { display:inline-flex; }
  ...
  `}render(){let t=this.getString("src",""),e=this.getString("name","?"),r=e.split(" ").map(o=>o[0]).join("").toUpperCase().slice(0,2);return E`<div class="avatar">${t?E`<img src="${t}" alt="${e}">`:r}<slot></slot></div>`}};customElements.define("forgeui-avatar",ae);var le=class extends f{static get styles(){return B`
  ...
  `}render(){let t=this.getString("title","Nothing here"),e=this.getString("description","");return E`
      ...
      <slot></slot>
    `}};customElements.define("forgeui-empty-state",le);import{html as w,css as C,nothing as ce}from"lit";var ue=class extends f{static get properties(){return{props:{type:Object}}}static get styles(){return C`
  ...
  `}render(){let t=this.getString("direction","column"),e=t==="horizontal"||t==="row"?"row":"column",r=this.getString("gap","")||this.getString("spacing","md"),o=this.getString("padding",""),i=this.getString("align",""),s=this.getString("justify",""),a=this.getBool("wrap"),l=this.gapValue(r),d=o?this.gapValue(o):"0";return this.setAttribute("direction",e),i&&this.setAttribute("align",i),s&&this.setAttribute("justify",s),a&&this.setAttribute("wrap",""),this.style.gap=l,this.style.padding=d,w`<slot></slot>`}};customElements.define("forgeui-stack",ue);var ge=class extends f{static get properties(){return{props:{type:Object}}}static get styles(){return C`
  ...
  `}render(){let t=this.getString("variant",""),e=this.getString("title",""),r=this.getString("subtitle","");return t&&this.setAttribute("variant",t),w`
    ...
    `}};customElements.define("forgeui-card",de);var fe=class extends f{static get properties(){return{props:{type:Object}}}static get styles(){return C`:host { display:block; margin-inline:auto; width:100%; box-sizing:border-box; }`}render(){let t=this.getString("maxWidth",""),e={sm:"640px",md:"768px",lg:"1024px",xl:"1280px","2xl":"1536px",full:"100%",none:"none","":""},r=t in e?e[t]:t,o=this.getString("padding","");return r&&r!=="none"?this.style.maxWidth=r:this.style.maxWidth="",this.style.padding=o?this.gapValue(o):"",w`<slot></slot>`}};customElements.define("forgeui-container",fe);var pe=class extends f{static get properties(){return{props:{type:Object}}}constructor(){super(),this._active=""}static get styles(){return C`
    :host { display:block; }
  ...
  `}_itemKey(t){return typeof t=="string"?t:String(t&&typeof t=="object"?t.id??t.key??t.value??t.label??"":t??"")}_itemLabel(t){return typeof t=="string"?t:String(t&&typeof t=="object"?t.label??t.title??t.value??"":t??"")}updated(){Array.from(this.children).filter(e=>!(e instanceof HTMLScriptElement)).forEach((e,r)=>{let o=(e.props||{}).slot??e.getAttribute("slot");String(r)===this._active||o===this._active?e.setAttribute("data-active",""):e.removeAttribute("data-active")})}_moveTo(t,e){let r=this._itemKey(e[t])||String(t);this._active=r,this.requestUpdate(),this.dispatchAction("tab-change",{active:r,value:r}),this.updateComplete.then(()=>{this.shadowRoot?.querySelector(`#${this._instanceId}-tab-${t}`)?.focus()})}render(){let t=this.getProp("items")||this.getProp("tabs")||[],e=Array.isArray(t)?t:[],r=this.getBoundProp("activeTab",this.getProp("value"));r!==void 0&&String(r)!==this._active&&(this._active=String(r)),!this._active&&e.length>0&&(this._active=this._itemKey(e[0])||"0");let o=e.findIndex((s,a)=>(this._itemKey(s)||String(a))===this._active),i=(s,a)=>{let l=-1;s.key==="ArrowRight"?l=(a+1)%e.length:s.key==="ArrowLeft"?l=(a-1+e.length)%e.length:s.key==="Home"?l=0:s.key==="End"&&(l=e.length-1),l!==-1&&(s.preventDefault(),this._moveTo(l,e))};return w`
      <div class="tabs" role="tablist">${e.map((s,a)=>{let l=this._itemKey(s)||String(a),d=this._itemLabel(s)||String(a+1),g=l===this._active;return w`
          <button class="tab" ?active=${g} role="tab" aria-selected=${g}
            ...
            @keydown=${c=>i(c,a)}>${d}</button>
        `})}</div>
      <div class="panel" role="tabpanel" id="${this._instanceId}-panel"
        aria-labelledby="${this._instanceId}-tab-${o>=0?o:0}"><slot></slot></div>
    `}};customElements.define("forgeui-tabs",pe);var he=class extends f{static get properties(){return{props:{type:Object}}}static get styles(){return C`
    :host { display:block; }
  ...
  `}render(){let t=this.getString("title","Section");return w`<details><summary>${t}</summary><div class="content"><slot></slot></div></details>`}};customElements.define("forgeui-accordion",he);var me=class extends f{static get styles(){return C`
    :host { display:block; }
    hr { border:none; border-top:1px solid var(--forgeui-color-border); margin:var(--forgeui-space-sm) 0; }
  `}render(){return w`<hr>`}};customElements.define("forgeui-divider",me);var be=class extends f{static get styles(){return C`:host { display:block; }`}render(){let t=this.getString("size","md"),e=this.getString("height",""),r=this.getString("width",""),o=e?this.gapValue(e):this.gapValue(t),i=r?/^\d+(\.\d+)?%$/.test(r)?r:this.gapValue(r):"";return w`<div style="height:${o};${i?`width:${i}`:""}"></div>`}};customElements.define("forgeui-spacer",be);var ve=class extends f{static get properties(){return{props:{type:Object}}}static get styles(){return C`
  ...
  `}render(){let t=this.getArray("data"),e=this.getString("emptyMessage",""),r=this.getString("direction","column");(r==="row"||r==="horizontal")&&this.setAttribute("direction","row");let o=this.getString("gap","md");return this.style.gap=this.gapValue(o),t.length===0&&e?w`<div class="empty">${e}</div>`:w`<slot></slot>`}};customElements.define("forgeui-repeater",ve);import{html as O,css as Je,nothing as ct}from"lit";var ye=class extends f{static get styles(){return Je`
  ...
  `}render(){let t=this.getProp("items")||[];return O`${t.map((e,r)=>{let o=r===t.length-1,i=typeof e=="string"?e:e.label,s=typeof e=="string"?"#":e.href;return O`
      ...
      `})}`}};customElements.define("forgeui-breadcrumb",ye);var xe=class extends f{static get styles(){return Je`
  ...
  `}render(){let t=this.getProp("steps")||[],e=this.getBoundProp("active",this.getProp("activeStep")??0),r=Number(e)||0;return O`${t.map((o,i)=>{let s=typeof o=="string"?o:o.label||o.title||`Step ${i+1}`,a=i===r,l=i<r;return O`<div class="step" ?active=${a} ?completed=${l}>
      ...
      </div>`})}`}};customElements.define("forgeui-stepper",xe);var we=class extends f{static get styles(){return m`
  ...
  `}render(){let t=this.getString("label",""),e=this.getString("placeholder",""),r=this.getString("hint",""),o=this.getString("error",""),i=this.getString("inputType","")||this.getString("type","text"),s=this.getBool("multiline"),a=String(this.getBoundProp("value","")??""),l=this._instanceId;return u`
      ${t?u`<label for="${l}">${t}</label>`:p}
      ${s?u`<textarea id="${l}" placeholder="${e}" .value=${a} @input=${d=>this.dispatchAction("change",{value:d.target.value})}></textarea>`:u`<input id="${l}" type="${i}" placeholder="${e}" .value=${a} @input=${d=>this.dispatchAction("change",{value:d.target.value})}>`}
      ${r&&!o?u`<div class="hint">${r}</div>`:p}
      ${o?u`<div class="error">${o}</div>`:p}
    `}};customElements.define("forgeui-text-input",we);var $e=class extends f{static get styles(){return m`
    :host { display:block; flex:1 1 auto; min-width:0; max-width:100%; margin-bottom:var(--forgeui-space-sm); }
  ...
  `}render(){let t=this.getString("label",""),e=this.getProp("min"),r=this.getProp("max"),o=this.getProp("step"),i=this.getBoundProp("value"),s=this._instanceId;return u`
      ${t?u`<label for="${s}">${t}</label>`:p}
      <input id="${s}" type="number" min=${e} max=${r} step=${o} .value=${i??""}
        @input=${a=>this.dispatchAction("change",{value:Number(a.target.value)})}>
    `}};customElements.define("forgeui-number-input",$e);var ke=class extends f{static get styles(){return m`
    :host { display:block; flex:1 1 auto; min-width:0; max-width:100%; margin-bottom:var(--forgeui-space-sm); }
    label { display:block; font-size:var(--forgeui-text-sm); font-weight:var(--forgeui-weight-medium); margin-bottom:var(--forgeui-space-2xs); overflow-wrap:break-word; }
  ...
  `}render(){let t=this.getString("label",""),e=this.getProp("options")||[],r=String(this.getBoundProp("value","")??""),o=this._instanceId;return u`
      ${t?u`<label for="${o}">${t}</label>`:p}
      <select id="${o}" .value=${r} @change=${i=>this.dispatchAction("change",{value:i.target.value})}>
        ${e.map(i=>u`<option value=${typeof i=="string"?i:i.value} ?selected=${(typeof i=="string"?i:i.value)===r}>
          ${typeof i=="string"?i:i.label||i.value}
        </option>`)}
      </select>
    `}};customElements.define("forgeui-select",ke);var Se=class extends f{static get styles(){return m`
  ...
  `}render(){let t=this.getString("label",""),e=this.getProp("options")||[],r=this.getBoundProp("value",this.getProp("selected")??[]),o=Number(this.getProp("maxSelections")),i=Number.isFinite(o)&&o>=0?o:1/0,s=(Array.isArray(r)?r.map(g=>String(g)):[]).slice(0,i),a=this.getBool("disabled"),l=this._instanceId,d=g=>{let c=s.filter(h=>h!==g);this.dispatchAction("remove",{value:g}),this.dispatchAction("change",{value:c,selected:c})};return u`
      ${t?u`<label for="${l}">${t}</label>`:p}
      <select id="${l}" multiple ?disabled=${a}
        ...
        ${e.map(g=>{let c=String(typeof g=="string"?g:g?.value??g?.label??"");return u`<option value=${c} ?selected=${s.includes(c)}>
            ${typeof g=="string"?g:g?.label??c}
          </option>`})}
      </select>
      <div class="tags">
        ${s.map(g=>u`<span class="tag">${g}<button type="button" aria-label=${`Remove ${g}`} @click=${()=>d(g)}>×</button></span>`)}
        <slot></slot>
      </div>
    `}};customElements.define("forgeui-multi-select",Se);var _e=class extends f{static get styles(){return m`
  ...
  `}render(){let t=this.getString("label",""),e=!!this.getBoundProp("checked",this.getProp("value")??!1),r=this._instanceId;return u`
      <input id="${r}" type="checkbox" ?checked=${e} @change=${o=>this.dispatchAction("change",{checked:o.target.checked})}>
      ${t?u`<label for="${r}">${t}</label>`:p}
    `}};customElements.define("forgeui-checkbox",_e);var ze=class extends f{constructor(){super(...arguments);this._toggle=()=>{if(this.getBool("disabled"))return;let e=!!this.getBoundProp("on",this.getProp("value")??!1);this.dispatchAction("change",{value:!e,checked:!e})};this._onKeydown=e=>{(e.key==="Enter"||e.key===" "||e.key==="Spacebar")&&(e.preventDefault(),this._toggle())}}static get styles(){return m`
  ...
  `}render(){let e=!!this.getBoundProp("on",this.getProp("value")??!1),r=this.getString("label",""),o=this.getBool("disabled"),i=this._instanceId;return u`
      <label for="${i}" class="toggle-label">
        ...
        ></button>
        ${r?u`<span class="toggle-text">${r}</span>`:p}
      </label>
    `}};customElements.define("forgeui-toggle",ze);var Ee=class extends f{static get styles(){return m`
    :host { display:block; flex:1 1 auto; min-width:0; max-width:100%; margin-bottom:var(--forgeui-space-sm); }
    label { display:block; font-size:var(--forgeui-text-sm); font-weight:var(--forgeui-weight-medium); margin-bottom:var(--forgeui-space-2xs); overflow-wrap:break-word; }
    input { width:100%; padding:var(--forgeui-space-xs) var(--forgeui-space-sm); border:1px solid var(--forgeui-color-border);
      border-radius:var(--forgeui-radius-md); font:inherit; height:var(--forgeui-input-height);
      background:var(--forgeui-color-surface); color:var(--forgeui-color-text); box-sizing:border-box; min-width:0; }
    input:focus { outline:none; border-color:var(--forgeui-color-primary); box-shadow:0 0 0 3px var(--forgeui-color-primary-subtle); }
  `}render(){let t=this.getString("label",""),e=this.getString("value",""),r=this._instanceId;return u`
      ${t?u`<label for="${r}">${t}</label>`:p}
      <input id="${r}" type="date" .value=${e} @change=${o=>this.dispatchAction("change",{value:o.target.value})}>
    `}};customElements.define("forgeui-date-picker",Ee);var Me=class extends f{static get styles(){return m`
    :host { display:block; flex:1 1 auto; min-width:0; max-width:100%; margin-bottom:var(--forgeui-space-sm); }
    label { display:block; font-size:var(--forgeui-text-sm); font-weight:var(--forgeui-weight-medium); margin-bottom:var(--forgeui-space-2xs); overflow-wrap:break-word; }
  ...
  `}render(){let t=this.getString("label",""),e=this.getNumber("min",0),r=this.getNumber("max",100),o=this.getNumber("step",1),i=this.getBoundProp("value",e),s=Number(i);Number.isFinite(s)||(s=e);let a=this._instanceId;return u`
      ${t?u`<label for="${a}">${t}</label>`:p}
      <input id="${a}" type="range" min=${e} max=${r} step=${o} .value=${s}
        @input=${l=>this.dispatchAction("change",{value:Number(l.target.value)})}>
      <div class="value">${s}</div>
    `}};customElements.define("forgeui-slider",Me);var Ae=class extends f{constructor(){super(...arguments);this._dragging=!1;this._openFilePicker=()=>{this.shadowRoot?.querySelector('input[type="file"]')?.click()};this._onDropzoneKeydown=e=>{e.key!=="Enter"&&e.key!==" "||(e.preventDefault(),this._openFilePicker())};this._onFileChange=e=>{let r=Array.from(e.target.files??[]);this._processFiles(r)};this._onDragOver=e=>{e.preventDefault(),!this._dragging&&(this._dragging=!0,this.requestUpdate())};this._onDragLeave=e=>{e.currentTarget===e.target&&(this._dragging=!1,this.requestUpdate())};this._onDrop=e=>{e.preventDefault(),this._dragging=!1,this.requestUpdate(),this._processFiles(Array.from(e.dataTransfer?.files??[]))}}static get styles(){return m`
  ...
  `}_maxSizeBytes(){let e=this.getProp("maxSize");if(typeof e=="number"&&Number.isFinite(e)&&e>=0)return Math.floor(e);if(typeof e!="string")return null;let r=e.trim().match(/^(\d+(?:\.\d+)?)\s*(b|kb|mb|gb)?$/i);if(!r)return null;let o=Number(r[1]),i=(r[2]||"b").toLowerCase(),s=i==="gb"?1<<30:i==="mb"?1<<20:i==="kb"?1024:1,a=o*s;return Number.isFinite(a)?Math.floor(a):null}_newFileId(){return globalThis.crypto?.randomUUID?.()??`${Date.now()}_${Math.random().toString(36).slice(2)}`}_processFiles(e){let r=this.getBool("multiple"),o=this._maxSizeBytes(),i=(r?e:e.slice(0,1)).map(c=>{let h=this._newFileId(),$=o==null||c.size<=o,R={id:h,name:c.name,size:c.size,type:c.type,lastModified:c.lastModified,accepted:$,storageKey:$?h:null};return $||(R.error="maxSize"),[c,R]}),s=i.filter(([,c])=>c.accepted),a=i.map(([,c])=>c),l=s.map(([,c])=>c),d=r?l:l[0]??null,g=l[0]??null;this.dispatchAction("change",{id:g?.id??null,uuid:g?.id??null,name:g?.name??null,size:g?.size??null,type:g?.type??null,lastModified:g?.lastModified??null,storageKey:g?.storageKey??null,value:d,files:a,rejected:a.filter(c=>!c.accepted),multiple:r,maxSize:o}),Ue(s.map(([c,h])=>({file:c,id:h.id})))}render(){let e=this.getString("label","Upload file"),r=this.getString("accept","*"),o=this.getBool("multiple");return u`
      ${e?u`<label>${e}</label>`:p}
    ...
    `}};customElements.define("forgeui-file-upload",Ae);var Pe=class extends f{static get styles(){return m`
  ...
  `}_statusClass(t){let e=String(t??"").toLowerCase().trim();return["done","complete","completed","success","active","ok","approved","paid"].includes(e)?"success":["in progress","in-progress","pending","warning","waiting","review"].includes(e)?"warning":["to do","to-do","todo","backlog","draft","new","inactive"].includes(e)?"neutral":["high","urgent","critical"].includes(e)?"error":["medium","med"].includes(e)?"warning":["low"].includes(e)?"info":["failed","error","rejected","blocked","overdue"].includes(e)?"error":"neutral"}_renderCell(t,e){let r=typeof t=="string"?t:t.key,o=e[r],i=t&&typeof t=="object"?t.type:void 0;if(o==null||o==="")return u`<span style="color:var(--forgeui-color-text-tertiary)">—</span>`;if(i==="badge"||i==="status"){let s=(t.variant&&typeof t.variant=="object"?t.variant[String(o).toLowerCase()]:null)||this._statusClass(o);return u`<span class="badge ${s}">${String(o)}</span>`}if(i==="number")return typeof o=="number"?o.toLocaleString():String(o);if(i==="date"){let s=typeof o=="string"||typeof o=="number"?new Date(o):o;return s instanceof Date&&!isNaN(s.getTime())?s.toLocaleDateString():String(o)}if(i==="currency"){let s=Number(o);return isNaN(s)?String(o):s.toLocaleString(void 0,{style:"currency",currency:t.currency||"USD"})}return i==="boolean"?o?"\u2713":"\u2717":String(o)}render(){let t=this.getProp("data"),e=this.getProp("columns")||[],r=this.getString("emptyMessage","No data yet"),o=this.getString("rowAction",""),i=this.getString("caption","");if(!Array.isArray(t))return u`<div class="empty">${r}</div>`;let s=e.length>0?e:t.length>0?Object.keys(t[0]):[];return s.length===0?u`<div class="empty">${r}</div>`:u`
      <table>
        ${i?u`<caption>${i}</caption>`:p}
        <thead><tr>${s.map(a=>{let l=typeof a=="string"?a:a.label||a.key,d=typeof a=="object"?a.align:void 0,g=typeof a=="object"?a.width:void 0;return u`<th class="${d==="right"?"align-right":d==="center"?"align-center":""}" style="${g?`width:${g}`:""}">${l}</th>`})}</tr></thead>
        <tbody>${t.length===0?u`<tr><td colspan=${s.length} class="empty">${r}</td></tr>`:t.map((a,l)=>{let d=!!o,g=d?String(a[typeof s[0]=="string"?s[0]:s[0]?.key]??`Row ${l+1}`):"";return u`<tr class="${d?"row-action":""}"
                tabindex=${d?0:p}
                role=${d?"button":p}
                aria-label=${d?g:p}
                @click=${d?()=>this.dispatchAction(o,{row:a,index:l}):void 0}
                @keydown=${d?c=>{(c.key==="Enter"||c.key===" ")&&(c.preventDefault(),this.dispatchAction(o,{row:a,index:l}))}:void 0}>
              ${s.map(c=>{let h=typeof c=="object"?c.align:void 0;return u`<td class="${h==="right"?"align-right":h==="center"?"align-center":""}">${this._renderCell(c,a)}</td>`})}</tr>`})}</tbody>
      </table>
    `}};customElements.define("forgeui-table",Pe);var Ie=class extends f{static get styles(){return m`
    :host { display:block; }
  ...
  `}render(){let t=this.getProp("data"),e=this.getString("dataPath","");!("data"in(this.props||{}))&&e&&this.store?.hasTable(e)&&(t=Object.values(this.store.getTable(e)));let r=this.getString("emptyMessage","No items");return!Array.isArray(t)||t.length===0?u`<div class="empty">${r}</div>`:u`<div class="list">${t.map((o,i)=>u`
      <div class="item" data-index=${i}><slot name="item" .item=${o} .index=${i}>${JSON.stringify(o)}</slot></div>
    `)}</div>`}};customElements.define("forgeui-list",Ie);var Ce=class extends f{constructor(){super(...arguments);this._palette=["var(--forgeui-color-primary)","var(--forgeui-color-success)","var(--forgeui-color-warning)","var(--forgeui-color-error)","var(--forgeui-color-info)","var(--forgeui-color-chart-6)","var(--forgeui-color-chart-7)","var(--forgeui-color-chart-8)","var(--forgeui-color-chart-9)","var(--forgeui-color-chart-10)"]}static get styles(){return m`
    :host { display:block; min-width:0; }
  ...
  `}_niceMax(e){if(e<=0)return 1;let r=Math.pow(10,Math.floor(Math.log10(e))),o=e/r;return(o<=1?1:o<=2?2:o<=5?5:10)*r}render(){let e=this.getString("chartType","bar"),r=this.getProp("data")||[],o=this.getString("title",""),i=this.getString("xKey","label")||this.getString("labelKey","label"),s=this.getString("yKey","value")||this.getString("valueKey","value"),a=this.getString("color","");if(!r||r.length===0)return u`
        ${o?u`<div class="title">${o}</div>`:p}
        <div class="empty">No data to display</div>
      `;let l=r.map(b=>typeof b=="number"?{label:"",value:b}:b&&typeof b=="object"?{label:String(b[i]??b.label??b.name??b.x??""),value:Number(b[s]??b.value??b.y??0)||0,color:b.color}:{label:String(b),value:0}),d=600,g=260,c={top:8,right:16,bottom:36,left:48},h=d-c.left-c.right,$=g-c.top-c.bottom,R,Ve=p;if(e==="pie"||e==="donut"){let b=l.reduce((S,x)=>S+Math.max(0,x.value),0)||1,j=d/2,I=g/2,M=Math.min(h,$)/2-8,A=e==="donut"?M*.55:0,y=-Math.PI/2,k=[],P=[];l.forEach((S,x)=>{let L=Math.max(0,S.value)/b,_=y,z=y+L*Math.PI*2;y=z;let V=z-_>Math.PI?1:0,K=j+M*Math.cos(_),Te=I+M*Math.sin(_),We=j+M*Math.cos(z),Ke=I+M*Math.sin(z),F=S.color||this._palette[x%this._palette.length];if(P.push(F),A>0){let Ze=j+A*Math.cos(_),Xe=I+A*Math.sin(_),Ye=j+A*Math.cos(z),Ge=I+A*Math.sin(z);k.push(v`<path class="slice" fill="${F}" d="M ${K} ${Te} A ${M} ${M} 0 ${V} 1 ${We} ${Ke} L ${Ye} ${Ge} A ${A} ${A} 0 ${V} 0 ${Ze} ${Xe} Z"/>`)}else k.push(v`<path class="slice" fill="${F}" d="M ${j} ${I} L ${K} ${Te} A ${M} ${M} 0 ${V} 1 ${We} ${Ke} Z"/>`)}),R=v`<g>${k}</g>`,Ve=u`<div class="legend">${l.map((S,x)=>u`
        <span class="legend-item"><span class="swatch" style="background:${P[x]}"></span>${S.label} (${S.value})</span>
      `)}</div>`}else{let b=Math.max(...l.map(y=>y.value),0),j=this._niceMax(b),I=y=>c.top+$-y/j*$,M=4,A=[];for(let y=0;y<=M;y++){let k=j*y/M,P=I(k);A.push(v`<line class="grid" x1="${c.left}" x2="${c.left+h}" y1="${P}" y2="${P}"/>`),A.push(v`<text class="tick-label" x="${c.left-6}" y="${P+3}" text-anchor="end">${k.toLocaleString()}</text>`)}if(e==="line"||e==="area"){let y=h/Math.max(1,l.length-1),k=l.map((x,L)=>{let _=c.left+L*y,z=I(x.value);return`${L===0?"M":"L"} ${_} ${z}`}).join(" "),P=e==="area"?k+` L ${c.left+h} ${c.top+$} L ${c.left} ${c.top+$} Z`:"",S=a||"var(--forgeui-color-primary)";R=u`
          <g>${A}</g>
          ${e==="area"?v`<path class="area" d="${P}" style="fill:${S};opacity:0.15"/>`:p}
          ${v`<path class="line" d="${k}" style="stroke:${S}"/>`}
          ${l.map((x,L)=>{let _=c.left+L*y,z=I(x.value);return v`<circle class="point" cx="${_}" cy="${z}" r="3" style="fill:${S}"/>
              <text class="tick-label" x="${_}" y="${c.top+$+14}" text-anchor="middle">${x.label}</text>`})}
        `}else{let y=l.length,k=h/y,P=Math.max(2,k*.7),S=k-P;R=u`
          <g>${A}</g>
          ${l.map((x,L)=>{let _=c.left+L*k+S/2,z=I(x.value),V=Math.max(0,c.top+$-z),K=x.color||a||"var(--forgeui-color-primary)";return v`<rect class="bar" x="${_}" y="${z}" width="${P}" height="${V}" rx="2" style="fill:${K}">
      ...
      ${o?u`<div class="title">${o}</div>`:p}
      <div class="wrap">
        <svg viewBox="0 0 ${d} ${g}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${o||e+" chart"}">
          ${R}
        </svg>
        ${Ve}
      </div>
    `}};customElements.define("forgeui-chart",Ce);var je=class extends f{static get styles(){return m`
  ...
  `}render(){let t=this.getString("variant","info"),e=this.getString("title",""),r=this.getString("message","");return u`<div class="alert ${t}" role=${t==="error"||t==="warning"?"alert":"status"}>
      ${e?u`<strong>${e}</strong> `:p}${r}<slot></slot>
    </div>`}};customElements.define("forgeui-alert",Le);var Re=class extends f{constructor(){super(...arguments);this._priorFocus=null;this._keydownHandler=e=>this._onKeydown(e);this._close=()=>{this.dispatchAction("close")}}static get styles(){return m`
    :host { display:none; }
  ...
  `}render(){let e=this.getString("title",""),r=this.getBool("open"),o=`${this._instanceId}-title`;return r?this.setAttribute("open",""):this.removeAttribute("open"),r?u`
  ...
  `}render(){let t=this.getProp("value"),e=this.getNumber("max",100),r=t==null,o=r?0:Math.max(0,Math.min(Number(t),e)),i=r?0:o/e*100,s=this.getString("label",""),a=this.getBool("showValue");return u`
      ${s||a?u`
        <div class="meta">
          ${s?u`<span>${s}</span>`:u`<span></span>`}
          ${a?u`<span class="value">${Math.round(i)}%</span>`:p}
        </div>
      `:p}
      <div
    ...
    `}};customElements.define("forgeui-progress",De);var Oe=class extends f{static get styles(){return m`
  ...
  `}render(){let t=this.getString("message","");return t?u`<div class="toast">${t}</div>`:u`${p}`}};customElements.define("forgeui-toast",Oe);var Ne=class extends f{static get styles(){return m`
    :host { display:block; }
  ...
  `}render(){let t=this.getString("msg","Unknown error");return u`<div class="error" role="alert">⚠ ${t}</div>`}};customElements.define("forgeui-error",Ne);var Be=class extends f{static get properties(){return{props:{type:Object}}}static get styles(){return m`
    :host { display:block; }
    svg { display:block; }
  `}render(){let t=this.getNumber("width",400),e=this.getNumber("height",300),r=this.getString("background","transparent"),o=this.getProp("shapes")||[];return v`
    ...
    `}renderShape(t){let e={fill:t.fill??void 0,stroke:t.stroke??void 0,"stroke-width":t.strokeWidth??void 0,opacity:t.opacity??void 0},r=t.action?()=>{this.onAction&&this.onAction(t.action)}:void 0,o=t.action?"cursor:pointer":void 0;switch(t.type){case"rect":return v`<rect
        ...
        >${t.content??""}</text>`;case"path":return v`<path
          ...
          style="${o}"
          @click=${r}
        />`;default:return v``}}};customElements.define("forgeui-drawing",Be);export{he as ForgeAccordion,Le as ForgeAlert,ae as ForgeAvatar,se as ForgeBadge,ye as ForgeBreadcrumb,G as ForgeButton,Q as ForgeButtonGroup,de as ForgeCard,Ce as ForgeChart,_e as ForgeCheckbox,fe as ForgeContainer,Ee as ForgeDatePicker,Re as ForgeDialog,me as ForgeDivider,Be as ForgeDrawing,le as ForgeEmptyState,Ae as ForgeFileUpload,ge as ForgeGrid,ne as ForgeIcon,ie as ForgeImage,ee as ForgeLink,Ie as ForgeList,je as ForgeMetric,Se as ForgeMultiSelect,$e as ForgeNumberInput,De as ForgeProgress,ve as ForgeRepeater,ke as ForgeSelect,Me as ForgeSlider,be as ForgeSpacer,ue as ForgeStack,xe as ForgeStepper,Pe as ForgeTable,pe as ForgeTabs,oe as ForgeText,we as ForgeTextInput,Oe as ForgeToast,ze as ForgeToggle,Ne as ForgeUIError};
