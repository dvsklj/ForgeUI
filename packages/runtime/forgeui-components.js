import{html as s,css as h,svg as b,nothing as d}from"lit";import{LitElement as Ze}from"lit";import{createStore as Ye}from"tinybase";var De=new Set(["__proto__","prototype","constructor"]);function P(n){if(n.length===0||n.length>256)return!1;for(let r of n.normalize("NFC").split("."))if(De.has(r))return!1;return!0}function D(n,r){if(r.includes("/")){let e=r.split("/");if(e.length===3){let[t,o,i]=e;return n.getCell(t,o,i)}if(e.length===2){let[t,o]=e,i=n.getValue(r);if(i!==void 0)return i;let a=n.getCellIds(t,o);if(a.length>0){let l={};for(let c of a)l[c]=n.getCell(t,o,c);return l}}}return n.getValue(r)}function He(n,r){if(r.startsWith("count:")){let e=r.slice(6);return n.getRowCount(e)}if(r.startsWith("sum:")){let[e,t]=r.split(":"),[o,i]=t.split("/"),a=0,l=n.getRowIds(o);for(let c of l){let u=n.getCell(o,c,i);typeof u=="number"&&(a+=u)}return a}if(r.startsWith("avg:")){let[e,t]=r.split(":"),[o,i]=t.split("/"),a=0,l=0,c=n.getRowIds(o);for(let u of c){let p=n.getCell(o,u,i);typeof p=="number"&&(a+=p,l++)}return l>0?a/l:0}return D(n,r)}var N=null;function H(n){N=n}function Ke(n,r){let e=qe(r);if(!e)return;let t=0,o={},i=()=>e[t],a=()=>{let p=e[t++];if(!p)return o;if(p.type==="number"||p.type==="string"||p.type==="literal")return p.value;if(p.type==="state")return Ne(n,p.path);if(p.type==="paren"&&p.value==="("){let g=c(1),m=e[t++];return m?.type==="paren"&&m.value===")"?g:o}return o},l=()=>{let p=i();if(p?.type==="op"&&p.value==="-"){t++;let g=l();return g===o?o:typeof g=="number"?-g:o}return a()};function c(p){let g=l();for(;g!==o;){let m=i();if(m?.type!=="op")break;let w=Pe[m.value];if(!w||w<p)break;t++,g=Be(m.value,g,c(w+1),o)}return g}let u=c(1);return u!==o&&t===e.length?u:void 0}var Pe={"&&":2,">":4,"<":4,">=":4,"<=":4,"+":5,"-":5,"*":6,"/":6};function Be(n,r,e,t){if(e===t)return t;if(n==="&&")return!!r&&!!e;if(n==="+")return typeof r=="number"&&typeof e=="number"?r+e:typeof r!="object"&&typeof e!="object"?String(r)+String(e):t;if(typeof r!="number"||typeof e!="number"||n==="/"&&e===0)return t;switch(n){case"-":return r-e;case"*":return r*e;case"/":return r/e;case">":return r>e;case"<":return r<e;case">=":return r>=e;case"<=":return r<=e;default:return t}}function qe(n){if(n.length>1024)return;let r=[],e=/\s*(>=|<=|&&|[()+\-*/><]|"(?:\\.|[^"\\])*"|\d+(?:\.\d+)?|[a-zA-Z_][a-zA-Z0-9_.]*)/gy,t,o=0;for(;t=e.exec(n);){let i=t[1];if(o=e.lastIndex,"()".includes(i))r.push({type:"paren",value:i});else if(Pe[i])r.push({type:"op",value:i});else if(i[0]==='"')r.push({type:"string",value:JSON.parse(i)});else if(/^\d/.test(i))r.push({type:"number",value:Number(i)});else if(i==="true"||i==="false")r.push({type:"literal",value:i==="true"});else if(i==="null")r.push({type:"literal",value:null});else if(i.startsWith("state.")&&P(i.slice(6)))r.push({type:"state",path:i.slice(6)});else return}return o===n.length?r:void 0}function K(n,r){let e=r.trim();if(e==="")return;if(e.startsWith('"')&&e.endsWith('"')||e.startsWith("'")&&e.endsWith("'"))return e.slice(1,-1);if(e.startsWith('"')&&!e.endsWith('"')||e.startsWith("'")&&!e.endsWith("'"))return;if(e==="true")return!0;if(e==="false")return!1;if(e==="null")return null;if(/^-?\d+(\.\d+)?$/.test(e))return Number(e);if(/(?:[+\-*/%]|===?|!==?|>=?|<=?|\&\&|\|\|)/.test(e)&&!e.includes("|"))return Ke(n,e);if(e.includes("|")){let[o,...i]=e.split("|").map(c=>c.trim()),l=K(n,o);for(let c of i){let[u,...p]=c.split(/\s+/);l=Je(l,u,p)}return l}if(e.startsWith("item.")||e==="item"){if(e==="item")return N;let o=e.slice(5);return R(N,o)}if(e.startsWith("state.")||e==="state"){if(e==="state")return;let o=e.slice(6);return Ne(n,o)}return D(n,e)}function Je(n,r,e){switch(r){case"values":return Array.isArray(n)?n:n&&typeof n=="object"?Object.values(n):[];case"keys":return n&&typeof n=="object"?Object.keys(n):[];case"count":case"length":return Array.isArray(n)?n.length:n&&typeof n=="object"?Object.keys(n).length:typeof n=="string"?n.length:0;case"sum":return Array.isArray(n)?n.reduce((t,o)=>t+(typeof o=="number"?o:0),0):0;case"first":return Array.isArray(n)?n[0]:void 0;case"last":return Array.isArray(n)?n[n.length-1]:void 0;default:return n}}function R(n,r){if(!n||typeof n!="object"||!r||!P(r))return;let e=r.split(".");if(e.length>32)return;let t=n;for(let o of e){if(t==null)return;t=t[o]}return t}function Ne(n,r){if(!P(r))return;let e=n.getValue(r);if(e!==void 0){if(typeof e=="string")try{return JSON.parse(e)}catch{}return e}let t=r.split(".");if(t.length>=3){let[i,a,l,...c]=t;if(n.hasTable(i)&&n.hasRow(i,a)){let u=n.getCell(i,a,l);if(c.length===0)return u;if(typeof u=="string")try{let p=JSON.parse(u);return R(p,c.join("."))}catch{}return}}if(t.length>=2){let[i,a,...l]=t;if(n.hasTable(i)&&n.hasRow(i,a)){let c=n.getRow(i,a);return l.length===0?c:R(c,l.join("."))}}if(t.length>=1){let[i,...a]=t;if(n.hasTable(i)){let l=n.getRowIds(i),c={};for(let u of l)c[u]=n.getRow(i,u);return a.length===0?c:R(c,a.join("."))}}let o=n.getValue(t[0]);if(typeof o=="string"&&t.length>1)try{let i=JSON.parse(o);return R(i,t.slice(1).join("."))}catch{}}function I(n,r){if(typeof r!="string"){if(r!==null&&typeof r=="object"){let e=r;if("$expr"in e)return I(n,`$expr:${e.$expr}`);if("$state"in e)return I(n,`$state:${e.$state}`);if("$computed"in e)return I(n,`$computed:${e.$computed}`);if("$item"in e)return I(n,`$item:${e.$item}`)}return r}if(r.startsWith("$state:")){let e=r.slice(7);return P(e)?D(n,e):void 0}if(r.startsWith("$computed:")){let e=r.slice(10);return e.length>1024?void 0:He(n,e)}if(r.startsWith("$item:")){let e=r.slice(6);return P(e)?e.includes(".")?R(N,e):N?.[e]:void 0}if(r.startsWith("$expr:")){let e=r.slice(6);return e.length>1024?void 0:K(n,e)}return r.length>4096?r:r.includes("{{")&&r.includes("}}")?Ue(r,n):r}function Ue(n,r){let e="",t=0;for(;t<n.length;)if(n[t]==="{"&&n[t+1]==="{"){let o=t+2,i=1,a=o;for(;a<n.length-1&&i>0;){let l=n[a],c=n[a+1];l==="{"&&c==="{"?(i++,a+=2):l==="}"&&c==="}"?(i--,a+=2):a++}if(i)e+=n[t++];else{let l=n.slice(o,a-2);if(l.length<=256){let c=K(r,l.trim());e+=c==null?"":String(c)}else e+=n.slice(t,a);t=a}}else e+=n[t++];return e}import{css as B}from"lit";var rr=B`
  @layer tokens {
    :host {
...
`;var V=class V extends Ze{constructor(){super(...arguments);this._instanceId=`forge-${++V._instanceCounter}`;this.props={};this.store=null;this.onAction=null;this.itemContext=null}static get properties(){return{props:{type:Object}}}connectedCallback(){super.connectedCallback()}resolve(e){if(!this.store)return e;this.itemContext&&H(this.itemContext);try{return I(this.store,e)}finally{H(null)}}getProp(e){let t=this.props?.[e];return typeof t=="string"&&(t.startsWith("$state:")||t.startsWith("$computed:")||t.startsWith("$item:")||t.startsWith("$expr:")||t.includes("{{")&&t.includes("}}"))?this.resolve(t):t}getArray(e){let t=this.getProp(e);return Array.isArray(t)?t:t&&typeof t=="object"?Object.values(t):[]}getString(e,t=""){let o=this.getProp(e);return typeof o=="string"?o:String(o??t)}getNumber(e,t=0){let o=this.getProp(e);return typeof o=="number"?o:Number(o)||t}getBool(e,t=!1){let o=this.getProp(e);return typeof o=="boolean"?o:t}dispatchAction(e,t){this.onAction&&this.onAction(e,t),this.dispatchEvent(new CustomEvent("forgeui-action",{detail:{action:e,payload:t},bubbles:!0,composed:!0}))}handleAction(e){let t=this.getString("action");t&&this.dispatchAction(t,this.props)}prop(e){return this.getProp(e)}static get sharedStyles(){return[q]}gapValue(e){let t={none:"0",0:"0","3xs":"var(--forgeui-space-3xs)","2xs":"var(--forgeui-space-2xs)",xs:"var(--forgeui-space-xs)",sm:"var(--forgeui-space-sm)",md:"var(--forgeui-space-md)",lg:"var(--forgeui-space-lg)",xl:"var(--forgeui-space-xl)","2xl":"var(--forgeui-space-2xl)"};if(e==null||e==="")return"var(--forgeui-space-md)";let o=String(e);return o in t?t[o]:/^\d+(\.\d+)?$/.test(o)?`${o}px`:/^\d+(\.\d+)?(px|rem|em|%|vw|vh|ch)$/.test(o)?o:"var(--forgeui-space-md)"}static get styles(){return[q]}};V._instanceCounter=0;var f=V;var J=class extends f{static get properties(){return{props:{type:Object}}}static get styles(){return h`
  ...
  `}render(){let r=this.getProp("columns"),e;typeof r=="number"?e=String(r):typeof r=="string"&&r?e=r:e="1";let t=/^\d+$/.test(e)?`repeat(${e}, minmax(0, 1fr))`:e,o=this.getString("gap","md"),i=this.gapValue(o),a=this.getString("padding",""),l=a?this.gapValue(a):"0";return this.style.gridTemplateColumns=t,this.style.gap=i,this.style.padding=l,/^\d+$/.test(e)&&Number(e)>=2&&this.setAttribute("responsive",""),s`<slot></slot>`}};customElements.define("forgeui-grid",U);var Z=class extends f{static get properties(){return{props:{type:Object}}}static get styles(){return h`
  ...
  `}render(){let r=this.getString("variant",""),e=this.getString("title",""),t=this.getString("subtitle","");return r&&this.setAttribute("variant",r),s`
    ...
    `}};customElements.define("forgeui-card",Z);var X=class extends f{static get properties(){return{props:{type:Object}}}static get styles(){return h`:host { display:block; margin-inline:auto; width:100%; box-sizing:border-box; }`}render(){let r=this.getString("maxWidth",""),e={sm:"640px",md:"768px",lg:"1024px",xl:"1280px","2xl":"1536px",full:"100%",none:"none","":""},t=r in e?e[r]:r,o=this.getString("padding","");return t&&t!=="none"?this.style.maxWidth=t:this.style.maxWidth="",this.style.padding=o?this.gapValue(o):"",s`<slot></slot>`}};customElements.define("forgeui-container",X);var Y=class extends f{static get properties(){return{props:{type:Object},_active:{state:!0}}}constructor(){super(),this._active=""}static get styles(){return h`
    :host { display:block; }
  ...
  `}_itemKey(r){return typeof r=="string"?r:String(r&&typeof r=="object"?r.id??r.key??r.value??r.label??"":r??"")}_itemLabel(r){return typeof r=="string"?r:String(r&&typeof r=="object"?r.label??r.title??r.value??"":r??"")}updated(){Array.from(this.children).filter(e=>!(e instanceof HTMLScriptElement)).forEach((e,t)=>{String(t)===this._active||e.id===this._active||e.getAttribute("slot")===this._active?e.setAttribute("data-active",""):e.removeAttribute("data-active")})}_moveTo(r,e){let t=this._itemKey(e[r])||String(r);this._active=t,this.requestUpdate(),this.dispatchAction("tab-change",{active:t}),this.updateComplete.then(()=>{this.shadowRoot?.querySelector(`#${this._instanceId}-tab-${r}`)?.focus()})}render(){let r=this.getProp("items")||[],e=Array.isArray(r)?r:[];!this._active&&e.length>0&&(this._active=this._itemKey(e[0])||"0");let t=e.findIndex((i,a)=>(this._itemKey(i)||String(a))===this._active),o=(i,a)=>{let l=-1;i.key==="ArrowRight"?l=(a+1)%e.length:i.key==="ArrowLeft"?l=(a-1+e.length)%e.length:i.key==="Home"?l=0:i.key==="End"&&(l=e.length-1),l!==-1&&(i.preventDefault(),this._moveTo(l,e))};return s`
      <div class="tabs" role="tablist">${e.map((i,a)=>{let l=this._itemKey(i)||String(a),c=this._itemLabel(i)||String(a+1),u=l===this._active;return s`
          <button class="tab" ?active=${u} role="tab" aria-selected=${u}
            ...
            @keydown=${p=>o(p,a)}>${c}</button>
        `})}</div>
      <div class="panel" role="tabpanel" id="${this._instanceId}-panel"
        aria-labelledby="${this._instanceId}-tab-${t>=0?t:0}"><slot></slot></div>
    `}};customElements.define("forgeui-tabs",Y);var G=class extends f{static get properties(){return{props:{type:Object}}}static get styles(){return h`
    :host { display:block; }
  ...
  `}render(){let r=this.getString("title","Section");return s`<details><summary>${r}</summary><div class="content"><slot></slot></div></details>`}};customElements.define("forgeui-accordion",G);var Q=class extends f{static get styles(){return h`
    :host { display:block; }
    hr { border:none; border-top:1px solid var(--forgeui-color-border); margin:var(--forgeui-space-sm) 0; }
  `}render(){return s`<hr>`}};customElements.define("forgeui-divider",Q);var F=class extends f{static get styles(){return h`:host { display:block; }`}render(){let r=this.getString("size","md"),e=this.getString("height",""),t=this.getString("width",""),o=e?this.gapValue(e):this.gapValue(r),i=t?/^\d+(\.\d+)?%$/.test(t)?t:this.gapValue(t):"";return s`<div style="height:${o};${i?`width:${i}`:""}"></div>`}};customElements.define("forgeui-spacer",F);var ee=class extends f{static get properties(){return{props:{type:Object}}}static get styles(){return h`
  ...
  `}render(){let r=this.getArray("data"),e=this.getString("emptyMessage",""),t=this.getString("direction","column");(t==="row"||t==="horizontal")&&this.setAttribute("direction","row");let o=this.getString("gap","md");return this.style.gap=this.gapValue(o),r.length===0&&e?s`<div class="empty">${e}</div>`:s`<slot></slot>`}};customElements.define("forgeui-repeater",ee);var re=class extends f{static get properties(){return{props:{type:Object}}}static get styles(){return h`
  ...
  `}render(){let r=this.getString("text","")||this.getString("label",""),e=this.getString("variant","");return s`<span class="badge" variant="${e}">${r}<slot></slot></span>`}};customElements.define("forgeui-badge",ie);var ne=class extends f{static get styles(){return h`
  ...
  `}render(){let r=this.getString("src",""),e=this.getString("name","?"),t=e.split(" ").map(o=>o[0]).join("").toUpperCase().slice(0,2);return s`<div class="avatar">${r?s`<img src="${r}" alt="${e}">`:t}<slot></slot></div>`}};customElements.define("forgeui-avatar",ne);var se=class extends f{static get styles(){return h`
  ...
  `}render(){let r=this.getString("title","Nothing here"),e=this.getString("description","");return s`
      ...
      <slot></slot>
    `}};customElements.define("forgeui-empty-state",se);var ae=class extends f{static get styles(){return h`
  ...
  `}render(){let r=this.getString("label",""),e=this.getString("placeholder",""),t=this.getString("hint",""),o=this.getString("error",""),i=this.getString("inputType","")||this.getString("type","text"),a=this.getBool("multiline"),l=this.getString("value",""),c=this._instanceId;return s`
    ...
    `}};customElements.define("forgeui-text-input",ae);var le=class extends f{static get styles(){return h`
    :host { display:block; flex:1 1 auto; min-width:0; max-width:100%; margin-bottom:var(--forgeui-space-sm); }
  ...
  `}render(){let r=this.getString("label",""),e=this.getProp("min"),t=this.getProp("max"),o=this.getProp("step"),i=this.getProp("value"),a=this._instanceId;return s`
    ...
    `}};customElements.define("forgeui-number-input",le);var ce=class extends f{static get styles(){return h`
    :host { display:block; flex:1 1 auto; min-width:0; max-width:100%; margin-bottom:var(--forgeui-space-sm); }
    label { display:block; font-size:var(--forgeui-text-sm); font-weight:var(--forgeui-weight-medium); margin-bottom:var(--forgeui-space-2xs); overflow-wrap:break-word; }
  ...
  `}render(){let r=this.getString("label",""),e=this.getProp("options")||[],t=this.getString("value",""),o=this._instanceId;return s`
    ...
    `}};customElements.define("forgeui-select",ce);var ue=class extends f{static get styles(){return h`
  ...
  `}render(){let r=this.getString("label",""),e=this.getProp("selected")||[];return s`
    ...
    `}};customElements.define("forgeui-multi-select",ue);var ge=class extends f{static get styles(){return h`
  ...
  `}render(){let r=this.getString("label",""),e=this.getBool("checked"),t=this._instanceId;return s`
    ...
    `}};customElements.define("forgeui-checkbox",ge);var fe=class extends f{constructor(){super(...arguments);this._toggle=()=>{if(this.getBool("disabled"))return;let e=this.getBool("on");this.dispatchEvent(new CustomEvent("forgeui-action",{detail:{actionId:"change",value:!e},bubbles:!0,composed:!0}))};this._onKeydown=e=>{(e.key==="Enter"||e.key===" "||e.key==="Spacebar")&&(e.preventDefault(),this._toggle())}}static get styles(){return h`
  ...
  `}render(){let e=this.getBool("on"),t=this.getString("label",""),o=this.getBool("disabled"),i=this._instanceId;return s`
    ...
    `}};customElements.define("forgeui-toggle",fe);var de=class extends f{static get styles(){return h`
    :host { display:block; flex:1 1 auto; min-width:0; max-width:100%; margin-bottom:var(--forgeui-space-sm); }
    label { display:block; font-size:var(--forgeui-text-sm); font-weight:var(--forgeui-weight-medium); margin-bottom:var(--forgeui-space-2xs); overflow-wrap:break-word; }
    input { width:100%; padding:var(--forgeui-space-xs) var(--forgeui-space-sm); border:1px solid var(--forgeui-color-border);
      border-radius:var(--forgeui-radius-md); font:inherit; height:var(--forgeui-input-height);
  ...
  `}render(){let r=this.getString("label",""),e=this.getString("value","");return s`
    ...
    `}};customElements.define("forgeui-date-picker",de);var pe=class extends f{static get styles(){return h`
    :host { display:block; flex:1 1 auto; min-width:0; max-width:100%; margin-bottom:var(--forgeui-space-sm); }
    label { display:block; font-size:var(--forgeui-text-sm); font-weight:var(--forgeui-weight-medium); margin-bottom:var(--forgeui-space-2xs); overflow-wrap:break-word; }
  ...
  `}render(){let r=this.getString("label",""),e=this.getNumber("min",0),t=this.getNumber("max",100),o=this.getNumber("step",1),i=this.getNumber("value",e);return s`
    ...
    `}};customElements.define("forgeui-slider",pe);var he=class extends f{static get styles(){return h`
    :host { display:block; margin-bottom:var(--forgeui-space-sm); }
    label { display:block; font-size:var(--forgeui-text-sm); font-weight:var(--forgeui-weight-medium); margin-bottom:var(--forgeui-space-2xs); }
  ...
  `}render(){let r=this.getString("label","Upload file"),e=this.getString("accept","*");return s`
    ...
    `}};customElements.define("forgeui-file-upload",he);var me=class extends f{static get styles(){return h`
    :host { display:inline-flex; }
  ...
  `}render(){let r=this.getString("label","Button"),e=this.getString("variant","primary"),t=this.getString("size",""),o=this.getBool("disabled"),i=this.getProp("pressed");return s`<button class="${e} ${t}" ?disabled=${o}
      ...
      @click=${a=>this.handleAction(a)}>${r}<slot></slot></button>`}};customElements.define("forgeui-button",me);var ve=class extends f{static get styles(){return h`
    :host { display:flex; gap:var(--forgeui-space-xs); }
  `}render(){return s`<slot></slot>`}};customElements.define("forgeui-button-group",ve);var be=class extends f{static get styles(){return h`
    :host { display:inline-flex; }
  ...
  `}render(){let r=this.getString("label",""),e=this.getString("href","#");return s`<a href="${e}">${r}<slot></slot></a>`}};customElements.define("forgeui-link",be);var ye=class extends f{static get styles(){return h`
  ...
  `}_statusClass(r){let e=String(r??"").toLowerCase().trim();return["done","complete","completed","success","active","ok","approved","paid"].includes(e)?"success":["in progress","in-progress","pending","warning","waiting","review"].includes(e)?"warning":["to do","to-do","todo","backlog","draft","new","inactive"].includes(e)?"neutral":["high","urgent","critical"].includes(e)?"error":["medium","med"].includes(e)?"warning":["low"].includes(e)?"info":["failed","error","rejected","blocked","overdue"].includes(e)?"error":"neutral"}_renderCell(r,e){let t=typeof r=="string"?r:r.key,o=e[t],i=r&&typeof r=="object"?r.type:void 0;if(o==null||o==="")return s`<span style="color:var(--forgeui-color-text-tertiary)">—</span>`;if(i==="badge"||i==="status"){let a=(r.variant&&typeof r.variant=="object"?r.variant[String(o).toLowerCase()]:null)||this._statusClass(o);return s`<span class="badge ${a}">${String(o)}</span>`}if(i==="number")return typeof o=="number"?o.toLocaleString():String(o);if(i==="date"){let a=typeof o=="string"||typeof o=="number"?new Date(o):o;return a instanceof Date&&!isNaN(a.getTime())?a.toLocaleDateString():String(o)}if(i==="currency"){let a=Number(o);return isNaN(a)?String(o):a.toLocaleString(void 0,{style:"currency",currency:r.currency||"USD"})}return i==="boolean"?o?"\u2713":"\u2717":String(o)}render(){let r=this.getProp("data"),e=this.getProp("columns")||[],t=this.getString("emptyMessage","No data yet"),o=this.getString("rowAction",""),i=this.getString("caption","");if(!Array.isArray(r))return s`<div class="empty">${t}</div>`;let a=e.length>0?e:r.length>0?Object.keys(r[0]):[];return a.length===0?s`<div class="empty">${t}</div>`:s`
      <table>
        ...
        <thead><tr>${a.map(l=>{let c=typeof l=="string"?l:l.label||l.key,u=typeof l=="object"?l.align:void 0,p=typeof l=="object"?l.width:void 0;return s`<th class="${u==="right"?"align-right":u==="center"?"align-center":""}" style="${p?`width:${p}`:""}">${c}</th>`})}</tr></thead>
        <tbody>${r.length===0?s`<tr><td colspan=${a.length} class="empty">${t}</td></tr>`:r.map((l,c)=>{let u=!!o,p=u?String(l[typeof a[0]=="string"?a[0]:a[0]?.key]??`Row ${c+1}`):"";return s`<tr class="${u?"row-action":""}"
                tabindex=${u?0:d}
                role=${u?"button":d}
                aria-label=${u?p:d}
                @click=${u?()=>this.dispatchAction(o,{row:l,index:c}):void 0}
                @keydown=${u?g=>{(g.key==="Enter"||g.key===" ")&&(g.preventDefault(),this.dispatchAction(o,{row:l,index:c}))}:void 0}>
              ${a.map(g=>{let m=typeof g=="object"?g.align:void 0;return s`<td class="${m==="right"?"align-right":m==="center"?"align-center":""}">${this._renderCell(g,l)}</td>`})}</tr>`})}</tbody>
      </table>
    `}};customElements.define("forgeui-table",ye);var xe=class extends f{static get styles(){return h`
    :host { display:block; }
  ...
  `}render(){let r=this.getProp("data"),e=this.getString("emptyMessage","No items");return!Array.isArray(r)||r.length===0?s`<div class="empty">${e}</div>`:s`<div class="list">${r.map((t,o)=>s`
    ...
    `)}</div>`}};customElements.define("forgeui-list",xe);var we=class extends f{constructor(){super(...arguments);this._palette=["var(--forgeui-color-primary)","var(--forgeui-color-success)","var(--forgeui-color-warning)","var(--forgeui-color-error)","var(--forgeui-color-info)","var(--forgeui-color-chart-6)","var(--forgeui-color-chart-7)","var(--forgeui-color-chart-8)","var(--forgeui-color-chart-9)","var(--forgeui-color-chart-10)"]}static get styles(){return h`
    :host { display:block; min-width:0; }
  ...
  `}_niceMax(e){if(e<=0)return 1;let t=Math.pow(10,Math.floor(Math.log10(e))),o=e/t;return(o<=1?1:o<=2?2:o<=5?5:10)*t}render(){let e=this.getString("chartType","bar"),t=this.getProp("data")||[],o=this.getString("title",""),i=this.getString("xKey","label")||this.getString("labelKey","label"),a=this.getString("yKey","value")||this.getString("valueKey","value"),l=this.getString("color","");if(!t||t.length===0)return s`
      ...
      `;let c=t.map(v=>typeof v=="number"?{label:"",value:v}:v&&typeof v=="object"?{label:String(v[i]??v.label??v.name??v.x??""),value:Number(v[a]??v.value??v.y??0)||0,color:v.color}:{label:String(v),value:0}),u=600,p=260,g={top:8,right:16,bottom:36,left:48},m=u-g.left-g.right,w=p-g.top-g.bottom,O,Ce=d;if(e==="pie"||e==="donut"){let v=c.reduce((k,x)=>k+Math.max(0,x.value),0)||1,j=u/2,M=p/2,E=Math.min(m,w)/2-8,_=e==="donut"?E*.55:0,y=-Math.PI/2,$=[],A=[];c.forEach((k,x)=>{let C=Math.max(0,k.value)/v,S=y,z=y+C*Math.PI*2;y=z;let L=z-S>Math.PI?1:0,T=j+E*Math.cos(S),Re=M+E*Math.sin(S),Ie=j+E*Math.cos(z),Le=M+E*Math.sin(z),W=k.color||this._palette[x%this._palette.length];if(A.push(W),_>0){let Oe=j+_*Math.cos(S),Te=M+_*Math.sin(S),Ve=j+_*Math.cos(z),We=M+_*Math.sin(z);$.push(b`<path class="slice" fill="${W}" d="M ${T} ${Re} A ${E} ${E} 0 ${L} 1 ${Ie} ${Le} L ${Ve} ${We} A ${_} ${_} 0 ${L} 0 ${Oe} ${Te} Z"/>`)}else $.push(b`<path class="slice" fill="${W}" d="M ${j} ${M} L ${T} ${Re} A ${E} ${E} 0 ${L} 1 ${Ie} ${Le} Z"/>`)}),O=b`<g>${$}</g>`,Ce=s`<div class="legend">${c.map((k,x)=>s`
        <span class="legend-item"><span class="swatch" style="background:${A[x]}"></span>${k.label} (${k.value})</span>
      `)}</div>`}else{let v=Math.max(...c.map(y=>y.value),0),j=this._niceMax(v),M=y=>g.top+w-y/j*w,E=4,_=[];for(let y=0;y<=E;y++){let $=j*y/E,A=M($);_.push(b`<line class="grid" x1="${g.left}" x2="${g.left+m}" y1="${A}" y2="${A}"/>`),_.push(b`<text class="tick-label" x="${g.left-6}" y="${A+3}" text-anchor="end">${$.toLocaleString()}</text>`)}if(e==="line"||e==="area"){let y=m/Math.max(1,c.length-1),$=c.map((x,C)=>{let S=g.left+C*y,z=M(x.value);return`${C===0?"M":"L"} ${S} ${z}`}).join(" "),A=e==="area"?$+` L ${g.left+m} ${g.top+w} L ${g.left} ${g.top+w} Z`:"",k=l||"var(--forgeui-color-primary)";O=s`
          <g>${_}</g>
          ${e==="area"?b`<path class="area" d="${A}" style="fill:${k};opacity:0.15"/>`:d}
          ${b`<path class="line" d="${$}" style="stroke:${k}"/>`}
          ${c.map((x,C)=>{let S=g.left+C*y,z=M(x.value);return b`<circle class="point" cx="${S}" cy="${z}" r="3" style="fill:${k}"/>
              <text class="tick-label" x="${S}" y="${g.top+w+14}" text-anchor="middle">${x.label}</text>`})}
        `}else{let y=c.length,$=m/y,A=Math.max(2,$*.7),k=$-A;O=s`
          <g>${_}</g>
          ${c.map((x,C)=>{let S=g.left+C*$+k/2,z=M(x.value),L=Math.max(0,g.top+w-z),T=x.color||l||"var(--forgeui-color-primary)";return b`<rect class="bar" x="${S}" y="${z}" width="${A}" height="${L}" rx="2" style="fill:${T}">
                <title>${x.label}: ${x.value}</title>
              </rect>
              <text class="tick-label" x="${S+A/2}" y="${g.top+w+14}" text-anchor="middle">${x.label}</text>`})}
        `}}return s`
      ${o?s`<div class="title">${o}</div>`:d}
      <div class="wrap">
        <svg viewBox="0 0 ${u} ${p}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${o||e+" chart"}">
          ${O}
        </svg>
        ${Ce}
      </div>
    `}};customElements.define("forgeui-chart",we);var $e=class extends f{static get styles(){return h`
  ...
  `}render(){let r=this.getString("variant","info"),e=this.getString("title",""),t=this.getString("message","");return s`<div class="alert ${r}" role=${r==="error"||r==="warning"?"alert":"status"}>
    ...
    </div>`}};customElements.define("forgeui-alert",ke);var Se=class extends f{constructor(){super(...arguments);this._priorFocus=null;this._keydownHandler=e=>this._onKeydown(e);this._close=()=>{this.dispatchAction("close")}}static get styles(){return h`
    :host { display:none; }
  ...
  `}render(){let r=this.getProp("value"),e=this.getNumber("max",100),t=r==null,o=t?0:Math.max(0,Math.min(Number(r),e)),i=t?0:o/e*100,a=this.getString("label",""),l=this.getBool("showValue");return s`
    ...
    `}};customElements.define("forgeui-progress",ze);var Ee=class extends f{static get styles(){return h`
  ...
  `}render(){let r=this.getString("message","");return r?s`<div class="toast">${r}</div>`:s`${d}`}};customElements.define("forgeui-toast",Ee);var _e=class extends f{static get styles(){return h`
  ...
  `}render(){let r=this.getProp("items")||[];return s`${r.map((e,t)=>{let o=t===r.length-1,i=typeof e=="string"?e:e.label,a=typeof e=="string"?"#":e.href;return s`
      ...
      `})}`}};customElements.define("forgeui-breadcrumb",_e);var Ae=class extends f{static get styles(){return h`
  ...
  `}render(){let r=this.getProp("steps")||[],e=this.getNumber("active",0);return s`${r.map((t,o)=>{let i=typeof t=="string"?t:t.label||t.title||`Step ${o+1}`,a=o===e,l=o<e;return s`<div class="step" ?active=${a} ?completed=${l}>
      ...
      </div>`})}`}};customElements.define("forgeui-stepper",Ae);var Me=class extends f{static get styles(){return h`
    :host { display:block; }
  ...
  `}render(){let r=this.getString("msg","Unknown error");return s`<div class="error" role="alert">⚠ ${r}</div>`}};customElements.define("forgeui-error",Me);var je=class extends f{static get properties(){return{props:{type:Object}}}static get styles(){return h`
    :host { display:block; }
    svg { display:block; }
  `}render(){let r=this.getNumber("width",400),e=this.getNumber("height",300),t=this.getString("background","transparent"),o=this.getProp("shapes")||[];return b`
      <svg width="${r}" height="${e}" style="background:${t}" viewBox="0 0 ${r} ${e}">
        ${o.map(i=>this.renderShape(i))}
      </svg>
    `}renderShape(r){let e={fill:r.fill??void 0,stroke:r.stroke??void 0,"stroke-width":r.strokeWidth??void 0,opacity:r.opacity??void 0},t=r.action?()=>{this.onAction&&this.onAction(r.action)}:void 0,o=r.action?"cursor:pointer":void 0;switch(r.type){case"rect":return b`<rect
          x="${r.x??0}" y="${r.y??0}"
        ...
        />`;case"text":return b`<text
          ...
          style="${o}"
          @click=${t}
        >${r.content??""}</text>`;case"path":return b`<path
          d="${r.d??""}"
          fill="${e.fill??"none"}"
          stroke="${e.stroke??"none"}"
          stroke-width="${e["stroke-width"]??1}"
          ...
          style="${o}"
          @click=${t}
        />`;default:return b``}}};customElements.define("forgeui-drawing",je);export{G as ForgeAccordion,ke as ForgeAlert,ne as ForgeAvatar,ie as ForgeBadge,_e as ForgeBreadcrumb,me as ForgeButton,ve as ForgeButtonGroup,Z as ForgeCard,we as ForgeChart,ge as ForgeCheckbox,X as ForgeContainer,de as ForgeDatePicker,Se as ForgeDialog,Q as ForgeDivider,je as ForgeDrawing,se as ForgeEmptyState,he as ForgeFileUpload,U as ForgeGrid,oe as ForgeIcon,te as ForgeImage,be as ForgeLink,xe as ForgeList,$e as ForgeMetric,ue as ForgeMultiSelect,le as ForgeNumberInput,ze as ForgeProgress,ee as ForgeRepeater,ce as ForgeSelect,pe as ForgeSlider,F as ForgeSpacer,J as ForgeStack,Ae as ForgeStepper,ye as ForgeTable,Y as ForgeTabs,re as ForgeText,ae as ForgeTextInput,Ee as ForgeToast,fe as ForgeToggle,Me as ForgeUIError};
