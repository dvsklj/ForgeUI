import{html as c,css as h,svg as v,nothing as f}from"lit";import{LitElement as rt}from"lit";import{createStore as gt}from"tinybase";var Ye=new Set(["__proto__","prototype","constructor"]);function V(n){if(n.length===0||n.length>256)return!1;for(let t of n.normalize("NFC").split("."))if(Ye.has(t))return!1;return!0}function H(n,t){if(t.includes("/")){let e=t.split("/");if(e.length===3){let[r,o,i]=e;return n.getCell(r,o,i)}if(e.length===2){let[r,o]=e,i=n.getValue(t);if(i!==void 0)return i;let s=n.getCellIds(r,o);if(s.length>0){let a={};for(let l of s)a[l]=n.getCell(r,o,l);return a}}}return n.getValue(t)}function Ge(n,t){if(t.startsWith("count:")){let e=t.slice(6);return n.getRowCount(e)}if(t.startsWith("sum:")){let[e,r]=t.split(":"),[o,i]=r.split("/"),s=0,a=n.getRowIds(o);for(let l of a){let g=n.getCell(o,l,i);typeof g=="number"&&(s+=g)}return s}if(t.startsWith("avg:")){let[e,r]=t.split(":"),[o,i]=r.split("/"),s=0,a=0,l=n.getRowIds(o);for(let g of l){let p=n.getCell(o,g,i);typeof p=="number"&&(s+=p,a++)}return a>0?s/a:0}return H(n,t)}var B=null;function F(n){B=n}function Qe(n,t){if(t.length>1024)return;let e="(state\\.[a-zA-Z_][a-zA-Z0-9_.]*|-?\\d+(?:\\.\\d+)?)",r=t.trim().match(new RegExp(`^${e}\\s*(>=|<=|[+\\-*/><])\\s*${e}$`));if(!r)return;let o=We(n,r[1]),i=We(n,r[3]);if(!(typeof o!="number"||typeof i!="number"))switch(r[2]){case"+":return o+i;case"-":return o-i;case"*":return o*i;case"/":return i===0?void 0:o/i;case">":return o>i;case"<":return o<i;case">=":return o>=i;case"<=":return o<=i}}function We(n,t){if(/^-?\d/.test(t))return Number(t);if(!t.startsWith("state."))return;let e=t.slice(6);return V(e)?Ke(n,e):void 0}function U(n,t){let e=t.trim();if(e==="")return;if(e.startsWith('"')&&e.endsWith('"')||e.startsWith("'")&&e.endsWith("'"))return e.slice(1,-1);if(e.startsWith('"')&&!e.endsWith('"')||e.startsWith("'")&&!e.endsWith("'"))return;if(e==="true")return!0;if(e==="false")return!1;if(e==="null")return null;if(/^-?\d+(\.\d+)?$/.test(e))return Number(e);if(/(?:[+\-*/%]|===?|!==?|>=?|<=?|\&\&|\|\|)/.test(e)&&!e.includes("|"))return Qe(n,e);if(e.includes("|")){let[o,...i]=e.split("|").map(l=>l.trim()),a=U(n,o);for(let l of i){let[g,...p]=l.split(/\s+/);a=et(a,g,p)}return a}if(e.startsWith("item.")||e==="item"){if(e==="item")return B;let o=e.slice(5);return O(B,o)}if(e.startsWith("state.")||e==="state"){if(e==="state")return;let o=e.slice(6);return Ke(n,o)}return H(n,e)}function et(n,t,e){switch(t){case"values":return Array.isArray(n)?n:n&&typeof n=="object"?Object.values(n):[];case"keys":return n&&typeof n=="object"?Object.keys(n):[];case"count":case"length":return Array.isArray(n)?n.length:n&&typeof n=="object"?Object.keys(n).length:typeof n=="string"?n.length:0;case"sum":return Array.isArray(n)?n.reduce((r,o)=>r+(typeof o=="number"?o:0),0):0;case"first":return Array.isArray(n)?n[0]:void 0;case"last":return Array.isArray(n)?n[n.length-1]:void 0;default:return n}}function O(n,t){if(!n||typeof n!="object"||!t||!V(t))return;let e=t.split(".");if(e.length>32)return;let r=n;for(let o of e){if(r==null)return;r=r[o]}return r}function Ke(n,t){if(!V(t))return;let e=n.getValue(t);if(e!==void 0){if(typeof e=="string")try{return JSON.parse(e)}catch{}return e}let r=t.split(".");if(r.length>=3){let[i,s,a,...l]=r;if(n.hasTable(i)&&n.hasRow(i,s)){let g=n.getCell(i,s,a);if(l.length===0)return g;if(typeof g=="string")try{let p=JSON.parse(g);return O(p,l.join("."))}catch{}return}}if(r.length>=2){let[i,s,...a]=r;if(n.hasTable(i)&&n.hasRow(i,s)){let l=n.getRow(i,s);return a.length===0?l:O(l,a.join("."))}}if(r.length>=1){let[i,...s]=r;if(n.hasTable(i)){let a=n.getRowIds(i),l={};for(let g of a)l[g]=n.getRow(i,g);return s.length===0?l:O(l,s.join("."))}}let o=n.getValue(r[0]);if(typeof o=="string"&&r.length>1)try{let i=JSON.parse(o);return O(i,r.slice(1).join("."))}catch{}}function D(n,t){if(typeof t!="string"){if(t!==null&&typeof t=="object"){let e=t;if("$expr"in e)return D(n,`$expr:${e.$expr}`);if("$state"in e)return D(n,`$state:${e.$state}`);if("$computed"in e)return D(n,`$computed:${e.$computed}`);if("$item"in e)return D(n,`$item:${e.$item}`)}return t}if(t.startsWith("$state:")){let e=t.slice(7);return V(e)?H(n,e):void 0}if(t.startsWith("$computed:")){let e=t.slice(10);return e.length>1024?void 0:Ge(n,e)}if(t.startsWith("$item:")){let e=t.slice(6);return V(e)?e.includes(".")?O(B,e):B?.[e]:void 0}if(t.startsWith("$expr:")){let e=t.slice(6);return e.length>1024?void 0:U(n,e)}return t.length>4096?t:t.includes("{{")&&t.includes("}}")?tt(t,n):t}function tt(n,t){let e="",r=0;for(;r<n.length;)if(n[r]==="{"&&n[r+1]==="{"){let o=r+2,i=1,s=o;for(;s<n.length-1&&i>0;){let a=n[s],l=n[s+1];a==="{"&&l==="{"?(i++,s+=2):a==="}"&&l==="}"?(i--,s+=2):s++}if(i)e+=n[r++];else{let a=n.slice(o,s-2);if(a.length<=256){let l=a.trim(),g=l.startsWith("$")?D(t,l):U(t,l);e+=g==null?"":String(g)}else e+=n.slice(r,s);r=s}}else e+=n[r++];return e}import{css as q}from"lit";var vt=q`
  @layer tokens {
    :host {
...
`;var W=class W extends rt{constructor(){super(...arguments);this._instanceId=`forge-${++W._instanceCounter}`;this.props={};this.store=null;this.onAction=null;this.itemContext=null}static get properties(){return{props:{type:Object}}}connectedCallback(){super.connectedCallback()}resolve(e){if(!this.store)return e;this.itemContext&&F(this.itemContext);try{return D(this.store,e)}finally{F(null)}}getProp(e){let r=this.props?.[e];return typeof r=="string"&&(r.startsWith("$state:")||r.startsWith("$computed:")||r.startsWith("$item:")||r.startsWith("$expr:")||r.includes("{{")&&r.includes("}}"))?this.resolve(r):r}getArray(e){let r=this.getProp(e);return Array.isArray(r)?r:r&&typeof r=="object"?Object.values(r):[]}getString(e,r=""){let o=this.getProp(e);return typeof o=="string"?o:String(o??r)}getNumber(e,r=0){let o=this.getProp(e);return typeof o=="number"?o:Number(o)||r}getBool(e,r=!1){let o=this.getProp(e);return typeof o=="boolean"?o:r}getBoundProp(e,r){let o=typeof this.props?.bind=="string"?this.props.bind:"";if(o){let s=this.resolve(o);if(s!==void 0)return s}let i=this.getProp(e);return i===void 0?r:i}dispatchAction(e,r){let o=typeof this.props?.bind=="string"?this.props.bind:"",i=o?{...r||{},bind:o}:r;this.onAction&&this.onAction(e,i),this.dispatchEvent(new CustomEvent("forgeui-action",{detail:{action:e,payload:i},bubbles:!0,composed:!0}))}handleAction(e){let r=this.getString("action");r&&this.dispatchAction(r,this.props)}prop(e){return this.getProp(e)}static get sharedStyles(){return[J]}gapValue(e){let r={none:"0",0:"0","3xs":"var(--forgeui-space-3xs)","2xs":"var(--forgeui-space-2xs)",xs:"var(--forgeui-space-xs)",sm:"var(--forgeui-space-sm)",md:"var(--forgeui-space-md)",lg:"var(--forgeui-space-lg)",xl:"var(--forgeui-space-xl)","2xl":"var(--forgeui-space-2xl)"};if(e==null||e==="")return"var(--forgeui-space-md)";let o=String(e);return o in r?r[o]:/^\d+(\.\d+)?$/.test(o)?`${o}px`:/^\d+(\.\d+)?(px|rem|em|%|vw|vh|ch)$/.test(o)?o:"var(--forgeui-space-md)"}static get styles(){return[J]}};W._instanceCounter=0;var d=W;function ot(n){return`forgeui_${(n||"global").replace(/[^a-zA-Z0-9-]/g,"_")}`}var Z="f";function it(n){return new Promise((t,e)=>{let r=i=>e(i??new Error("IDB"));if(!globalThis.indexedDB)return r();let o=indexedDB.open(`${ot(n)}_f`,1);o.onupgradeneeded=()=>{o.result.createObjectStore(Z)},o.onsuccess=()=>t(o.result),o.onerror=o.onblocked=()=>r(o.error)})}async function He(n,t){if(n.length===0)return;let e=null;try{e=await it(t),await new Promise((r,o)=>{let i=e.transaction(Z,"readwrite"),s=i.objectStore(Z);for(let{file:a,id:l}of n)s.put(a,l);i.oncomplete=()=>r(),i.onerror=i.onabort=()=>o(i.error)})}catch{return}finally{e?.close()}}import{html as Q,css as ee,nothing as nt}from"lit";var X=class extends d{static get styles(){return ee`
  ...
  `}render(){let t=this.getString("label","Button"),e=this.getString("variant","primary"),r=this.getString("size",""),o=this.getBool("disabled"),i=this.getProp("pressed");return Q`<button class="${e} ${r}" ?disabled=${o}
      aria-pressed=${i==null?nt:String(!!i)}
      @click=${s=>this.handleAction(s)}>${t}<slot></slot></button>`}};customElements.define("forgeui-button",X);var Y=class extends d{static get styles(){return ee`
    :host { display:flex; gap:var(--forgeui-space-xs); }
  `}render(){return Q`<slot></slot>`}};customElements.define("forgeui-button-group",Y);var G=class extends d{static get styles(){return ee`
    :host { display:inline-flex; }
  ...
  `}render(){let t=this.getString("label",""),e=this.getString("href","#");return Q`<a href="${e}">${t}<slot></slot></a>`}};customElements.define("forgeui-link",G);import{html as w,css as C,nothing as te}from"lit";var re=class extends d{static get properties(){return{props:{type:Object}}}static get styles(){return C`
  ...
  `}render(){let t=this.getString("variant",""),e=this.getString("title",""),r=this.getString("subtitle","");return t&&this.setAttribute("variant",t),w`
      ${e||r?w`
        <div class="header">
          ${e?w`<div class="title">${e}</div>`:te}
          ${r?w`<div class="subtitle">${r}</div>`:te}
        </div>
      `:te}
      <div class="body"><slot></slot></div>
    `}};customElements.define("forgeui-card",ie);var ne=class extends d{static get properties(){return{props:{type:Object}}}static get styles(){return C`:host { display:block; margin-inline:auto; width:100%; box-sizing:border-box; }`}render(){let t=this.getString("maxWidth",""),e={sm:"640px",md:"768px",lg:"1024px",xl:"1280px","2xl":"1536px",full:"100%",none:"none","":""},r=t in e?e[t]:t,o=this.getString("padding","");return r&&r!=="none"?this.style.maxWidth=r:this.style.maxWidth="",this.style.padding=o?this.gapValue(o):"",w`<slot></slot>`}};customElements.define("forgeui-container",ne);var se=class extends d{static get properties(){return{props:{type:Object}}}constructor(){super(),this._active=""}static get styles(){return C`
    :host { display:block; }
  ...
  `}_itemKey(t){return typeof t=="string"?t:String(t&&typeof t=="object"?t.id??t.key??t.value??t.label??"":t??"")}_itemLabel(t){return typeof t=="string"?t:String(t&&typeof t=="object"?t.label??t.title??t.value??"":t??"")}updated(){Array.from(this.children).filter(e=>!(e instanceof HTMLScriptElement)).forEach((e,r)=>{let o=(e.props||{}).slot??e.getAttribute("slot");String(r)===this._active||o===this._active?e.setAttribute("data-active",""):e.removeAttribute("data-active")})}_moveTo(t,e){let r=this._itemKey(e[t])||String(t);this._active=r,this.requestUpdate(),this.dispatchAction("tab-change",{active:r,value:r}),this.updateComplete.then(()=>{this.shadowRoot?.querySelector(`#${this._instanceId}-tab-${t}`)?.focus()})}render(){let t=this.getProp("items")||this.getProp("tabs")||[],e=Array.isArray(t)?t:[],r=this.getBoundProp("activeTab",this.getProp("value"));r!==void 0&&String(r)!==this._active&&(this._active=String(r)),!this._active&&e.length>0&&(this._active=this._itemKey(e[0])||"0");let o=e.findIndex((s,a)=>(this._itemKey(s)||String(a))===this._active),i=(s,a)=>{let l=-1;s.key==="ArrowRight"?l=(a+1)%e.length:s.key==="ArrowLeft"?l=(a-1+e.length)%e.length:s.key==="Home"?l=0:s.key==="End"&&(l=e.length-1),l!==-1&&(s.preventDefault(),this._moveTo(l,e))};return w`
      <div class="tabs" role="tablist">${e.map((s,a)=>{let l=this._itemKey(s)||String(a),g=this._itemLabel(s)||String(a+1),p=l===this._active;return w`
    ...
    `}};customElements.define("forgeui-tabs",se);var ae=class extends d{static get properties(){return{props:{type:Object}}}static get styles(){return C`
    :host { display:block; }
  ...
  `}render(){let t=this.getString("title","Section");return w`<details><summary>${t}</summary><div class="content"><slot></slot></div></details>`}};customElements.define("forgeui-accordion",ae);var le=class extends d{static get styles(){return C`
    :host { display:block; }
    hr { border:none; border-top:1px solid var(--forgeui-color-border); margin:var(--forgeui-space-sm) 0; }
  `}render(){return w`<hr>`}};customElements.define("forgeui-divider",le);var ce=class extends d{static get styles(){return C`:host { display:block; }`}render(){let t=this.getString("size","md"),e=this.getString("height",""),r=this.getString("width",""),o=e?this.gapValue(e):this.gapValue(t),i=r?/^\d+(\.\d+)?%$/.test(r)?r:this.gapValue(r):"";return w`<div style="height:${o};${i?`width:${i}`:""}"></div>`}};customElements.define("forgeui-spacer",ce);var ue=class extends d{static get properties(){return{props:{type:Object}}}static get styles(){return C`
  ...
  `}render(){let t=this.getArray("data"),e=this.getString("emptyMessage",""),r=this.getString("direction","column");(r==="row"||r==="horizontal")&&this.setAttribute("direction","row");let o=this.getString("gap","md");return this.style.gap=this.gapValue(o),t.length===0&&e?w`<div class="empty">${e}</div>`:w`<slot></slot>`}};customElements.define("forgeui-repeater",ue);import{html as R,css as Fe,nothing as st}from"lit";var ge=class extends d{static get styles(){return Fe`
  ...
  `}render(){let t=this.getProp("items")||[];return R`${t.map((e,r)=>{let o=r===t.length-1,i=typeof e=="string"?e:e.label,s=typeof e=="string"?"#":e.href;return R`
        ${r>0?R`<span class="sep">/</span>`:st}
        ${o?R`<span class="current">${i}</span>`:R`<a href="${s}">${i}</a>`}
      `})}`}};customElements.define("forgeui-breadcrumb",ge);var de=class extends d{static get styles(){return Fe`
  ...
  `}render(){let t=this.getProp("steps")||[],e=this.getBoundProp("active",this.getProp("activeStep")??0),r=Number(e)||0;return R`${t.map((o,i)=>{let s=typeof o=="string"?o:o.label||o.title||`Step ${i+1}`,a=i===r,l=i<r;return R`<div class="step" ?active=${a} ?completed=${l}>
        <div class="circle">${l?"\u2713":i+1}</div>
        <div class="label">${s}</div>
      </div>`})}`}};customElements.define("forgeui-stepper",de);var fe=class extends d{static get properties(){return{props:{type:Object}}}static get styles(){return h`
  ...
  `}render(){let t=this.getString("text","")||this.getString("label",""),e=this.getString("variant","");return c`<span class="badge" variant="${e}">${t}<slot></slot></span>`}};customElements.define("forgeui-badge",me);var be=class extends d{static get styles(){return h`
    :host { display:inline-flex; }
  ...
  `}render(){let t=this.getString("src",""),e=this.getString("name","?"),r=e.split(" ").map(o=>o[0]).join("").toUpperCase().slice(0,2);return c`<div class="avatar">${t?c`<img src="${t}" alt="${e}">`:r}<slot></slot></div>`}};customElements.define("forgeui-avatar",be);var ve=class extends d{static get styles(){return h`
  ...
  `}render(){let t=this.getString("title","Nothing here"),e=this.getString("description","");return c`
      ...
      ${e?c`<div class="desc">${e}</div>`:f}
      <slot></slot>
    `}};customElements.define("forgeui-empty-state",ve);var ye=class extends d{static get styles(){return h`
  ...
  `}render(){let t=this.getString("label",""),e=this.getString("placeholder",""),r=this.getString("hint",""),o=this.getString("error",""),i=this.getString("inputType","")||this.getString("type","text"),s=this.getBool("multiline"),a=String(this.getBoundProp("value","")??""),l=this._instanceId;return c`
      ...
      ${r&&!o?c`<div class="hint">${r}</div>`:f}
      ${o?c`<div class="error">${o}</div>`:f}
    `}};customElements.define("forgeui-text-input",ye);var xe=class extends d{static get styles(){return h`
    :host { display:block; flex:1 1 auto; min-width:0; max-width:100%; margin-bottom:var(--forgeui-space-sm); }
  ...
  `}render(){let t=this.getString("label",""),e=this.getProp("min"),r=this.getProp("max"),o=this.getProp("step"),i=this.getBoundProp("value"),s=this._instanceId;return c`
      ${t?c`<label for="${s}">${t}</label>`:f}
      <input id="${s}" type="number" min=${e} max=${r} step=${o} .value=${i??""}
        @input=${a=>this.dispatchAction("change",{value:Number(a.target.value)})}>
    `}};customElements.define("forgeui-number-input",xe);var we=class extends d{static get styles(){return h`
    :host { display:block; flex:1 1 auto; min-width:0; max-width:100%; margin-bottom:var(--forgeui-space-sm); }
    label { display:block; font-size:var(--forgeui-text-sm); font-weight:var(--forgeui-weight-medium); margin-bottom:var(--forgeui-space-2xs); overflow-wrap:break-word; }
  ...
  `}render(){let t=this.getString("label",""),e=this.getProp("options")||[],r=String(this.getBoundProp("value","")??""),o=this._instanceId;return c`
    ...
    `}};customElements.define("forgeui-select",we);var $e=class extends d{static get styles(){return h`
  ...
  `}render(){let t=this.getString("label",""),e=this.getProp("selected")||[];return c`
    ...
    `}};customElements.define("forgeui-multi-select",$e);var ke=class extends d{static get styles(){return h`
  ...
  `}render(){let t=this.getString("label",""),e=!!this.getBoundProp("checked",this.getProp("value")??!1),r=this._instanceId;return c`
      ...
      ${t?c`<label for="${r}">${t}</label>`:f}
    `}};customElements.define("forgeui-checkbox",ke);var Se=class extends d{constructor(){super(...arguments);this._toggle=()=>{if(this.getBool("disabled"))return;let e=!!this.getBoundProp("on",this.getProp("value")??!1);this.dispatchAction("change",{value:!e,checked:!e})};this._onKeydown=e=>{(e.key==="Enter"||e.key===" "||e.key==="Spacebar")&&(e.preventDefault(),this._toggle())}}static get styles(){return h`
  ...
  `}render(){let e=!!this.getBoundProp("on",this.getProp("value")??!1),r=this.getString("label",""),o=this.getBool("disabled"),i=this._instanceId;return c`
      <label for="${i}" class="toggle-label">
        ...
        ></button>
        ${r?c`<span class="toggle-text">${r}</span>`:f}
      </label>
    `}};customElements.define("forgeui-toggle",Se);var _e=class extends d{static get styles(){return h`
    :host { display:block; flex:1 1 auto; min-width:0; max-width:100%; margin-bottom:var(--forgeui-space-sm); }
    label { display:block; font-size:var(--forgeui-text-sm); font-weight:var(--forgeui-weight-medium); margin-bottom:var(--forgeui-space-2xs); overflow-wrap:break-word; }
    input { width:100%; padding:var(--forgeui-space-xs) var(--forgeui-space-sm); border:1px solid var(--forgeui-color-border);
      border-radius:var(--forgeui-radius-md); font:inherit; height:var(--forgeui-input-height);
  ...
  `}render(){let t=this.getString("label",""),e=this.getString("value",""),r=this._instanceId;return c`
    ...
    `}};customElements.define("forgeui-date-picker",_e);var ze=class extends d{static get styles(){return h`
    :host { display:block; flex:1 1 auto; min-width:0; max-width:100%; margin-bottom:var(--forgeui-space-sm); }
    label { display:block; font-size:var(--forgeui-text-sm); font-weight:var(--forgeui-weight-medium); margin-bottom:var(--forgeui-space-2xs); overflow-wrap:break-word; }
  ...
  `}render(){let t=this.getString("label",""),e=this.getNumber("min",0),r=this.getNumber("max",100),o=this.getNumber("step",1),i=this.getBoundProp("value",e),s=Number(i);Number.isFinite(s)||(s=e);let a=this._instanceId;return c`
      ${t?c`<label for="${a}">${t}</label>`:f}
      <input id="${a}" type="range" min=${e} max=${r} step=${o} .value=${s}
        @input=${l=>this.dispatchAction("change",{value:Number(l.target.value)})}>
      <div class="value">${s}</div>
    `}};customElements.define("forgeui-slider",ze);var Me=class extends d{constructor(){super(...arguments);this._dragging=!1;this._openFilePicker=()=>{this.shadowRoot?.querySelector('input[type="file"]')?.click()};this._onDropzoneKeydown=e=>{e.key!=="Enter"&&e.key!==" "||(e.preventDefault(),this._openFilePicker())};this._onFileChange=e=>{let r=Array.from(e.target.files??[]);this._processFiles(r)};this._onDragOver=e=>{e.preventDefault(),!this._dragging&&(this._dragging=!0,this.requestUpdate())};this._onDragLeave=e=>{e.currentTarget===e.target&&(this._dragging=!1,this.requestUpdate())};this._onDrop=e=>{e.preventDefault(),this._dragging=!1,this.requestUpdate(),this._processFiles(Array.from(e.dataTransfer?.files??[]))}}static get styles(){return h`
    :host { display:block; margin-bottom:var(--forgeui-space-sm); }
    label { display:block; font-size:var(--forgeui-text-sm); font-weight:var(--forgeui-weight-medium); margin-bottom:var(--forgeui-space-2xs); }
  ...
  `}_maxSizeBytes(){let e=this.getProp("maxSize");if(typeof e=="number"&&Number.isFinite(e)&&e>=0)return Math.floor(e);if(typeof e!="string")return null;let r=e.trim().match(/^(\d+(?:\.\d+)?)\s*(b|kb|mb|gb)?$/i);if(!r)return null;let o=Number(r[1]),i=(r[2]||"b").toLowerCase(),s=i==="gb"?1<<30:i==="mb"?1<<20:i==="kb"?1024:1,a=o*s;return Number.isFinite(a)?Math.floor(a):null}_newFileId(){return globalThis.crypto?.randomUUID?.()??`${Date.now()}_${Math.random().toString(36).slice(2)}`}_processFiles(e){let r=this.getBool("multiple"),o=this._maxSizeBytes(),i=(r?e:e.slice(0,1)).map(u=>{let m=this._newFileId(),$=o==null||u.size<=o,L={id:m,name:u.name,size:u.size,type:u.type,lastModified:u.lastModified,accepted:$,storageKey:$?m:null};return $||(L.error="maxSize"),[u,L]}),s=i.filter(([,u])=>u.accepted),a=i.map(([,u])=>u),l=s.map(([,u])=>u),g=r?l:l[0]??null,p=l[0]??null;this.dispatchAction("change",{id:p?.id??null,uuid:p?.id??null,name:p?.name??null,size:p?.size??null,type:p?.type??null,lastModified:p?.lastModified??null,storageKey:p?.storageKey??null,value:g,files:a,rejected:a.filter(u=>!u.accepted),multiple:r,maxSize:o}),He(s.map(([u,m])=>({file:u,id:m.id})))}render(){let e=this.getString("label","Upload file"),r=this.getString("accept","*"),o=this.getBool("multiple");return c`
    ...
    `}};customElements.define("forgeui-file-upload",Me);var Ee=class extends d{static get styles(){return h`
  ...
  `}_statusClass(t){let e=String(t??"").toLowerCase().trim();return["done","complete","completed","success","active","ok","approved","paid"].includes(e)?"success":["in progress","in-progress","pending","warning","waiting","review"].includes(e)?"warning":["to do","to-do","todo","backlog","draft","new","inactive"].includes(e)?"neutral":["high","urgent","critical"].includes(e)?"error":["medium","med"].includes(e)?"warning":["low"].includes(e)?"info":["failed","error","rejected","blocked","overdue"].includes(e)?"error":"neutral"}_renderCell(t,e){let r=typeof t=="string"?t:t.key,o=e[r],i=t&&typeof t=="object"?t.type:void 0;if(o==null||o==="")return c`<span style="color:var(--forgeui-color-text-tertiary)">—</span>`;if(i==="badge"||i==="status"){let s=(t.variant&&typeof t.variant=="object"?t.variant[String(o).toLowerCase()]:null)||this._statusClass(o);return c`<span class="badge ${s}">${String(o)}</span>`}if(i==="number")return typeof o=="number"?o.toLocaleString():String(o);if(i==="date"){let s=typeof o=="string"||typeof o=="number"?new Date(o):o;return s instanceof Date&&!isNaN(s.getTime())?s.toLocaleDateString():String(o)}if(i==="currency"){let s=Number(o);return isNaN(s)?String(o):s.toLocaleString(void 0,{style:"currency",currency:t.currency||"USD"})}return i==="boolean"?o?"\u2713":"\u2717":String(o)}render(){let t=this.getProp("data"),e=this.getProp("columns")||[],r=this.getString("emptyMessage","No data yet"),o=this.getString("rowAction",""),i=this.getString("caption","");if(!Array.isArray(t))return c`<div class="empty">${r}</div>`;let s=e.length>0?e:t.length>0?Object.keys(t[0]):[];return s.length===0?c`<div class="empty">${r}</div>`:c`
      <table>
        ${i?c`<caption>${i}</caption>`:f}
        <thead><tr>${s.map(a=>{let l=typeof a=="string"?a:a.label||a.key,g=typeof a=="object"?a.align:void 0,p=typeof a=="object"?a.width:void 0;return c`<th class="${g==="right"?"align-right":g==="center"?"align-center":""}" style="${p?`width:${p}`:""}">${l}</th>`})}</tr></thead>
        <tbody>${t.length===0?c`<tr><td colspan=${s.length} class="empty">${r}</td></tr>`:t.map((a,l)=>{let g=!!o,p=g?String(a[typeof s[0]=="string"?s[0]:s[0]?.key]??`Row ${l+1}`):"";return c`<tr class="${g?"row-action":""}"
                tabindex=${g?0:f}
                role=${g?"button":f}
                aria-label=${g?p:f}
    ...
    `}};customElements.define("forgeui-table",Ee);var Ae=class extends d{static get styles(){return h`
    :host { display:block; }
  ...
  `}render(){let t=this.getProp("data"),e=this.getString("dataPath","");!("data"in(this.props||{}))&&e&&this.store?.hasTable(e)&&(t=Object.values(this.store.getTable(e)));let r=this.getString("emptyMessage","No items");return!Array.isArray(t)||t.length===0?c`<div class="empty">${r}</div>`:c`<div class="list">${t.map((o,i)=>c`
    ...
    `)}</div>`}};customElements.define("forgeui-list",Ae);var Pe=class extends d{constructor(){super(...arguments);this._palette=["var(--forgeui-color-primary)","var(--forgeui-color-success)","var(--forgeui-color-warning)","var(--forgeui-color-error)","var(--forgeui-color-info)","var(--forgeui-color-chart-6)","var(--forgeui-color-chart-7)","var(--forgeui-color-chart-8)","var(--forgeui-color-chart-9)","var(--forgeui-color-chart-10)"]}static get styles(){return h`
    :host { display:block; min-width:0; }
  ...
  `}_niceMax(e){if(e<=0)return 1;let r=Math.pow(10,Math.floor(Math.log10(e))),o=e/r;return(o<=1?1:o<=2?2:o<=5?5:10)*r}render(){let e=this.getString("chartType","bar"),r=this.getProp("data")||[],o=this.getString("title",""),i=this.getString("xKey","label")||this.getString("labelKey","label"),s=this.getString("yKey","value")||this.getString("valueKey","value"),a=this.getString("color","");if(!r||r.length===0)return c`
        ${o?c`<div class="title">${o}</div>`:f}
        <div class="empty">No data to display</div>
      `;let l=r.map(b=>typeof b=="number"?{label:"",value:b}:b&&typeof b=="object"?{label:String(b[i]??b.label??b.name??b.x??""),value:Number(b[s]??b.value??b.y??0)||0,color:b.color}:{label:String(b),value:0}),g=600,p=260,u={top:8,right:16,bottom:36,left:48},m=g-u.left-u.right,$=p-u.top-u.bottom,L,Ne=f;if(e==="pie"||e==="donut"){let b=l.reduce((S,x)=>S+Math.max(0,x.value),0)||1,I=g/2,P=p/2,M=Math.min(m,$)/2-8,E=e==="donut"?M*.55:0,y=-Math.PI/2,k=[],A=[];l.forEach((S,x)=>{let j=Math.max(0,S.value)/b,_=y,z=y+j*Math.PI*2;y=z;let N=z-_>Math.PI?1:0,T=I+M*Math.cos(_),Ve=P+M*Math.sin(_),Be=I+M*Math.cos(z),Te=P+M*Math.sin(z),K=S.color||this._palette[x%this._palette.length];if(A.push(K),E>0){let Ue=I+E*Math.cos(_),qe=P+E*Math.sin(_),Je=I+E*Math.cos(z),Ze=P+E*Math.sin(z);k.push(v`<path class="slice" fill="${K}" d="M ${T} ${Ve} A ${M} ${M} 0 ${N} 1 ${Be} ${Te} L ${Je} ${Ze} A ${E} ${E} 0 ${N} 0 ${Ue} ${qe} Z"/>`)}else k.push(v`<path class="slice" fill="${K}" d="M ${I} ${P} L ${T} ${Ve} A ${M} ${M} 0 ${N} 1 ${Be} ${Te} Z"/>`)}),L=v`<g>${k}</g>`,Ne=c`<div class="legend">${l.map((S,x)=>c`
        <span class="legend-item"><span class="swatch" style="background:${A[x]}"></span>${S.label} (${S.value})</span>
      `)}</div>`}else{let b=Math.max(...l.map(y=>y.value),0),I=this._niceMax(b),P=y=>u.top+$-y/I*$,M=4,E=[];for(let y=0;y<=M;y++){let k=I*y/M,A=P(k);E.push(v`<line class="grid" x1="${u.left}" x2="${u.left+m}" y1="${A}" y2="${A}"/>`),E.push(v`<text class="tick-label" x="${u.left-6}" y="${A+3}" text-anchor="end">${k.toLocaleString()}</text>`)}if(e==="line"||e==="area"){let y=m/Math.max(1,l.length-1),k=l.map((x,j)=>{let _=u.left+j*y,z=P(x.value);return`${j===0?"M":"L"} ${_} ${z}`}).join(" "),A=e==="area"?k+` L ${u.left+m} ${u.top+$} L ${u.left} ${u.top+$} Z`:"",S=a||"var(--forgeui-color-primary)";L=c`
          <g>${E}</g>
          ${e==="area"?v`<path class="area" d="${A}" style="fill:${S};opacity:0.15"/>`:f}
          ${v`<path class="line" d="${k}" style="stroke:${S}"/>`}
          ${l.map((x,j)=>{let _=u.left+j*y,z=P(x.value);return v`<circle class="point" cx="${_}" cy="${z}" r="3" style="fill:${S}"/>
              <text class="tick-label" x="${_}" y="${u.top+$+14}" text-anchor="middle">${x.label}</text>`})}
        `}else{let y=l.length,k=m/y,A=Math.max(2,k*.7),S=k-A;L=c`
          <g>${E}</g>
          ${l.map((x,j)=>{let _=u.left+j*k+S/2,z=P(x.value),N=Math.max(0,u.top+$-z),T=x.color||a||"var(--forgeui-color-primary)";return v`<rect class="bar" x="${_}" y="${z}" width="${A}" height="${N}" rx="2" style="fill:${T}">
                <title>${x.label}: ${x.value}</title>
              </rect>
              <text class="tick-label" x="${_+A/2}" y="${u.top+$+14}" text-anchor="middle">${x.label}</text>`})}
        `}}return c`
      ${o?c`<div class="title">${o}</div>`:f}
      <div class="wrap">
    ...
    `}};customElements.define("forgeui-chart",Pe);var Ce=class extends d{static get styles(){return h`
  ...
  `}_trendMeta(t){if(t==null||t==="")return null;if(typeof t=="number")return t>0?{dir:"up",arrow:"\u2191",display:`${Math.abs(t)}%`}:t<0?{dir:"down",arrow:"\u2193",display:`${Math.abs(t)}%`}:{dir:"neutral",arrow:"\u2192",display:"0%"};if(typeof t=="string"){let e=t.toLowerCase(),r=t.match(/^\s*([+-]?\d+(?:\.\d+)?)\s*(%?)\s*$/);if(r){let o=parseFloat(r[1]),i=r[2];return o>0?{dir:"up",arrow:"\u2191",display:`${Math.abs(o)}${i}`}:o<0?{dir:"down",arrow:"\u2193",display:`${Math.abs(o)}${i}`}:{dir:"neutral",arrow:"\u2192",display:`0${i}`}}return e==="up"||e==="positive"||e==="increase"?{dir:"up",arrow:"\u2191",display:""}:e==="down"||e==="negative"||e==="decrease"?{dir:"down",arrow:"\u2193",display:""}:e==="flat"||e==="neutral"||e==="same"?{dir:"neutral",arrow:"\u2192",display:""}:{dir:"neutral",arrow:"",display:t}}return null}render(){let t=this.getString("label",""),e=this.getProp("value"),r=this.getProp("trend"),o=this.getString("trendLabel",""),i=this.getProp("goal"),s=this.getString("unit",""),a=this.getString("suffix",""),l=this.getString("subtitle",""),g=this.getString("variant","");g&&this.setAttribute("variant",g);let p=typeof e=="number"?e.toLocaleString():e==null||e===""?"\u2014":String(e),u=this._trendMeta(r);return c`
      ${t?c`<div class="label">${t}</div>`:f}
      <div class="value-row">
        <span class="value">${p}</span>
        ${s?c`<span class="unit">${s}</span>`:f}
        ${a?c`<span class="suffix">${a}</span>`:f}
        ${u?c`<span class="trend ${u.dir} ${!u.display&&!o?"icon-only":""}">${u.arrow}${u.display?c` ${u.display}`:f}${o?c` ${o}`:f}</span>`:f}
      </div>
      ${l?c`<div class="subtitle">${l}</div>`:f}
      ${i!=null&&i!==""?c`<div class="goal">Goal: ${typeof i=="number"?i.toLocaleString():i}</div>`:f}
    `}};customElements.define("forgeui-metric",Ce);var Ie=class extends d{static get styles(){return h`
    :host { display:block; margin-bottom:var(--forgeui-space-sm); }
  ...
  `}render(){let t=this.getString("variant","info"),e=this.getString("title",""),r=this.getString("message","");return c`<div class="alert ${t}" role=${t==="error"||t==="warning"?"alert":"status"}>
      ${e?c`<strong>${e}</strong> `:f}${r}<slot></slot>
    </div>`}};customElements.define("forgeui-alert",Ie);var je=class extends d{constructor(){super(...arguments);this._priorFocus=null;this._keydownHandler=e=>this._onKeydown(e);this._close=()=>{this.dispatchAction("close")}}static get styles(){return h`
    :host { display:none; }
  ...
  `}render(){let t=this.getProp("value"),e=this.getNumber("max",100),r=t==null,o=r?0:Math.max(0,Math.min(Number(t),e)),i=r?0:o/e*100,s=this.getString("label",""),a=this.getBool("showValue");return c`
      ${s||a?c`
        <div class="meta">
          ...
          ${a?c`<span class="value">${Math.round(i)}%</span>`:f}
        </div>
      `:f}
      <div
    ...
    `}};customElements.define("forgeui-progress",Le);var De=class extends d{static get styles(){return h`
  ...
  `}render(){let t=this.getString("message","");return t?c`<div class="toast">${t}</div>`:c`${f}`}};customElements.define("forgeui-toast",De);var Re=class extends d{static get styles(){return h`
    :host { display:block; }
  ...
  `}render(){let t=this.getString("msg","Unknown error");return c`<div class="error" role="alert">⚠ ${t}</div>`}};customElements.define("forgeui-error",Re);var Oe=class extends d{static get properties(){return{props:{type:Object}}}static get styles(){return h`
    :host { display:block; }
    svg { display:block; }
  `}render(){let t=this.getNumber("width",400),e=this.getNumber("height",300),r=this.getString("background","transparent"),o=this.getProp("shapes")||[];return v`
    ...
    `}renderShape(t){let e={fill:t.fill??void 0,stroke:t.stroke??void 0,"stroke-width":t.strokeWidth??void 0,opacity:t.opacity??void 0},r=t.action?()=>{this.onAction&&this.onAction(t.action)}:void 0,o=t.action?"cursor:pointer":void 0;switch(t.type){case"rect":return v`<rect
        ...
        >${t.content??""}</text>`;case"path":return v`<path
          ...
          style="${o}"
          @click=${r}
        />`;default:return v``}}};customElements.define("forgeui-drawing",Oe);export{ae as ForgeAccordion,Ie as ForgeAlert,be as ForgeAvatar,me as ForgeBadge,ge as ForgeBreadcrumb,X as ForgeButton,Y as ForgeButtonGroup,ie as ForgeCard,Pe as ForgeChart,ke as ForgeCheckbox,ne as ForgeContainer,_e as ForgeDatePicker,je as ForgeDialog,le as ForgeDivider,Oe as ForgeDrawing,ve as ForgeEmptyState,Me as ForgeFileUpload,oe as ForgeGrid,he as ForgeIcon,pe as ForgeImage,G as ForgeLink,Ae as ForgeList,Ce as ForgeMetric,$e as ForgeMultiSelect,xe as ForgeNumberInput,Le as ForgeProgress,ue as ForgeRepeater,we as ForgeSelect,ze as ForgeSlider,ce as ForgeSpacer,re as ForgeStack,de as ForgeStepper,Ee as ForgeTable,se as ForgeTabs,fe as ForgeText,ye as ForgeTextInput,De as ForgeToast,Se as ForgeToggle,Re as ForgeUIError};
