...
const defs: Record<ComponentType, string[]> = {
  ...
  Spacer: [...SHARED, 'size'],
  Repeater: [...SHARED, 'dataPath', 'template', 'data'],
  Text: [...SHARED, 'content', 'variant', 'weight', 'color', 'align'],
  Image: [...SHARED, 'src', 'alt', 'aspectRatio', 'fit', 'radius'],
  Icon: [...SHARED, 'name', 'size', 'color'],
  Badge: [...SHARED, 'text', 'colorScheme', 'variant'],
  Avatar: [...SHARED, 'src', 'name', 'size'],
  EmptyState: [...SHARED, 'title', 'description', 'icon', 'actionLabel'],
  TextInput: [...SHARED, ...INPUT_BASE, 'placeholder', 'multiline', 'required', 'maxLength'],
  ...
  Slider: [...SHARED, ...INPUT_BASE, 'min', 'max', 'step', 'showValue'],
  FileUpload: [...SHARED, ...INPUT_BASE, 'accept', 'maxSize', 'multiple'],
  Button: [...SHARED, 'label', 'variant', 'size', 'icon', 'disabled'],
  ButtonGroup: [...SHARED, 'direction', 'spacing'],
  Link: [...SHARED, 'label', 'href', 'variant', 'external'],
  Table: [...SHARED, 'dataPath', 'columns', 'pageSize', 'searchable', 'emptyMessage'],
  List: [...SHARED, 'dataPath', 'template', 'emptyMessage', 'dividers', 'items'],
  Chart: [...SHARED, ...BASE_TEXT, 'dataPath', 'xKey', 'yKey', 'colorScheme', 'height', 'data'],
  Metric: [...SHARED, ...BASE_TEXT, 'format', 'goal', 'trend', 'prefix', 'suffix'],
  Alert: [...SHARED, 'title', 'message', 'variant', 'dismissible'],
  Dialog: [...SHARED, 'title', 'trigger', 'confirmLabel', 'cancelLabel'],
  Progress: [...SHARED, ...BASE_TEXT, 'max', 'size'],
