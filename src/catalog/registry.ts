...
/** Category mapping for all 40 manifest components */
export const componentCategories: Record<ComponentType, ComponentCategory> = {
  ...
  TextInput: 'input', Textarea: 'input', NumberInput: 'input', Select: 'input', MultiSelect: 'input', RadioGroup: 'input',
...
export const componentsByCategory: Record<ComponentCategory, ComponentType[]> = {
  ...
  input: ['TextInput', 'Textarea', 'NumberInput', 'Select', 'MultiSelect', 'RadioGroup', 'Checkbox', 'Toggle', 'DatePicker', 'Slider', 'FileUpload'],
