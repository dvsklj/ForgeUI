...
| Boundary | Size |
| --- | ---: |
| ForgeUI wheel | 119,810 bytes (117.0 KiB) |
...
its 117.0 KiB wheel and roughly 0.8-1.1 MiB extracted package.
...
wheel into clean base, mounted-web, and complete environments. The current 117.0 KiB wheel uses
about 91% of that budget. New integrations should therefore stay optional and avoid vendored
