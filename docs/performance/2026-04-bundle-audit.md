...
> - Architecture and package metadata now distinguish 43 manifest catalog components from 44 runtime custom elements (`forgeui-error` is internal).
>
> The rest of this document is preserved as a point-in-time audit.

## Executive summary

The `@nedast/forgeui-runtime` IIFE ships at **334 KB raw / 95 KB gzipped** — the architecture doc (§10) claims ~308 KB raw / ~40 KB gzipped, meaning the real number is **~8% over on raw and 2.4× over on gzip**. The primary culprits are Ajv (25 KB gzip), Zod (14 KB gzip), and TinyBase (13 KB gzip), all of which are fully inlined into the IIFE despite the description claiming "zero dependencies." Every other published package also exceeds reasonable expectations for its domain.

## Per-package size table

| Package                         | Raw (B) | Min (B) | Gzip (B) | Brotli (B) | vs. claim        |
|---------------------------------|---------|---------|----------|------------|------------------|
| @nedast/forgeui-runtime (IIFE)           | 333,785 | 333,785 | 95,029   | 83,813     | +235% vs 40 KB   |
| @nedast/forgeui-runtime (ESM standalone) | 173,375 | 173,375 | 41,604   | 36,577     | n/a (no claim)   |
| @nedast/forgeui-runtime (ESM components) | 63,812  | 63,812  | 14,278   | 12,550     | n/a (no claim)   |
| @nedast/forgeui-catalog                  | 30,125  | 30,125  | 8,389    | 7,266      | n/a (no claim)   |
| @nedast/forgeui-server                   | 232,140 | 232,140 | 68,284   | 60,476     | n/a (no claim)   |
| @nedast/forgeui-connect                  | 377,119 | 377,119 | 103,202  | 89,136     | n/a (no claim)   |
...
## @nedast/forgeui-runtime bundle breakdown
...
> `@nedast/forgeui-runtime` IIFE: ~308 KB raw, ~40 KB gzipped.
...
|---------------------------------|------------------|---------------------|
| @nedast/forgeui-runtime (IIFE)           | 95,029           | 106,433             |
| @nedast/forgeui-runtime (ESM standalone) | 41,604           | 46,597              |
| @nedast/forgeui-runtime (ESM components) | 14,278           | 15,992              |
| @nedast/forgeui-catalog                  | 8,389            | 9,396               |
| @nedast/forgeui-server                   | 68,284           | 76,479              |
| @nedast/forgeui-connect                  | 103,202          | 115,587             |
